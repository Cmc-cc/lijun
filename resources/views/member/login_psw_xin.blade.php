...
<div id="main-container1">
	<div class="module-top">
		<div class="top-menu-area">
			<a href="javascript:void(0)" class="active">{{trans("lang.xgdenglumima")}}</a>
			<a class="switchroute" href="safe_psw_xin">{{trans("lang.xgqkmm")}}</a>
		</div>
	</div>		
	<div class="module-main" style="margin-top:25px">
		<form action="member/update_login_password" method="post" class="form-horizontal">
			<div class="form-group">
				...
				<div class="col-xs-6">
					<input name="old_password" type="password" class="form-control" id="oddPwd" placeholder="{{trans("lang.srjmm")}}" autocomplete="off">
				</div>
			</div>
			<div class="form-group">
				<label class="col-xs-3 control-label"></label>
				<div class="col-xs-6">
					<input name="password" type="password" class="form-control" id="newPwd" placeholder="{{trans("lang.qrxmm620")}}" autocomplete="off">
				</div>
			...
			<div class="form-group">
				<label class="col-xs-3 control-label"></label>
				<div class="col-xs-6">
					<input name="password_confirmation" id="newPwd2" type="password" class="form-control" placeholder="{{trans("lang.srxmm620")}}" autocomplete="off">
				</div>
				<!-- <div class="col-xs-3 info">
					* 6-20个常规字符
				</div> -->
...
<script>
    function upPw() {
        ...
        if(!password || !password_confirmation || !old_password){
             chenggong_alert(2,'{{trans("lang.qrztxxx")}}');return false;
        }
        ...
        $.ajax({
            url : "{{ route('member.update_login_password') }}",
            type : 'POST',
