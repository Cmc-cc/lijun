...
<head>
    ...
    <link href="/web/mb25/css/site.css" rel="stylesheet"/>
    @if($web_route == 'web.index')  <link href="/web/mb25/bundles/home.css?v=Z0I1MnqVfQ2Gxw7Nrs0FZ-E7HyV84bcUupfFjChrVWE1" rel="stylesheet"/> @else  @endif
...
@include('web.template.mb25.layouts.header')

<div id="banner" style="margin-top: 55px;"></div>
...
@include('web.template.mb25.layouts.aside')

@include('web.template.mb25.layouts.footer')
