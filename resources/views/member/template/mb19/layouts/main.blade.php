...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/web/mb19/css/common.css') }}">
    <link rel="stylesheet" href="{{ asset('/web/mb19/css/style.css') }}">
    <link rel="stylesheet" href="{{ asset('/web/css/vendor.css') }}">
    <link rel="stylesheet" href="{{ asset('/web/mb19/css/member.css') }}">
    <link rel="stylesheet" href="{{ asset('/web/css/yk_modal.css') }}">
    <link rel="stylesheet" href="{{ asset('/web/mb19/css/index1.css') }}">
    <script src="{{ asset('/web/js/jquery-2.1.3.min.js') }}"></script>
</head>
<body>

@include('web.template.mb19.layouts.header')
...
@include('web.template.mb19.layouts.aside')
@include('web.template.mb19.layouts.footer')

<script src="{{ asset('/web/mb19/js/jquery.flexslider.js') }}"></script>
<script src="{{ asset('/web/mb19/js/index1.js') }}"></script>
<script src="{{ asset('/web/mb19/js/common.js') }}"></script>
<script src="{{ asset('/web/mb19/js/yk_modal.js') }}"></script>
<script src="{{ asset('/web/mb19/js/jquery.SuperSlide.2.1.1.js') }}"></script>
<script src="{{ asset('/web/layer/layer.js') }}"></script>
<script src="{{ asset('/web/mb19/js/ajax-submit-form.js') }}"></script>
<script src="{{ asset('/web/mb19/js/rendezvous.js') }}"></script><!--日历-->
<script src="{{ asset('/web/mb19/js/jquery.page.js') }}"></script><!--翻页-->
