...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/web/mb16/css/member.css') }}">
...
<script src="{{ asset('/web/mb16/js/rendezvous.js') }}"></script><!--日历-->
<script src="{{ asset('/web/mb16/js/jquery.page.js') }}"></script><!--翻页-->
