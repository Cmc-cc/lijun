...
<div style="width:100%;margin-bottom:5px;background: linear-gradient(90deg,#e8e8e8,#cccbca);overflow: hidden;">
	...
	@if(!$setting->is_wechat_on)
		<a href="usdt_pay_xin" class="switchroute"><div class="zfu bgc"><span class="zfu1" style="color:#f5f5f5">{{trans('lang.xnbzf')}}</span></div></a>
	@endif
			            	  </div>
...
<div id="main-container">
	<div class="module-main" style="margin-top:26px;">
		<form action="https://www.emixbet.com/member/usdt_pay" method="post" class="form-horizontal">
			...
			<div class="form-group" style="margin-bottom:10px">
				...
				<div style="float:left;" class="col-xs-6">
					<input type="number" class="form-control" placeholder="{{trans("lang.qingshuru")}}{{trans("lang.huikuanjine")}}" onchange="jine_input2()"  id="amount"  name="amount">
				</div>
				<div class="col-xs-3 info">
					&nbsp;&nbsp;{{trans("lang.zdhq")}}{{trans("lang.huikuanjine")}}<span class="STYLE12">*</span>
				</div>
			</div>
			<div class="form-group" style="margin-bottom:10px">
			...
			<div class="form-group" style="margin-bottom:16px;">
				<div class="col-xs-3 control-label">{{trans("lang.czdz")}}：</div>
				<div style="float:left;" class="col-xs-6">
						<input type="text" name="paytime" class="form-control" id="usdt_addr" value="{{ $_system_config->usdt_trc }}"  disabled >
				</div>
			</div>
			<div class="form-group" style="margin-bottom:16px;">
				<div class="col-xs-3 control-label" >{{trans("lang.skewm")}}：</div>
				<div style="float:left;" class="col-xs-6">
						<img src="{{ $_system_config->usdt_trc_pic }}" id="usdt_pic" width="200" alt="">
				</div>
			</div>
            <div class="form-group">
				<div class="col-xs-3 control-label">{{trans("lang.czleixing")}}：</div>
				<div class="col-xs-6">
	...
	function jine_input2(){
        ...
        $("#amount").val(val)
		    ...
		    val = $("#amount").val();
		    val = val / {{$_system_config->usdt_lv}};
            $('#usdtnum').text('$' + Number(Number(val) + Number(xiaoshu)).toFixed(2))
		}
		
		
        // var account = '{{ $_system_config->usdt_trc }}';
