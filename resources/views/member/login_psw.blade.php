            ...
            <div class="main-bg">
                ...
                <div class="memcenter clear">
                    ...
                    <div class="memRight">
                        <div class="nav">
                            <ul class="commonlist">
                                <li class="select" style="width: 200px;"><a href="{{ route('member.login_psw') }}" class="text_42" oncontextmenu="return false;"></a></li>
                                <li style="width: 215px;"><a href="{{ route('member.safe_psw') }}" class="text_43" oncontextmenu="return false;"></a></li>
                            </ul>
                        </div>
