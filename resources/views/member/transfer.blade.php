                            ...
                            <div class="trans-money-header clear" id="balance">
                                ...
                                <div class="t-h-box" data-num="10">
                                    ...
                                    <div class="t-h-info ">
                                        ...
                                        <h6 class="gameMoney gamemoney_text" gamename="Center">{{$member->money}}</h6>
                                    </div>
                                </div>
                                    ...
                                    <div class="t-h-box" data-num="2">
                                        ...
                                        @if($mod)
                                            <div class="t-h-info"><h1>{{ $item->api_title }}</h1>
                                                <h6 class="gameMoney gamecode"  gamename="{{$item->api_name}}"  data-code="{{$item->api_name}}">{{$mod->money}}</h6>
                                            </div>
                                        @else
