                        ...
                        <form>
                            <div class="memCon clearfix">
                                <div class="txt">
                                    ...
                                    <h3 style="color: #e3c7af">{{trans("lang.yinhangka")}}</h3>
                                    <p></p>
                                    <a id="bank_btn" class="btn typebtn" type="bank"
                                       style="margin-top: 5px;margin-bottom: 15px; width: 170px; height: 30px; line-height: 30px;">{{trans("lang.yinhangka")}}</a>
                                       @endif
                        ...
                        <form id="Depositeform">
                            ...
                            <table style="width: 100%;" border="0" cellspacing="1" cellpadding="0">
                                ...
                                <tr class="b_rig recharge-data amount" style="display: table-row;">
                                    ...
                                    <td width="80%" style="display: flex;">
                                        <div align="left" style="float: left;position: relative;">
                                            <input name="money" id="PayMoney_usdt" style="width: 180px" onkeyup="this.value=this.value.replace(/\D/g,'');$('#account_usdt').val((Number(Number(this.value / {{$_system_config->usdt_lv}}).toFixed(2))+Number(usdt_pointer / 1000)).toFixed(3))" onafterpaste="this.value=this.value.replace(/\D/g,'')">
                                        </div>
                                ...
                                <!--</tr>-->
                                 ...
                                 <tr class="b_rig recharge-data deviceType">
                                    ...
                                    <td width="80%" style="display: flex;">
                                        <img src="{{$setting->trc_pic}}" width="100" height="100" style="margin-left: 0px;margin-top: 0px"/>
                                    </td>
                                </tr>
                        ...
                        <form id="Depositeform">
                            ...
                            <table style="width: 100%;" border="0" cellspacing="1" cellpadding="0">
                                        ...
                                        <div align="left">
                                            <select name="banksss" class="platform" id="banksss" style="width: 180px">
                                                ...
                                                @foreach(@$banks as $item)
                                                    <option data-cardno="{{ $item->card_no }}" data-username="{{ $item->username }}" value="{{ $item->id }}" data-bank_name="{{ $item->bank_name }}"  >{{ $item->bank_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </td>
                                ...
                                <tr class="b_rig recharge-data amount" style="display: table-row;">
                                    ...
                                    <td width="80%" style="display: flex;">
                                        <div align="left" style="float: left;position: relative;">
                                            <input name="money" id="PayMoney_bank" style="width: 180px" onkeyup="this.value=this.value.replace(/\D/g,'');$('#account_usdt').val((Number(Number(this.value / {{$_system_config->usdt_lv}}).toFixed(2))+Number({{$xiaoshu}} / 100)).toFixed(2))" onafterpaste="this.value=this.value.replace(/\D/g,'')">
                                        </div>
                                        <span class="style1" style="padding-left: 8px;">金額：100.00~2000000.00(元)</span>
                                    </td>
                                </tr>
                                ...
                                <tr class="b_rig recharge-data recharge-data-platform amount">
                                    ...
                                    <td width="80%">
                                        <div align="left" id="95404128" class="Payaccount chatNumber3"
                                             style="width: 130px;float: left;position: relative; line-height: 25px;">{{ @$banks[0]->card_no }}
                                        </div>
                                ...
                                <tr class="b_rig recharge-data recharge-data-platform amount">
                                    ...
                                    <td width="80%">
                                        <div align="left" id="95404128" class="Payaccount chatNumber4"
                                             style="width: 130px;float: left;position: relative; line-height: 25px;">{{ @$banks[0]->username }}
                                        </div>
...
var ok = 1;
    ...
    $('.repairSubBtn3').click(function () {
        ...
        // $('#paymoney').text(  (Number(Number($('#money').val() / {{$_system_config->usdt_lv}}).toFixed(2))+Number($('#xiaoshu').val() / 100)).toFixed(2));
