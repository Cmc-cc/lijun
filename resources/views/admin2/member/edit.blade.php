                ...
                <form class="form-horizontal cmxform" name="registerForm" id="form" action="{{ route('member.update', ['id' => $data->getKey()]) }}" method="post">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="name" name="name"  placeholder="用户名" value="{{ $data->name }}" readonly/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="number" class="form-control"  name="ml_money"  value="{{ $data->ml_money??0 }}"  />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="ml_money" class="col-sm-2 control-label">转盘次数</label>
                            <div class="col-sm-7">
                                <input type="number" class="form-control"  name="zhuanpan"  value="{{ $data->zhuanpan??0 }}"  />
                            </div>
                        </div>
                        {{--<div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="bank_username" name="username"  value="{{ $data->username }}"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <select name="bank" class="form-control">
                                    ...
                                    @foreach($banks as $vo)
                                    <option value="{{$vo}}" @if($data->bank==$vo) selected  @endif >{{$vo}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="bank_card" name="card"  value="{{ $data->card }}"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="bank_username" class="col-sm-2 control-label">转数快账号</label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="bank_branch_name" name="fps"  value="{{ $data->fps }}"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="bank_address" class="col-sm-2 control-label">USDT-ERC20</label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="bank_address" name="erc20"  value="{{ $data->erc20 }}"/>
                            </div>
                        </div>
                        \<div class="form-group">
                            <label for="trc20" class="col-sm-2 control-label">USDT-TRC20</label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="trc20" name="trc20"  value="{{ $data->trc20 }}"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="joker_top" name="joker_top" placeholder="0为跟随系统" value="{{ $data->joker_top }}"/>
                            </div>
                        </div>
                    </div><!-- /.box-body -->
