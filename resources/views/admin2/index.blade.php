...
@section('content')
    ...
    <div class="row apiList clearfix">
        ...
        <!--            <span>0</span>-->
        <!--            <a href="#" data-uri="{{ route('api.credit_all') }}" class="refresh" style="vertical-align: top" id="ty"></a>-->
        <!--        </div>-->
        <!--    </div>-->
        <!--</div>-->
        ...
        <div class="col-xs-2">
                ...
                <div class="text-center">
                    <label class="pull-left">乐娱总额度</label>
                    <div class="pull-right">
                        <span id="spacemoney">0.00</span>
...
//查询商户后台余额
$.ajax({
        url:'/api/credit?api_name=CURRENCY',
        contentType : "application/json; charset=utf-8",
        success:function(data){
            // var data = JSON.parse(data);
            $('#spacemoney').text(data.Data)
        }
    })
    $.ajax({
        url:'/api/credit?api_name=GB_HK',
        contentType : "application/json; charset=utf-8",
        success:function(data){
            // var data = JSON.parse(data);
