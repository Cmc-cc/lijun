        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="top_id" placeholder="上级代理" value="{{ $top_id }}">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="input-group">
                    <span class="input-group-addon">来源地址</span>
                    <input type="text" class="form-control" name="register_url" placeholder="来源地址" value="{{ $register_url }}">
                </div>
            </div>
        ...
        <div class="row" style="margin-bottom: 5px;">
            <div class="col-lg-3 pull-right">
                <div class="input-group">
                    ...
                    <a href="{{ route('member.create') }}" class="btn btn-primary">添加会员</a>&nbsp;
                </div>
            </div>
        </div>
    </form>
