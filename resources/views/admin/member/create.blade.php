    ...
    <section class="content">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form class="form-horizontal cmxform" name="registerForm" id="form" action="{{ route('member.store') }}" method="post">
                    {!! csrf_field() !!}
                    ...
                    <div class="box-body">
                       ...
                       {{-- <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="number" class="form-control" id="my-money" name=""  value="" readonly />
                            </div>
                        </div>--}}
                        <div class="form-group">
