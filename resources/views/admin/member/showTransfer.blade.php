                ...
                <div class="panel-body">
                                ...
                                <div class="col-lg-2">
                                    <div class="input-group">
                                        ...
                                        <select name="transfer_out_account" id="transfer_out_account" class="form-control">
                                            <option value="">--请选择--</option>
                                            <option value="中心账户" @if($transfer_out_account == '中心账户') selected @endif>中心账户</option>
                                ...
                                <div class="col-lg-2">
                                    <div class="input-group">
                                        ...
                                        <select name="transfer_in_account" id="transfer_in_account" class="form-control">
                                            <option value="">--请选择--</option>
                                            <option value="中心账户" @if($transfer_in_account == '中心账户') selected @endif>中心账户</option>
                                            @foreach($_api_list as $k => $v)
                                ...
                                <div class="col-lg-2">
                                    <div class="input-group">
                                        ...
                                        <select name="result" id="result" class="form-control">
                                            <option value="">--请选择--</option>
                                            <option value="0" @if(is_numeric($result) && $result == 0) selected @endif>请求成功</option>
                                            <option value="1" @if($result == 1) selected @endif>请求失败</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                    ...
                    <table class="table table-bordered table-hover text-center">
                        <tr>
                            ...
                            <th style="width: 10%">转入后金额</th>
                            <th style="width: 10%">转账时间</th>
                            <th style="width: 10%">接口结果</th>
                        </tr>
