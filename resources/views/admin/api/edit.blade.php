                ...
                <form class="form-horizontal" id="form" action="{{ route('apple.update', ['id' => $data->id]) }}" method="post">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="radio"  name="on_line" value="0" @if($data->on_line==0)checked @endif/>上线
                                <input type="radio"  name="on_line" value="1" @if($data->on_line==1)checked @endif/>下线
                                <input type="radio"  name="on_line" value="2" @if($data->on_line==2)checked @endif/>维护中
                            </div>
                        </div>
                        {{--<div class="form-group">
