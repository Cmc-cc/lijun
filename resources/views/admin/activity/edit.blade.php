                ...
                <form class="form-horizontal" id="form" action="{{ route('activity.update', ['id' => $data->getKey()]) }}" method="post">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" id="start_at" name="start_at" value="{{ $data->start_at }}"  />
                            </div>

                            <label for="end_at" class="col-sm-1 control-label">活动截止时间</label>
                            <div class="col-sm-3">
                                <input type="text" class="form-control" id="end_at" name="end_at" value="{{ $data->end_at }}"  />
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="number" class="form-control" id="pointer" name="pointer" value="{{ $data->pointer }}" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="pointer" class="col-sm-2 control-label">申请次数</label>
                            <div class="col-sm-7">
                                <input type="number" class="form-control" id="times" name="times" value="{{ $data->times }}"/>
                            </div>
                        </div>
                        {{--<div class="form-group">--}}
