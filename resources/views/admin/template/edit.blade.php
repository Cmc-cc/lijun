    ...
    <section class="content">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">修改模板</h3>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" id="form" action="{{ route('template.update',['id'=>$data->id]) }}" method="put">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="sort" class="col-sm-2 control-label">名称</label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" name="name" placeholder="请填写模板名称" value="{{$data->name}}" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <select class="form-control" name="client_type">
                                    <option value="1" @if($data->client_type==1)selected=""@endif>PC</option>
                                    <option value="2" @if($data->client_type==2)selected=""@endif>手机</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="sort" class="col-sm-2 control-label">名称</label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" name="template_name" placeholder="请填写模板路径" value="{{$data->template_name}}" />
                            </div>
                        </div>
                        <div class="form-group">
                                ...
                                <div id="files" class="files">
                                    @if($data->pic)
                                        <div class="pull-left" style="position:relative;margin: 10px;">
                                            <a href="{{ $data->pic }}" target="_blank"><img src="{{ $data->pic }}" alt="" style="width: 100px;"></a>
