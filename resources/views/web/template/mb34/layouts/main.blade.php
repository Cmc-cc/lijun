<!DOCTYPE html>
<html  id="ng-app" ng-app="portalApp" meidon-time="<?php echo "". date("Y/m/d h:i:s") . "";?>" moment-lang="zh-CN"  ng-init="'{{ $_system_config->site_title or 'motoo' }}'" style="overflow-x: hidden">
...
<head>
    ...
    <link href="/web/mb34/bundles/custom.css?v=5Wa8nqZwlBGzu1Pp_QLNPIWNPw7nHF_nimfxfdWB2fE1" rel="stylesheet"/>
    ...
    <link href="/web/mb34/bundles/home.css?v=LbK70f-uDrNcVMzWecnFowfQK8PsQdHY5MCniXPFqJs1" rel="stylesheet"/>
