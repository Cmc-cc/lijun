...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/web/mb8/fonts/iconfont.css') }}">
...
<script src="{{ asset('/web/mb8/js/jquery.lazyload.min.js') }}"></script>
<script src="{{ asset('/web/mb8/js/jquery.fly.min.js') }}"></script>
<script src="{{ asset('/web/mb8/js/common2.js') }}"></script>
<script src="{{ asset('/web/mb8/js/swfobject.js') }}"></script>
<script src="{{ asset('/web/js/float.js') }}"></script>
<script src="{{ asset('/web/mb8/js/slider.js') }}"></script>
@yield('after.js')
<script>
