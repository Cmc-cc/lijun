...
<head>
    ...
    <link href="/web/mb23/bundles/site.css" rel="stylesheet"/>
 @if($web_route == 'web.index')  <link href="/web/mb23/bundles/home.css?v=Z0I1MnqVfQ2Gxw7Nrs0FZ-E7HyV84bcUupfFjChrVWE1" rel="stylesheet"/> @else  @endif
...
@include('web.template.mb23.layouts.header')

@yield('content')
@include('web.template.mb23.layouts.aside')
...
@include('web.template.mb23.layouts.footer')
