...
<footer id="footer">
        <div class="wrapper">
            <ul id="footer-info">
                ...
                <li class="email">联系邮箱<span ng-bind="{{ $_system_config->agent_qq }}">{{ $_system_config->agent_qq }}</span></li>
                ...
                <li class="chat" ng-click=""onclick="javascript:window.open('{{ $_system_config->service_link }}','','width=1024,height=768')">在线客服<span>7X24小时</span></li>
            </ul>
