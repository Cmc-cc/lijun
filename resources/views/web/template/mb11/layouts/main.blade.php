...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/web/mb11/css/style.css') }}">
...
@include('web.template.mb11.layouts.header')

@yield('content')
@include('web.template.mb11.layouts.aside')
@include('web.template.mb11.layouts.footer')
...
<script src="{{ asset('/web/mb11/js/jquery.lazyload.min.js') }}"></script>
<script src="{{ asset('/web/mb11/js/jquery.fly.min.js') }}"></script>
<script src="{{ asset('/web/mb11/js/common.js') }}"></script>
<script type="text/javascript">
    (function(){
        $(function(){
            colorChange([{obj:'.header .right a',sourcrCr:'rgb(215, 22, 20)',afterCr:'rgb(236, 215, 19)'},{obj:'.activity',sourcrCr:'#fff',afterCr:'#ff0000'}]);
        })
    })(jQuery);
</script>
@yield('after.js')
