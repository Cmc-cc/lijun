...
<div class="footer">
    <div class="foot-bank">
        <img src="{{ asset('/web/mb5/images/foot-bank.jpg') }}"/>
    </div>
    <div class="foot-content">
        <div>
            ...
            <a href="javascript:;"
               onclick="javascript:window.open('{{ $_system_config->service_link }}','','width=1024,height=768')">联系我们 </a>
...
<div id="dailiModal" class="modal modal-login modal-daili" style="display: none">
