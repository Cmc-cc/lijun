...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/web/mb12/css/swiper.min.css') }}">
    <link rel="stylesheet" href="{{ asset('/web/mb12/css/style.css') }}">
    <link rel="stylesheet" href="{{ asset('/web/mb12/css/common.css') }}">
    <link rel="stylesheet" href="{{ asset('/web/mb12/css/yk_modal.css') }}">
...
<script src="{{ asset('/web/mb12/js/swiper-3.4.2.min.js') }}"></script>
...
<script src="{{ asset('/web/mb12/js/jquery.lazyload.min.js') }}"></script>
<script src="{{ asset('/web/mb12/js/jquery.fly.min.js') }}"></script>
