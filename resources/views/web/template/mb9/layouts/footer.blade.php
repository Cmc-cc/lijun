<div id="page-footer">
    <div class="footer">
        <div class="footer-logo-wrap clearfix">
            <a id="bblogo" href="#" target="_blank"></a>
            <a id="browser-logo" href="#">
                <img src="{{ asset('/web/mb9/images/ublogo.png') }}" border="0" width="128">
            </a>
        </div>
        <div class="article-menu">
            <a href="javascript:;" target="_blank" class="js-article-color aboutUs_modal">
                关于我们
            </a>
            ｜ <a href="javascript:;" target="_blank" class="js-article-color"
                 onclick="javascript:window.open('{{ $_system_config->service_link }}','','width=1024,height=768')">
                联络我们
            </a>
            ｜ <a href="javascript:;" target="_blank" class="js-article-color daili_apply">
                加盟代理
            </a>
            ｜ <a href="javascript:;" target="_blank" data-color="#FFFFFF" class="js-article-color cunkuanHelp_modal"
                 style="color: rgb(255, 255, 255);">
                存款帮助
            </a>
            ｜ <a href="javascript:;" target="_blank" class="js-article-color qukuanHelp_modal">
                取款帮助
            </a>
            ｜ <a href="javascript:;" target="_blank" class="js-article-color normalQues_modal">
                常见问题
            </a>
        </div>
