<div id="page-footer">
    <div class="footer">
        <div class="footer-imgs clearfix">
            <a href="https://bb-in.cc" target="_blank" id="bblogo"></a>
            <a id="browser-logo" href="">
                <img src="{{ asset('/web/mb19/images/ublogo.png') }}" border="0" width="100" height="36"/>
            </a>
        </div>

        <div class="article-menu">
            <a href='javascript:;' class="js-article-color aboutUs_modal">
                關於我們
            </a>
            ...
            &nbsp;\&nbsp; <a href='javascript:;' data-color=""
                             class="js-article-color daili_apply">
                代理加盟
            </a>
            &nbsp;\&nbsp; <a href='javascript:;' data-color=""
                             class="js-article-color cunkuanHelp_modal">
                存款幫助
            </a>
            &nbsp;\&nbsp; <a href='javascript:;' data-color=""
                             class="js-article-color qukuanHelp_modal">
                取款幫助
            </a>
            &nbsp;\&nbsp; <a href='javascript:;' data-color=""
                             class="js-article-color normalQues_modal">
                常見問題
            </a>
            &nbsp;\&nbsp; <a href='{{route('daili.init')}}' data-color=""
                             target="_blank">
                代理登陆
            </a>
        </div>
        <div class="copyright">Copyright &copy; 澳门银河在线娱乐 Reserved</div>
