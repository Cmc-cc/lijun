...
<head>
    ...
    <link href="/web/mb30/bundles/site.css" rel="stylesheet"/>
...
@include('web.template.mb30.layouts.header')

@yield('content')
@include('web.template.mb30.layouts.aside')
...
@include('web.template.mb30.layouts.footer')
