<footer id="footer">
    <div class="wrapper">
        <ul id="footer-nav">
            ...
            <li>
                <a href="javascript:void (0)" onclick="javascript:window.open('{{ $_system_config->service_link }}','','width=1024,height=768')">
                    联系我们</a>
            </li>
            <li>
            ...
            <li toggle-color>
                <a href="{{ route('web.eGame') }}">九大電子优惠</a>
            </li>
            <li toggle-color>
                <a href="{{ route('web.poker') }}">五大棋牌优惠</a>
            </li>

        </ul>
        <div class="easy-domain">
            易记域名：
            <span>{{ $_system_config -> site_domain }}</span>
        </div>
        <div id="footer-logo">
            <div class="left-logo fadeInLeft"></div>
            <div class="right-logo fadeInRight"></div>
        </div>
        <p id="footer-suggest">
