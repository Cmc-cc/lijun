...
<div class="footer">
    <div class="wrap">
        ...
        <div class="company">
            <dl>
                <dt>合作伙伴:</dt>
                <dd><img src="{{ asset('/web') }}/mb16/images/company01.png"></dd>
            </dl>
            <dl>
                <dt>监管机构:</dt>
                <dd><img src="{{ asset('/web') }}/mb16/images/company02.png"></dd>
            </dl>
            <dl>
                <dt>推荐浏览器:</dt>
                <dd>
                    <a href="javascript:;"><img src="{{ asset('/web') }}/mb16/images/browser01.png"></a>
                    <a href="javascript:;"><img src="{{ asset('/web') }}/mb16/images/browser02.png"></a>
                    <a href="javascript:;"><img src="{{ asset('/web') }}/mb16/images/browser03.png"></a>
                    <a href="javascript:;"><img src="{{ asset('/web') }}/mb16/images/browser04.png"></a>
                    <a href="javascript:;"><img src="{{ asset('/web') }}/mb16/images/browser05.png"></a>
                </dd>
            </dl>
        </div>
        <div class="copyright">
            PT游戏是由PT TransPacific在 <img src="{{ asset('/web') }}/mb16/images/i-pagcor.png">的授权下部署
        </div>
    </div>
</div>
