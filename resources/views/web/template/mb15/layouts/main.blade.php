...
<script src="{{ asset('/web/mb15/js/jquery.lazyload.min.js') }}"></script>
<script src="{{ asset('/web/mb15/js/jquery.fly.min.js') }}"></script>
<script src="{{ asset('/web/mb15/js/swfobject.js') }}"></script>
