...
<div class="footer">
    <div class="wrap">
        <div class="top">
            <img src="{{ asset('/web') }}/mb15/images/footer_img01.png">
        </div>
        <div class="copyright">
            <a href="javascript:;"><img src="{{ asset('/web') }}/mb15/images/white.png"></a>
            <a href="javascript:;"><img src="{{ asset('/web') }}/mb15/images/ublogo.png"></a>
