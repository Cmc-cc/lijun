<footer id="footer">
    <div class="wrapper">
        <ul id="footer-logo">
            <li class="brands">
                <h3><span class="">{{ $_system_config ->site_name }}</span>旗下品牌</h3>
                <a href="{{ route('web.liveCasino') }}" class="casino"></a>
                <a href="{{ route('web.eGame') }}" class="games"></a>
                <a href="{{ route('web.esports') }}" class="sport"></a>
            </li>
            <li class="partner">
                <h3>合作伙伴</h3>
            </li>
            <li class="browsers">
                <h3>推荐浏览器</h3>
                <ul>
                    <li class="maxthon"><a href="http://www.maxthon.cn/"></a></li>
                    <li class="chrome"><a href="http://www.google.cn/chrome/browser/desktop/index.html"></a></li>
                    <li class="firefox"><a href="http://www.firefox.com.cn/"></a></li>
                    <li class="ub"><a href="https://www.ub66.com/"></a></li>
                </ul>
            </li>
            <li class="safe">
                <h3>安全与信任</h3>
