...
<head>
 ...
 @if($web_route == 'web.index')  <link href="/web/mb26/bundles/home.css?v=Z0I1MnqVfQ2Gxw7Nrs0FZ-E7HyV84bcUupfFjChrVWE1" rel="stylesheet"/> @else  @endif
...
@include('web.template.mb26.layouts.header')

@yield('content')
@include('web.template.mb26.layouts.aside')
...
@include('web.template.mb26.layouts.footer')
