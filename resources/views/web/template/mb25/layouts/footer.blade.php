...
<footer id="footer">
        <div class="wrapper">
            <ul id="footer-info">
                <li class="footer-info01"><span>联系电话<span ng-cloak>{{ $_system_config->phone1 }}</span></span></li>
                <li class="footer-info02"><span>联系邮箱<span ng-cloak>{{ $_system_config->agent_qq }}</span></span></li>
                <li class="footer-info03" ng-click=""onclick="javascript:window.open('http://wpa.qq.com/msgrd?V=3&uin={{ $_system_config->qq}}&Site=QQ客服&Menu=yes','','width=1024,height=768')"><span>客服QQ<span ng-bind="{{ $_system_config->qq }}"></span></span></li>
                <li class="footer-info04" ng-click=""onclick="javascript:window.open('{{ $_system_config->service_link }}','','width=1024,height=768')"><span>在线客服<span>7X24小时</span></span></li>
            </ul>
