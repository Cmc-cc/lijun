...
<div class="footer">
    <div class="wrap">
        <div class="top">
            <dl>
                <dt><img src="{{ asset('/web') }}/mb20/images/f_icon01.png"></dt>
                <dd>
                    <p class="tit">澳门热线</p>
            ...
            <dl>
                <dt><img src="{{ asset('/web') }}/mb20/images/f_icon02.png"></dt>
                <dd>
                    <p class="tit">联系邮箱</p>
            ...
            <dl>
                <a href="javascript:;" onclick="javascript:window.open('{{ $_system_config->service_link }}','','width=1024,height=768')">
                    <dt><img src="{{ asset('/web') }}/mb20/images/f_icon03.png"></dt>
                    <dd>
        ...
        <div class="middle">
            <a href="javascript:;" class="bblogo"><img src="{{ asset('/web') }}/mb20/images/bbinlogo.png"></a>
        </div>
        <div class="copyright">
            <div class="left">
                <a href="javascript:;" class="aboutUs_modal">关于我们</a>
                <a href="javascript:;"
                   onclick="javascript:window.open('{{ $_system_config->service_link }}','','width=1024,height=768')">联络我们</a>
...
<div class="goTop">
    <a href="javascript:void(0)"><img src="{{ asset('/web') }}/mb20/images/float_top_up.png"></a>
</div>
