...
<head>
    ...
    <link href="/web/mb24/bundles/site.css" rel="stylesheet"/>
 @if($web_route == 'web.index')  <link href="/web/mb24/bundles/home.css?v=Z0I1MnqVfQ2Gxw7Nrs0FZ-E7HyV84bcUupfFjChrVWE1" rel="stylesheet"/> @else  @endif
...
@include('web.template.mb24.layouts.header')

@yield('content')
@include('web.template.mb24.layouts.aside')
...
@include('web.template.mb24.layouts.footer')
