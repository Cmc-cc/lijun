...
<footer id="footer">
        <div class="wrapper">
            <ul id="footer-info">
                <li class="tel">联系电话<span ng-bind="{{ $_system_config->phone1 }}"></span></li>
                <li class="mail">联系邮箱<span ng-bind="{{ $_system_config->agent_qq }}">{{ $_system_config->agent_qq }}</span></li>
                <li class="qq" ng-click=""onclick="javascript:window.open('http://wpa.qq.com/msgrd?V=3&uin={{ $_system_config->qq}}&Site=QQ客服&Menu=yes','','width=1024,height=768')">客服QQ<span ng-bind="{{ $_system_config->qq }}"></span></li>
                <li class="tel tel2" ng-click=""onclick="javascript:window.open('{{ $_system_config->service_link }}','','width=1024,height=768')">在线客服<span>7X24小时</span></li>
            </ul>
