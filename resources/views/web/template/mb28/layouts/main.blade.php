...
<head>
    ...
    <link href="/web/mb28/bundles/site.css" rel="stylesheet"/>
 @if($web_route == 'web.index')  <link href="/web/mb28/bundles/home.css?v=Z0I1MnqVfQ2Gxw7Nrs0FZ-E7HyV84bcUupfFjChrVWE1" rel="stylesheet"/> @else  @endif
...
@include('web.template.mb28.layouts.header')

@yield('content')
@include('web.template.mb28.layouts.aside')
...
@include('web.template.mb28.layouts.footer')
    ...
    $(document).ready(function () {
        $(window).on('scroll', function () {
            if ($(this).scrollTop() > 380) {
                $('#account-bot').removeClass('home-account');
                $('#news').removeClass('home-news');
            } else {
                $('#account-bot').addClass('home-account');
                $('#news').addClass('home-news');
            }
        });
    });
    jQuery("#slide-img").slide({ mainCell: ".main-cell ul", autoPlay: true, effect: "topMarquee", vis: 4, interTime: 20 });
</script>
