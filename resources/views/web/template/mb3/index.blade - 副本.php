...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="{{$_system_config->ico}}">
...
<body>
<div class="container">
    @if($_system_config->is_zhuanpan == 0)
                    ...
                    <div class="banner" style="height:430px;">
                        <div class="wrapper" style="width: 100%;">
                            <div class="banner-img">
                                ...
                                <div class="banner-item" style="position: absolute;background: url({{ $item->path }}) no-repeat center center;background-size: 100% 100%;"></div>
                                @endforeach
