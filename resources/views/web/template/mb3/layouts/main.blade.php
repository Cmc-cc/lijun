...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/web/mb3/css/yk_modal.css') }}">
    <link rel="stylesheet" href="{{ asset('/web/mb3/fonts/iconfont.css') }}">
...
<script src="{{ asset('/web/mb3/js/jquery.lazyload.min.js') }}"></script>
<script src="{{ asset('/web/mb3/js/jquery.fly.min.js') }}"></script>
