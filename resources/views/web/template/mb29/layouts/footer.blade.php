...
<footer id="footer">
    <div class="wrapper">
        ...
        {{--<div class="wrapper">
            --}}{{--<ul id="footer-info">
                <li class="tel"><span>联系电话<span ng-cloak>{{ $_system_config->phone1 }}</span></span></li>
                <li class="email"><span>联系邮箱<span ng-cloak>{{ $_system_config->agent_qq }}</span></span></li>
                <li class="qq" ng-click=""onclick="javascript:window.open('http://wpa.qq.com/msgrd?V=3&uin={{ $_system_config->qq}}&Site=QQ客服&Menu=yes','','width=1024,height=768')"><span>客服QQ<span ng-bind="{{ $_system_config->qq }}"></span></span></li>
                <li class="chat" ng-click=""onclick="javascript:window.open('{{ $_system_config->service_link }}','','width=1024,height=768')"><span>在线客服<span>7X24小时</span></span></li>
            </ul>--}}{{--
            <div class="wrapper">
                <ul id="footer-info">
                    <li class="about">
                        Copyright &#169;️ 澳门威尼斯人 Reserved 澳门威尼斯人乃正式注册的网上博彩公司。版权为澳门威尼斯人 所有&#169;️2017
                        <div>
                            <span class="email" ng-bind="ContactInfo.Email"></span>
                            <span class="tel" ng-bind="ContactInfo.TEL"></span>
                        </div>
                        <a class="launcher" href="https://ub.xf0371.com/UB/UB-Launcher.exe" target="_blank"></a>
                    </li>
                    <li class="logo">
                        <h1>合作平台</h1>
                        <div id="footer-logo"></div>
                    ...
                    <li class="mobile" style="background: none;height: 0px;">
                        <span class="title">随时随地，手机投注<span class="en">Mobile Betting</span></span>
                        我们的手机投注平台面向全网玩家，提供近百款老虎机·百家乐·以及彩票游戏投注，线上存款及线上取款，一键操作，运用3D即时运算创造真实场景结合立体影像。
                        <span class="qrcode apple">苹果APP下载</span>
                        <span class="qrcode android">安卓APP下载</span>
                    </li>
                </ul>
            </div>
            --}}{{--<div id="footer-logo"></div>--}}{{--
