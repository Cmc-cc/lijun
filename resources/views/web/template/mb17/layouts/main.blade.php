...
<script src="{{ asset('/web/mb17/js/index1.js') }}"></script>
<script src="{{ asset('/web/mb17/js/common.js') }}"></script>
<script src="{{ asset('/web/mb17/js/yk_modal.js') }}"></script>
<script src="{{ asset('/web/mb17/js/jquery.SuperSlide.2.1.1.js') }}"></script>
<script src="{{ asset('/web/layer/layer.js') }}"></script>
<script src="{{ asset('/web/mb17/js/ajax-submit-form.js') }}"></script>
<script src="{{ asset('/web/mb17/js/jquery.lazyload.min.js') }}"></script>
<script src="{{ asset('/web/mb17/js/jquery.fly.min.js') }}"></script>
@yield('after.js')
<script>
