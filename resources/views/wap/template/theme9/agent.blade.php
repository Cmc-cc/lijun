                        ...
                        <div class="@if($_member -> is_daili == 1) pull-left @else pull-right @endif">
                            ...
                            @else
                                ...
                                @elseif($apply && $apply->status == 2)
                                    ...
                                    <a href="{{ route('wap.agent_apply') }}"  style="width: 120%;font-size: 10px;background: #f13130" class="submit_btn text-center">重新申请</a>
                                ...
                                @else
                                    ...
                                    <a href="{{ route('wap.agent_apply') }}" style="background: #f13130" class="submit_btn text-center">立即申请</a>
                        @endif
                        @endif
                    </dd>
                    <dd>
