...
@section('content')
    ...
    <div class="userInfo wrap" style="padding: 10px;">
        ...
        <form id="form1" name="form1" action="{{ route('wap.post_qq_pay') }}" method="post">
            ...
            <button type="button" class="sbtech-widget-cashier-submit-payment__btn ajax-submit-btn" id="SubTran" style="width: 100%;background-color: rgb(66,96,132) !important">提交信息
            </button>
        </form>
