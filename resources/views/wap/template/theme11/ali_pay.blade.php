...
@section('content')
    ...
    <div class="am-navbar am-navbar-dark">
        ...
        <div class="am-navbar-title">支付宝支付</div>
        ...
        <div style="flex: 1 1 0%;">
            <div class="userInfo wrap" style="padding: 10px;">
                ...
                <table class="text-center" width="100%"  border="0" cellpadding="0" cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span class="copy"
                                  data-clipboard-text="{{ $_system_config->alipay_account }}" style="color: #e4393c">复制</span>
                        </td>
                    </tr>
                    <tr>
                        <td>收款支付宝昵称</td>
                ...
                <form id="form1" name="form1" action="{{ route('wap.post_ali_pay') }}" method="post">
                    ...
                    <button type="button" class="submit_btn ajax-submit-btn" id="SubTran" style="width: 100%;background-color: #00623b">提交信息</button>
                </form>
