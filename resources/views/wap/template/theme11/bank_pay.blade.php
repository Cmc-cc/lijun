...
@section('content')
    ...
    <div class="am-navbar am-navbar-dark">
        ...
        <div class="am-navbar-title">银行卡支付</div>
        ...
        <div style="flex: 1 1 0%;">
            <div class="userInfo wrap" style="padding: 10px;">
                    ...
                    <table class="text-center" width="100%" border="0" cellpadding="0" cellspacing="1">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:(0)"
                                   class="copy"
                                   data-clipboard-text="{{ \App\Models\Base::$BANK_TYPE[$item->bank_id] }}"
                                   style="color:#f00;margin-left:10px">点我复制</a>
                            </td>
                        </tr>
                        <tr>
                            <td>银行账号</td>
                            ...
                            <td >
                                <a href="javascript:(0)"
                                   class="copy"
                                   data-clipboard-text="{{ $item->card_no }}"
                                   style="color:#f00;margin-left:10px">点我复制</a>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <a href="javascript:(0)"
                                   class="copy"
                                   data-clipboard-text="{{ $item->username }}"
                                   style="color:#f00;margin-left:10px">点我复制</a>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <a href="javascript:(0)"
                                   class="copy"
                                   data-clipboard-text="{{ $item->bank_address }}"
                                   style="color:#f00;margin-left:10px">点我复制</a>
                            </td>
                        </tr>
                        </tbody>
                ...
                <form id="form1" name="form1" action="{{ route('wap.bank_pay') }}" method="post">
                    ...
                    <button type="button" class="submit_btn ajax-submit-btn" id="SubTran" style="width: 100%;background: #00623b">提交信息</button>
                    <button onclick="history.go(-1)" type="button" class="submit_btn" style="width: 100%;background: #00623b">返回</button>
                </form>
