...
<div class="header">
    <div class="fr hd-icon" style="margin-top: 13px;">
        <a href="{{ $_system_config->service_link }}">
            <i><img src="{{ asset('/wap/theme4/images/icon_contact.png') }}" width="20" height="19" /></i> 客服
        </a>
    </div>
    <h1>
...
<div class="login-wrap clearboth">
    ...
    <div class="mt10 clearboth"><a class="log-btn reg-btn fr" href="{{ route('wap.register') }}">注册</a><!--<a class="log-btn forget-psw-btn" href="forget.html">忘记密码</a>--></div>
