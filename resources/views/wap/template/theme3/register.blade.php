        ...
        <div data-v-1ea183fe="" class="register view">
            ...
            <div data-v-1ea183fe="" style="padding: 20px 10px;">
                ...
                <div data-v-1ea183fe="" class="margin-bottom" id="Introducer">
                    <div data-v-1ea183fe="" class="register-hint">@if($_system_config->is_regtj_2 == 1)*@endif介绍人</div>
                ...
                <div data-v-1ea183fe="" class="margin-bottom">
                    <div data-v-1ea183fe="" class="register-hint">@if($_system_config->is_real_name_2 == 1)*@endif与银行帐号姓名相同，否则不能出款</div>
                    <div data-v-1ea183fe="" class="register-item">
                ...
                <div data-v-1ea183fe="" class="margin-bottom" id="UserPhone" >
                    <div data-v-1ea183fe="" class="register-hint">@if($_system_config->is_phone_2 == 1)*@endif请输入手机号码</div>
                    <div data-v-1ea183fe="" class="register-item">
                ...
                <div data-v-1ea183fe="" class="margin-bottom"  id="Mailbox">
                    <div data-v-1ea183fe="" class="register-hint">@if($_system_config->is_qq_2 == 1)*@endif联系QQ</div>
                    <div data-v-1ea183fe="" class="register-item">
                        <label data-v-1ea183fe="" for="account">
                ...
                <div data-v-1ea183fe="" class="margin-bottom"  id="Mailbox">
                    <div data-v-1ea183fe="" class="register-hint">@if($_system_config->is_email_2 == 1)*@endif邮箱邮箱为您常用的邮箱</div>
                    <div data-v-1ea183fe="" class="register-item">
                        <label data-v-1ea183fe="" for="account">
                ...
                <div data-v-1ea183fe="" class="margin-bottom"  id="Mailbox">
                    <div data-v-1ea183fe="" class="register-hint">@if($_system_config->is_weixin_2 == 1)*@endif微信号/div>
                    <div data-v-1ea183fe="" class="register-item">
                        <label data-v-1ea183fe="" for="account">
                ...
                <div data-v-1ea183fe="" class="margin-bottom">
                    ...
                    <div data-v-1ea183fe="" class="register-item">
                        <label data-v-1ea183fe="">
                            ...
                            <img data-v-1ea183fe=""  onclick="javascript:re_captcha();" src="{{ URL('kit/captcha/1') }}" middle="" alt="" class="yzm—img" id="c2c98f0de5a04167a9e427d883690ff6">
                            <script>
                                function re_captcha() {
                                    $url = "{{ URL('kit/captcha') }}";
                                    $url = $url + "/" + Math.random();
            ...
            {{--<p data-v-1ea183fe="" class="agreement">
            <span data-v-1ea183fe="" relative="" style="">
                <svg data-v-1ea183fe="" class="md-icon md-icon-circle-right md" middle="" style="">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#circle-right"></use></svg> <span data-v-1ea183fe="">本人同意</span>
                <a data-v-1ea183fe="" href="javascript:void(0);" onclick="openAgreementClick()">&lt;开户协议&gt;&gt;</a>
            </span>
            </p>--}}
            <div data-v-1ea183fe="" style="padding: 1.33333rem 10px;">
                <button id='reg' data-v-1ea183fe="" type="button" class="md-button primary large" style="background-color: rgb(0, 0, 0);" {{--onclick="regCaptcha()"--}} >
                    ...
                    <div class="md-popup-box fade" style="display: none;">
                        <div class="content scroll">
                            ...
                            <div data-v-1ea183fe="" class="agree-text">
                                ...
                                <p style="white-space: normal;">5、成为本站点有效会员后，客户有责任以在线客服、電子邮件、在本站点网站上联系我们，随时向本公司提供最新的个人资料。</p>
