    ...
    <main class="panel slideout-panel slideout-panel-left">
        ...
        <div data-v-f645c2cc="" class="login view" style="">
            <div data-v-f645c2cc="" relative="" class="logo">
                <img data-v-f645c2cc="" src="{{ $_system_config->m_site_logo }}" middle-center="" alt=""></div>
            <form id="loginForm"  action="{{ route('wap.login.post') }}" method="post">
                <div data-v-f645c2cc="" class="login-content">
                    <div data-v-f645c2cc="" relative="" class="login-item" id="longUserName">
                        ...
                        <span data-v-f645c2cc="" middle="" class="login-info">
                            <img data-v-f645c2cc="" src="{{asset('/wap/theme3/images/main/menu-profile.png')}}" alt="" middle="">
                    ...
                    <div data-v-f645c2cc="" relative="" class="login-item" style="margin-top: 10px;" id="longUserPwd">
                        ...
                        <span data-v-f645c2cc="" relative="" class="login-info">
                            <img data-v-f645c2cc="" src="{{asset('/wap/theme3/images/main/menu-modifypwd.png')}}" alt="" middle="">
                    ...
                    {{--<div data-v-f645c2cc="" relative="" class="login-item" style="margin-top: 10px;">
                        <label data-v-f645c2cc="" for="password">
                        <span data-v-f645c2cc="" relative="" class="login-info">

                            <span data-v-f645c2cc="">验证码</span>
                        </span>
                            <input data-v-f645c2cc="" type="number" middle="" id="loginUsercode" onfocus="$('#loginpin').click()" style=" ">
                        </label>
                        <img src="/api/Vaildatacode" id="loginpin" onclick="changeCode(this)" style="" />
                    </div>--}}
                </div>
                <div data-v-f645c2cc="" class="buttons">
                    ...
                    <button data-v-f645c2cc="" type="button" class="md-button button-item primary large" style=" " onclick="window.location.href='{{ route('wap.register') }}'">
