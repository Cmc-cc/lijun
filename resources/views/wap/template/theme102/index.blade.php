				...
				<div style="height: 100%;width: 78%;display: flex;align-items: center;justify-content: flex-end;">
					...
					<div class="language-box">
						<div class="language-setting">
							<a class="btn-language" style="height: 40px;width:40px;display: block;background:url({{trans('lang.png')}});    background-size: 100% 100%;">
							</a>
				...
				<div class="swiper-container swiper-container-initialized swiper-container-horizontal swiper-container-ios">
    				<div class="swiper-wrapper" >
    					<div class="swiper-slide" data-swiper-slide-index="0" >
    						<a><img src="/css/img/4f9d541593d82b5431e7a0d188b5807d28dc7af.jpg" style="border-radius: 0.5rem;"></a>
    					</div>
    					<div class="swiper-slide" data-swiper-slide-index="1" >
    						<a><img src="/css/img/4f9d541593d82b5431e7a0d188b5807d28daf.jpg" style="border-radius: 0.5rem;"></a>
    					</div>
    					<div class="swiper-slide" data-swiper-slide-index="1" >
    						<a><img src="/css/img/4f9d541593d82b5431e7a0d188b5807d28dc71af.jpg" style="border-radius: 0.5rem;"></a>
    					</div>
    					<div class="swiper-slide" data-swiper-slide-index="1" >
    						<a><img src="/css/img/4f9d541593d82b5431e7a0d188bd248dc7a.jpg" style="border-radius: 0.5rem;"></a>
    					</div>
    					<div class="swiper-slide" data-swiper-slide-index="1" >
    						<a><img src="/css/img/4f9d541593d82b0d188bd248dc7a.jpg" style="border-radius: 0.5rem;"></a>
    					</div>
    					<div class="swiper-slide" data-swiper-slide-index="2" >
    						<a><img src="/css/img/4f9d54153d82b5431e7a0d188b5807d248dc7.jpg"style="border-radius: 0.5rem;"></a>
    					</div>
    					<div class="swiper-slide" data-swiper-slide-index="3" >
    						<a><img src="/css/img/4f9d541593d82b5431e7a0d18b5807d248dc.jpg"style="border-radius: 0.5rem;"></a>
    					</div>
    					<div class="swiper-slide" data-swiper-slide-index="4" >
    						<a><img src="/css/img/4f9d541593d82b5431e7a0188b580748dc.jpg" style="border-radius: 0.5rem;"></a>
    					</div>
    				</div>
					...
					<div class="tab-left">
						<div class="onlineusers">
							<div class="onlineusersimg">
							    {{trans("lang.zxrs")}}:
								<span class="onlinepeople">41332</span>
							</div>
						</div>
						<!-- <p><span id='account' class="person-name" style="font-size: 3vmin; color: #b1987f; font-weight: 400;"></span><i></i></p> -->
						<div class="moneystyle">
							<span class="mark-txt">點數：{{@$_member -> money?$_member -> money:'0.00'}}</span>
						</div>
					</div>
					<div class="tab-right">
						<div class="tab-right-btn trans-btn">
							<div class="transfer-icon" onclick="location.href='/m/transfer'"></div>
							<h4 style="color:#b1987f; font-size: 3vmin; font-weight: 400;width: 50px;padding: 0 10px;">{{trans("lang.edzh")}}</h4>
						</div>
				...
				<div id="gamelist-wrapper" class="gamelist-wrapper">
					<div class="gamelist-item">
						...
						<div class="gameitem" gamelistbtn="esports">
							...
							<span class="gameitem-text">{{trans('lang.dianjing')}}</span>
						</div>
						...
						<!--	<span class="gameitem-text">{{trans("lang.caipiao")}}</span>-->
						<!--</div>-->
						<!--<div class="gameitem liveBroadcast" gamelistBtn="liveBroadcast">-->
                           <!-- <span class="gameitem-text" style="width:auto;    margin-right: 10px;">{{trans('lang.xxq')}}</span>-->
                       <!-- </div>-->
					</div>
					<div class="gamelist-content">
						<div class="gamelist-type active" gamelisttype="live">
						    
						  <!--    <div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=OB&game_type=1&game_code=&devices=1" @else data-url="" @endif data-code="OB">
							...
							<div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=SEXY&game_type=1&game_code=&devices=1" @else data-url="" @endif data-code="SEXY">
								<div class="gameImage-SEXYLiveCasino"></div>
							</div>							
							<div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=WM&game_type=1&game_code=&devices=1" @else data-url="" @endif data-code="WM">
								<div class="gameImage-WM"></div>
							</div>
							<div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=BBIN&game_type=1&game_code=&devices=1" @else data-url="" @endif data-code="BBIN">
								<div class="gameImage-bbinLiveCasino"></div>
							</div>
							<div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=EVO&game_type=1&game_code=&devices=1" @else data-url="" @endif data-code="EVO">
								<div class="gameImage-EVOLiveCasino"></div>
							</div>
						</div>

						<div class="gamelist-type" gamelisttype="chess">
							<!--<div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=GDQ&game_type=6&game_code=&devices=1" @else data-url="" @endif data-code="GDQ">
								<div class="gameImage-GDQChess"></div> 
							</div>-->
							
							
							
							<div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=LEG&game_type=6&game_code=&devices=1" @else data-url="" @endif data-code="LEG">
								<div class="gameImage-LEGChess"></div>
							</div>
							<div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=KY&game_type=6&game_code=&devices=1" @else data-url="" @endif data-code="KY">
								<div class="gameImage-KAIYUANChess"></div>
							</div>
							<div class="game-btn gamelist-row toplay" @if($_member) data-url="/api/gamelist?api_code=BL&game_type=6&devices=1" @else data-url="" @endif data-code="BL">
								<div class="gameImage-BOLEChess"></div>
							</div>
							<div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=DTQP&game_type=6&game_code=&devices=1" @else data-url="" @endif data-code="DTQP">
						...
						<div class="gamelist-type" gamelisttype="slotgame">
							...
							<div class="game-btn gamelist-col electronicgames btn-pages toplay"  @if($_member) data-url="/game/playGame?plat_type=JOKER&game_type=3&game_code=&devices=1" @else data-url="" @endif data-code="JOKER">
								<div class="gameImage-JOKERSlotgame"></div>
							</div>
							
							<div class="game-btn gamelist-col electronicgames btn-pages toplay"  @if($_member) data-url="/game/playGame?plat_type=CQ9&game_type=3&game_code=&devices=1" @else data-url="" @endif data-code="CQ9">
								<div class="gameImage-CQ9Slotgame"></div>
							</div>
							
							<div class="game-btn gamelist-col toplay" @if($_member) data-url="/game/playGame?plat_type=JDB&game_type=3&game_code=&devices=1" @else data-url="" @endif data-code="JDB">
                         ...
                         <!--   <div class="game-btn gamelist-col electronicgames btn-pages toplay"  @if($_member) data-url="/game/playGame?plat_type=BBIN&game_type=1&game_code=&devices=1" @else data-url="" @endif data-code="BBIN">
								<div class="gameImage-CQ9Slotgame"></div>   
							</div>-->
							<div class="game-btn gamelist-col electronicgames btn-pages toplay"  @if($_member) data-url="/game/playGame?plat_type=PNG&game_type=3&game_code=&devices=1" @else data-url="" @endif data-code="PNG">
								<div class="gameImage-PNGSlotgame"></div>
							</div>
							<div class="game-btn gamelist-col electronicgames btn-pages toplay"  @if($_member) data-url="/game/playGame?plat_type=PG&game_type=3&game_code=&devices=1" @else data-url="" @endif data-code="PG">
								<div class="gameImage-PGSlotgame"></div>
							</div>
							<div class="game-btn gamelist-col electronicgames btn-pages toplay"  @if($_member) data-url="/game/playGame?plat_type=PP&game_type=3&game_code=&devices=1" @else data-url="" @endif data-code="PP">
						...
						<div class="gamelist-type" gamelisttype="fish">
							...
							<div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=FISH&game_type=redirect&devices=1" @else data-url="" @endif >
						...
						<div class="gamelist-type" gamelisttype="sport">
						    <div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=HG&game_type=5&game_code=&devices=1" @else data-url="" @endif data-code="HG">
								<div class="gameImage-HG"></div>
							</div>						    
						    <div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=CMD&game_type=5&game_code=&devices=1" @else data-url="" @endif data-code="CMD">
								<div class="gameImage-CMD"></div>
							</div>
						    
						    <div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=SBO&game_type=5&devices=1" @else data-url="" @endif data-code="SBO">
								<div class="gameImage-SBO"></div>
							</div>
							<div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=OB&game_type=5&devices=1" @else data-url="" @endif data-code="OB">
					...
					<!--	<div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=BBIN&game_type=1&game_code=&devices=1" @else data-url="" @endif data-code="BBIN">
						...
						<div class="gamelist-type" gamelisttype="esports">
							<div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=IA&game_type=7&game_code=&devices=1" @else data-url="" @endif data-code="IA">
								<div class="gameImage-IA"></div>
							</div>
						    <div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=TFG&game_type=7&game_code=&devices=1" @else data-url="" @endif data-code="TFG">
    		...
    		<div class="modal-dialog">
    			<div class="modal-content neka_sound" style="height: 289px;">
    				<div class="modal-title modal-header">
    					<h1 style="font-size: 17px; color: #fff">{{trans('lang.xtgg')}}</h1>
    				</div>
    				<div class="modal-body" style="overflow: auto;">
    					<table class="bulletin_table"
    						   style="border-collapse: separate; border-spacing: 0px 15px; color: #000000; table-layout: fixed; width: 100%;">
    						<tr>
    							<td style="word-break: break-all;">
    							    <pre style="white-space: pre-wrap; word-wrap: break-word;">
    							        {{$system_notices->content}}
    							    </pre>
    							</td>
    						</tr>
    					</table>
