...
method="post" action="{{ route('wap.register.post') }}"  onSubmit="return
...
maxlength="9"
placeholder="{{trans('lang.qingshuruzanghao')}} *"> </div>
...
placeholder="{{trans('lang.qingshurumima')}} *"> </div> <div
...
placeholder="{{trans('lang.qingzaicishuru')}}{{trans('lang.mima')}} *"> </div>
...
placeholder="{{trans('lang.qingshuqukuanmima')}} *"> </div>
...
style="width: 60%;"
placeholder="{{trans('lang.qingshuru')}}{{trans('lang.sjh')}}*"> 
...
placeholder="{{trans('lang.qingshuru')}}{{trans('lang.yzm')}}*" > </div> @else
<div class="input-box registion-input-box phone" style="display:
inline-flex;"> <input name="phone" type="text" id="phone"
style="outline:none;"  required="required" minlength="8" maxlength="11"
placeholder="{{trans('lang.qingshuru')}}{{trans('lang.sjh')}} *"> </div>
@endif <div class="registion-btn text_2 btn-acc-bind"
