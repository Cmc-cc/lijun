...
<div class="m_container">
	...
	<div style="position: fixed;top:.9rem;width: 100%;height:.68rem;background: #3a3a3a;">
		...
		<a href="/m/transfer_record"><div class="acse as">{{trans("lang.edzh")}}</div></a>
	</div>
	...
	<div class="select-info">
        ...
        <div class="select-time" style="width:72%;margin-left: 0px;">
			<div style="width:100%;overflow: hidden;">
                <p  style="width: 16%" tid="1" @if($day==1)class="on"@endif onclick="location.href='/m/transfer_record?day=1'">{{trans("lang.jinri")}}</p>
                <p style="width: 15.5%" tid="2" @if($day==2)class="on"@endif onclick="location.href='/m/transfer_record?day=2'">2{{trans("lang.day")}}</p>
				<p style="width: 15.5%" tid="3" @if($day==3)class="on"@endif onclick="location.href='/m/transfer_record?day=3'">3{{trans("lang.day")}}</p>
				<p style="width: 15.5%" tid="5" @if($day==5)class="on"@endif onclick="location.href='/m/transfer_record?day=5'">5{{trans("lang.day")}}</p>
                <p style="width: 18%" tid="7" @if($day==7)class="on"@endif onclick="location.href='/m/transfer_record?day=7'">7{{trans("lang.day")}}</p>
                <p style="width: 19.5%" tid="30" @if($day==30)class="on"@endif onclick="location.href='/m/transfer_record?day=30'">30{{trans("lang.day")}}</p>
            </div>
        </div>
    </div>
				...
				<div class="info-list">
    			    ...
    			    <table class="Hyzx-table mt10 MMain" style="line-height: 1.5;">
                        ...
                        <tr>
                            ...
                            <th style="width:33%">{{trans("lang.jine")}}</th>
                        ...
                        <tbody id="general-msg">
                                ...
                                @foreach($data as $item)
                                    <tr class="haveRead MColor1" style="display: table-row;">
                                        ...
                                        <td style="text-align:center;">{{ $item->transfer_out_account }}/{{ $item->transfer_in_account }}</td>
