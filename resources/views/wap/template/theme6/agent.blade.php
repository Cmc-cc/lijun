...
@section('content')
    ...
    <div class="mui-content info-content" style="display: block;padding-top: 29px;">
        <div class="userInfo dy_center" style="padding-top: 0px;background: #fff;">
                    ...
                    <div class="@if($_member -> is_daili == 1) pull-left @else pull-right @endif">
                        ...
                        @else
                            ...
                            @elseif($apply && $apply->status == 2)
                                ...
                                <a href="{{ route('wap.agent_apply') }}"  style="width: 120%;font-size: 10px;" class="submit_btn text-center">重新申请</a>
                            ...
                            @else
                                ...
                                <a href="{{ route('wap.agent_apply') }}" style="background: #007aff" class="submit_btn text-center">立即申请</a>
                            @endif
                    @endif
                </dd>
                <dd>
            ...
            <dl class="url-list" style="margin-top: 10px">
