...
<head>
	...
	<link rel="icon" type="image/png" sizes="32x32" href="{{$setting->ico}}">
...
<script type="text/javascript" src="/new/js/clipboard.min.js"></script>
	...
	<style>
	.text_508::before{
	    content: "{{trans('lang.bangding_title')}}";
}
		...
		<div class="registion-box">
			...
			<div class="login-wrapper2" style="">
				<div class="login-box">
					...
					<div class="login-logo" style="background:url({{ $_system_config->site_logo}});background-size:100% 100%;width: 115px;height: 115px;margin-top:30px;"></div>
					
					<div class="login-title">
						<div style="font-size: 5vmin; font-weight: 600; color: #fff;">{{trans("lang.denglu")}}</div>
						<!-- <span class="login-close"></span> ../images/icon_6.png-->
						<img src="{{trans('lang.png')}}" onclick="$('#yuyan').show();" />
					</div>

					<div class="login-content">
						<div class="input-box account">
							<input type="text" id="denglu_account" style="font-size: 14px;" placeholder="{{trans('lang.qingshuru')}}{{trans('lang.zanghao')}}">
						</div>
						<div class="input-box pwd">
							<input type="password" id="denglu_password" style="font-size: 14px;" placeholder="{{trans('lang.qingshuru')}}{{trans('lang.mima')}}">
						</div>
						
						<div  id="btn-login" onclick="check_login();">{{trans("lang.denglu")}}</div>
						...
						<div class="login_bottom">
							<div onclick="location.href='{{$setting->service_link}}'" class="forget_pwd remember_box_text">{{trans("lang.wjmm")}}？</div>
							<span>|</span>
							<div class="" id="btn-login-registion" onclick="click_show('#zhuce');">{{trans("lang.user")}}{{trans("lang.zhuce")}}</div>
						</div>
						
						<div class="login-gohome " id="btn-gohome" onclick="open_div('#index');">{{trans("lang.xqgg")}}</div>
					</div>
				</div>
			</div>
		</div>
...
<div class="body-pages page" id="zhuce" >
	<div id="registion-dialog" class="registion-dialog">
		<div class="registion-box">
			...
			<div class="registion-logo" style="background:url({{ $_system_config->site_logo}});background-size:100% 100%;    margin-top: 10vmin !important;width: 115px;height: 115px;"></div>
			
			
			<div class="registion-title">
				<div style="font-size: 5vmin; font-weight: 600; color: #fff;">{{trans('lang.zhuce')}}</div>
			</div>
					        ...
					        <div class="login-content2-l">
					            <div class="login-content2-l-b">
					                 <div class="login-content2-l-div">
    					                ...
    					                <input name="name" type="text" id="name" oninput="login_input2()" placeholder="{{trans('lang.qingshuruzanghao')}} *" maxlength="9"/>
    					            </div>
    					             <div class="login-content2-l-div">
    					                <img src="/new0404/images/icon_2.png" />
    					                <input name="password" type="password" id="registpassword" oninput="login_input2()" placeholder="{{trans('lang.qingshurumima')}} *" />
    					            </div>
    					            
    					            <div class="login-content2-l-div">
    					                <img src="/new0404/images/icon_2.png" />
    					                <input name="password_confirmation" type="password" id="registpassword2" oninput="login_input2()" placeholder="{{trans('lang.qingzaicishuru')}}{{trans('lang.mima')}} *" />
    					            </div>
    					            <div class="login-content2-l-div">
    					                <img src="/new0404/images/icon_3.png" />
    					                <input name="qk_pwd" type="password" id="registtruename" oninput="login_input2()" placeholder="{{trans('lang.qingshuqukuanmima')}} *" />
    					            </div>
    					            <div class="login-content2-l-div">
    					                <img src="/new0404/images/icon_1.png" />
    					                <input  name="username" type="text" id="username" oninput="login_input2()" placeholder="{{trans('lang.qingshuru')}}{{trans('lang.zsxm')}} *" />
    					            </div>
    					            <!----->
    					            @if($setting->sms_message)
    					            <div class="login-content2-l-div">
    					                <img src="/new0404/images/icon_4.png" />
    					                <input name="phone" type="text" id="phone" oninput="login_input2()" placeholder="{{trans('lang.qingshuru')}}{{trans('lang.sjh')}}" />
    					                <span class="sty2 phoneCodeBtn">{{trans('lang.hqyzm')}} </span>
    					            </div>
    					            <div class="login-content2-l-div">
    					                <img src="/new0404/images/icon_5.png" />
    					                <input name="code" type="text" id="registPhoneCode" oninput="login_input2()" placeholder="{{trans('lang.qingshuru')}}{{trans('lang.yzm')}}*" />
    					            </div>
    					            @else
    					            <div class="login-content2-l-div">
    					                <img src="/new0404/images/icon_4.png" />
    					            ...
    					            @endif
    					             ...
    					             <div class="login-content2-l-div">
                                        ...
                                        <input name="captcha" type="text" id="paypasswd" oninput="login_input2()"  placeholder="{{trans('lang.qingshuru')}}{{trans('lang.yzm')}}*" />
					                ...
					                <div class="login-content2-l-btn-input login-content2-l-btn-input2"  onclick="check_form();" id="btn-login";>{{trans('lang.zhuce')}}</div>
    					            
    					            <div onclick="click_show('#denglu');" style="text-align:center; padding-bottom:6vmin;">
    					                {{trans('lang.denglu')}}
    					            </div>
    					            <!--<div class="login-content2-l-div2">-->
    					            <!--    <p  onclick="div_close('#zhuce')">{{trans('lang.fanhui')}} </p>-->
     ...
     var username = $('#username').val();
      var paypasswd = $('#paypasswd').val();
         if (!loginName) {
            ...
            chenggong_alert(2,"{{trans('lang.qsr')}}{{trans('lang.zhanghao')}}!")
            return false;
        }
        
         if (!password) {
            chenggong_alert(2,"{{trans('lang.qsr')}}{{trans('lang.denglumima')}}!")
            return false;
        }
        if (!cfmpwd) {
            henggong_alert(2,"{{trans('lang.qsr')}}{{trans('lang.querenmima')}}!")
            return false;
        }
        if (password　!= cfmpwd) {
            henggong_alert(2,"{{trans('lang.liangcimimabuyizhi')}} !")
            return false;
        }
      
         if (!phone) {
            henggong_alert(2,"{{trans('lang.qsr')}}{{trans('lang.sjh')}}!")
            return false;
        }
        if (!username) {
            henggong_alert(2,"{{trans('lang.qsr')}}{{trans('lang.zsxm')}}!")
            return false;
        }
         if (!paypasswd) {
        ...
        if (!phone) {
             ...
             henggong_alert(2,"{{trans('lang.zhuce_shouji')}}")
            return false}
...
<div class="page" id="huodong">
    ...
    position: absolute;
    right: 0.4rem;
    top: 0.36rem;">{{trans("lang.sqjd")}}</h2>
		</div>
		<div id="activitylist">
        @foreach($data_huodong as $k => $item)
    		    <div style="position: relative;">
    			<div class="activitylist" onclick="open_huodong('{{$item->id}}');">
...
<div class="page" id="xitonggonggao">
    <div class="m_container">
		...
		<div class="nytop">
			...
			<h1>{{trans('lang.xtgg')}}</h1>
	        <!--<img class="huodong_img" src="/new0404/images/icon_6.png" />-->
		</div>
		
		<div id="xitonggonggao2">
		    @foreach($data_msg as $v)
		    <div class="xitonggonggao" onclick="xitonggonggao_showDetails('{{$v->content}}','{{$v->title}}');">
		        <h6>
		            {{ $v->content }}
		        </h6>
		        <p>
	...
	<div id="xitonggonggao_alert" style="display:none;">
	    <div class="xitonggonggao_alert">
	        ...
	        <div class="xitonggonggao_bottom" onclick="xitonggonggao_close()">{{trans('lang.guanbi')}}</div>
	    </div>
	</div>
</div>
<script>
            ...
            <section class="xin_zhifu_alert">
                ...
                <section class="xin_zhifu_alert_content">
                    <article class="xin_zhifu_nav">
                        @if(!$setting->is_qq_on)
                        <article class="dopay on" onclick="new_qiehuan(1,this,'{{trans('lang.zhuanhuankuai')}}')">
                            <img src="/new/css/fps.png" alt="">
                            </article>
                        @endif
    
                        @if(!$setting->is_bankpay_on)
                        <article class="dopay" onclick="new_qiehuan(4,this,'{{trans('lang.yinhangka')}}')">
                            <img src="/new/css/add2_i911.png" alt="" style="width: 81%;">
                            </article>
                        @endif
    
                        @if(!$setting->is_alipay_on)
                        <article class="dopay" onclick="new_qiehuan(2,this,'{{trans('lang.bldzz')}}')">
                        ...
                        <article class="dopay" onclick="new_qiehuan(3,this,'{{trans('lang.xnbzf')}}')"><img src="/new/css/xnb.png" alt=""></article>
                        @endif
                    ...
                    <article class="xin_jine">
                        <input type="number" placeholder="{{trans("lang.srje")}}" id="new_amount" class="jine" oninput ="jine_input()">
                    ...
                    <input type="hidden" name="fanlis" id="new_amounts" value="0">
                     <div class="bankBox1">
        					...
        					@if($_member->is_new2)
        						<div class="">
        					新会员首充赠送100%（本金倍+送分{{$setting->hongli_ml_percent}}倍碼量）
                        ...
                        <section class="type_1_list">
                            ...
                            <section id="zhihu1">
                                <article>
                                    ...
                                    <p id="qq_account">{{ $_system_config->qq_account }}</p>
                                    <i class="btn-copy qq_account" data-clipboard-text="{{ $_system_config->qq_account }}">{{trans("lang.fuzhi")}}</i>
                                </article>
                                <article>
                                    <span>{{trans("lang.skzhm")}}：</span>
                                    <p id="qq_nickname">{{ $_system_config->qq_nickname }}</p>
                                    <i class="btn-copy qq_nickname" data-clipboard-text="{{ $_system_config->qq_nickname }}">{{trans("lang.fuzhi")}}</i>
                                </article>
                            </section>
                            @endif
                            ...
                            <section id="zhihu2" style="display: none;">
                                <article>
                                    ...
                                    <img id="bld_pic" src="{{ $setting->bld_pic }}" alt="">
                                </article>
                            </section>
                            @endif
            ...
            <section class="xin_zhifu_alert_content">
                <section class="xin_type_1" style="padding-top: .7rem;">
                    ...
                    <article class="xin_jine" style="margin-top: 0.5rem;position: relative; ">
                        <input type="number" name="money" id="money" autocomplete="off" placeholder="{{trans("lang.tkje")}}" class="jine" style="width: 96%;text-align: center;">
                    ...
                    <article class="xin_jine" style="margin-top: 0.5rem;">
                        <input type="password" style="width: 96%;" name="qk_pwd" id="qk_pwd" autocomplete="off" placeholder="{{trans("lang.tkmm")}}" class="jine">
                    </article>
                    <article class="xin_jine" style="margin-top: 0.5rem;">
                        <input type="text" readonly style="width: 96%;"  autocomplete="off" class="jine new_ml_money" value="{{trans("lang.shengyumaliang")}}: {{$member->ml_money}}">
                    </article>
                    <article class="xin_jine" style="margin-top: 0.5rem;">
                        <input type="text" readonly style="width: 96%;"  autocomplete="off" class="jine new_money" value="{{trans("lang.yue")}}: {{$member->money}}">
                    </article>
...
var trc_addr = '{{ $_system_config->usdt_trc }}';
    ...
    let type = 1,xiaoshu = "{{$xiaoshu}}";
        ...
        function reset(){
            div_close('#chongzhi2');
            new_qiehuan(1,$('.xin_zhifu_nav article:eq(0)'),'{{trans('lang.zhuanhuankuai')}}');
    	...
    	<div class="drawInfor">
    	    <div id="step1">
    			...
    			<li style="border-bottom: 1px solid rgb(41, 45, 48);">
    			    ...
    			    <input type="text" name="money" id="money" oninput="this.value=this.value.replace(/\D/g,'');" placeholder="{{trans('lang.qsr')}}{{trans('lang.czje')}}" autocomplete="off">
  
    			</li>
    			<li style="border-bottom: 1px solid rgb(41, 45, 48);">
    			    <span>{{trans("lang.xingming")}}：</span>
    			    <input type="text" name="account" id="account" placeholder="{{trans('lang.qsr')}}{{trans('lang.xingming')}}" autocomplete="off">
    			</li>
                <li class="bankChose">
    				<span>{{trans('lang.skyh')}}：</span>
    				<div class="bankBox">
    													<b class="on">
    						<img src="/new/css/fps.png">{{trans('lang.zhuanhuankuai')}}
    		...
    		<button type="button" class="subBtn ajax-submit-btn-pay-type" id="SubTran1" style="margin: 0.5rem auto;" onclick="chongzhi_zhuanhuankuai_step()">{{trans('lang.huoquyinhangxinxi')}}</button>
    	    </div>
    		...
    		<div class="bq2-wrapper" style="display:none;">
            	...
            	<div class="bot-container">
            		...
            		<p class="row banker">
            			<span class="asain">{{trans('lang.xnbzf')}}：</span>
            		...
            		<div class="btns" >
            			<a class="contact" onclick="$('#chongzhi_zhuanhuankuai .bq2-wrapper').hide();$('#chongzhi_zhuanhuankuai #step1').show();$('.chongzhi_zhuanhuankuai_fhbtn2').hide();$('.chongzhi_zhuanhuankuai_fhbtn').show(); $('#chongzhi_zhuanhuankuai #money').val('');$('#chongzhi_zhuanhuankuai #account').val('')">{{trans('lang.xnbzf')}}</a>
            			<button type="button" class="submit ajax-submit-without-confirm-btn switchroute" onclick="chongzhi_zhuanhuankuai_addrecharge()">{{trans("lang.qrcz")}}</button>
            		</div>
            	</div>
            	<p style="color: red;line-height: 3;margin-top: 20px;">
            	    {{trans("lang.chongzhi_wenan2")}}
            	</p>
            </div>
...
function chongzhi_zhuanhuankuai_step(){
    ...
    if(!$('#chongzhi_zhuanhuankuai #money').val()){
        chenggong_alert(2,"{{trans('lang.qsr')}}{{trans('lang.czje')}}")
        return false;
    }
    if($('#chongzhi_zhuanhuankuai #money').val() < Number({{$setting->recharge_min}})){
        chenggong_alert(2,"{{trans('lang.jebxdy')}}{{$setting->recharge_min}}")
        return false;
    }
    if($('#chongzhi_zhuanhuankuai #money').val() > Number({{$setting->recharge_max}})){
        chenggong_alert(2,"{{trans('lang.jebxxy')}}{{$setting->recharge_max}}")
        return false;
    }
    if(!$('#chongzhi_zhuanhuankuai #account').val()){
        chenggong_alert(2,"{{trans('lang.qsr')}}{{trans('lang.xingming')}}")
        return false;
    }
       sysconfig();
			...
			$.ajax({
				...
				success : function (data) {
					...
					if(data.status.errorCode == 0){
                        ...
                        chenggong_alert(1,'{{trans("lang.chenggong")}}')
                    }else{
                        chenggong_alert(2,data.status.msg)
                    }
...
<div class="page" id="eduzhuanhuan">
    <div class="nytop">
		...
		<h2><a class="kefu_box" href="{{$setting->service_link}}">{{trans("lang.zxkf")}}</a></h2>
	</div>
	<div class="moneyBag">
			<div class="bagTitle">
				<div class="bagChange">
					{{trans("lang.shuaxinjine")}}
					<a href="javascript:void(0)" class="refuseBtn"></a>
				</div>
				<div class="getMoney"><a href="javascript:void(0);" id="transfer4" class="refresh11" style="color:#d2b79c">{{trans("lang.zijinhuishou")}}</a></div>
			</div>
			<ul class="moneyInfor">
				<li id="center_money" data-uri="/api/member_balance/4751">
					<div class="moneyName">
						<div></div>
						<span style="color:#fff;">{{trans("lang.zxqb")}}</span>
					</div>
					<p id="gamemoneyy" class="gamemoney_text">{{$member->money}}</p>
				...
				<li id="center_money" data-uri="/api/all_balance/4751">
					<div class="moneyName">
						<div></div>
						<span style="color:#fff;">{{trans("lang.yxqb")}}</span>
					</div>
					<p id="api_money">{{$member->api_money}}</p>
					<img src="/new/css/loading.png">
				</li>
			</ul>
			<div class="moneyListbox">
				<div class="checkMoremoney">
					<div class="saveBox">{{trans("lang.xiangxizhangkai")}}</div>
				...
				<ul class="moenyList">
				    @foreach($api_list as $item)
    					...
    					<li >
    						...
    						@if($mod)
    						    @if($item->api_name=='KY')
    						        <p style="color: #d2b79c;" class="gamecode" data-code="{{$item->api_name}}">  {{$mod->money / 2}}  </p>
    						    @else
...
<div class="page chongzhi_cont" id="chongzhi_yinhangka">
	...
	<div class="drawInfor">
	    <div id="step1">
            ...
            <li class="bankChose" style="padding-bottom:20px;">
				...
				<div class="bankBox" style="display: flex;   flex-wrap: wrap;">
				    @foreach($banks as $item)
    					<b class="banks" style="margin-bottom:6px;" data-cardno="{{ $item->card_no }}" data-username="{{ $item->username }}" data-id="{{ $item->id }}" data-bank_name="{{ $item->bank_name }}">
    						{{ $item->bank_name }}
    					</b>
					@endforeach
				</div>
	        ...
	        <input type="hidden" name="payment_type" value="3">
		<button type="button" class="subBtn ajax-submit-btn-pay-type" id="SubTran1" style="margin: 0.5rem auto;" onclick="chongzhi_yinhangka_step()">{{trans("lang.hqskyhxx")}}</button>
	    </div>
		...
		<div class="bq2-wrapper" style="display:none;">
        	...
        	<div class="bot-container">
        		<p class="row account">
                    <span class="asain"> {{trans("lang.skyh")}}：</span>
        			<span class="chatNumber2" style="color:#fb2464 ;"></span>
        			<span id="btn2" class="copy">
        				{{trans("lang.fuzhi")}}
        			</span>
        		...
        		<p class="row banker">
        			<span class="asain">{{trans("lang.yhkh")}}：</span>
        			<span class="chatNumber3" style="color:#fb2464 ;"></span>
        			<span class="copy" id="btn3">
        				{{trans("lang.fuzhi")}}
        			</span>
        		...
        		<p class="row banker">
        			<span class="asain">{{trans("lang.xingming")}}：</span>
        		...
        		<div class="btns" >
        			<a class="contact" onclick="$('#chongzhi_yinhangka .bq2-wrapper').hide();$('#chongzhi_yinhangka #step1').show();$('.chongzhi_yinhangka_fhbtn2').hide();$('.chongzhi_yinhangka_fhbtn').show();$('#chongzhi_yinhangka #account').val('');$('#chongzhi_yinhangka #money').val('')">{{trans("lang.fanhuichongxinshuru")}}</a>
        			<button type="button" class="submit ajax-submit-without-confirm-btn switchroute" onclick="chongzhi_yinhangka_addrecharge()">{{trans("lang.qrcz")}}</button>
        		</div>
        	</div>
        	<p style="color: red;line-height: 3;margin-top: 20px;">{{trans("lang.chongzhi_wenan2")}}
        	</p>
        </div>
...
function chongzhi_yinhangka_step(){
    ...
    if($('#chongzhi_yinhangka #money').val() < Number({{$setting->recharge_min}})){
        chenggong_alert(2,"{{trans('lang.jebxdy')}}{{$setting->recharge_min}}")
        return false;
    }
    if($('#chongzhi_yinhangka #money').val() > Number({{$setting->recharge_max}})){
        chenggong_alert(2,"{{trans('lang.jebxxy')}}{{$setting->recharge_max}}")
        return false;
    }
    if(!bank_id){
        chenggong_alert(2,"{{trans('lang.qxz')}}{{trans('lang.yinghang')}}")
        return false;
    }
	...
	<div class="drawInfor">
	    <div id="step1">
            ...
            <li class="bankChose">
	        	...
	        	<input type="hidden" name="payment_type" value="3">
		<button type="button" class="subBtn ajax-submit-btn-pay-type" id="SubTran1" style="margin: 0.5rem auto;" onclick="chongzhi_USDT_step()">{{trans("lang.huoquyinhangxinxi")}}</button>
	    </div>
		...
		<div class="bq2-wrapper" style="display:none;">
        	...
        	<h3>
        		{{trans("lang.xitongzidonghuansuan")}}
        	</h3>
        	<div class="bot-container">
        		<p class="row account">
                    <span class="asain"> {{trans("lang.czdz")}}(TRC20)：</span>
        		...
        		<p class="row banker">
        			<span class="asain">{{trans("lang.skewm")}}：</span>
        			<img id="trc_pic" src="" width="200" height="200" style="margin-left: 0px;margin-top: 0px"/>
        		</p>
        		<div class="btns" >
        			<a class="contact" onclick="$('#chongzhi_USDT .bq2-wrapper').hide();$('#chongzhi_USDT #step1').show();$('.chongzhi_USDT_fhbtn').show();$('.chongzhi_USDT_fhbtn2').hide();$('#chongzhi_USDT #account').val('');$('#chongzhi_USDT #money').val('');$('#chongzhi_USDT #paymoney').val('')">{{trans("lang.fanhuichongxinshuru")}}</a>
        			<button type="button" class="submit ajax-submit-without-confirm-btn switchroute" onclick="chongzhi_USDT_addrecharge()">{{trans("lang.qrcz")}}</button>
        		</div>
        	</div>
        	<p style="color: red;line-height: 2;margin-top: 20px;">{{trans("lang.chongzhi_wenan2")}}
        	</p>
        </div>
...
function chongzhi_USDT_step(){
    ...
    if($('#chongzhi_USDT #money').val() < Number({{$setting->recharge_min}})){
        chenggong_alert(2,"{{trans('lang.jebxdy')}}{{$setting->recharge_min}}")
        return false;
    }
    if($('#chongzhi_USDT #money').val() > Number({{$setting->recharge_max}})){
        chenggong_alert(2,"{{trans('lang.jebxxy')}}{{$setting->recharge_max}}")
        return false;
    }
    ...
    $.ajax({
        url:'/m/usdt_pointer',
        success:function(res){
            $('#chongzhi_USDT #paymoney').text(  (Number(Number($('#chongzhi_USDT #money').val() / {{$_system_config->usdt_lv}}).toFixed(2))+Number(res / 1000)).toFixed(3));
...
<div class="page chongzhi_cont" id="chongzhi_bainlidian">
	...
	<div class="drawInfor">
		...
		<input type="hidden" name="payment_type" value="3">
		<button type="button" class="subBtn ajax-submit-btn-pay-type" id="SubTran1" style="margin: 0.5rem auto;" onclick="chongzhi_bainlidian_step()">{{trans("lang.huoquyinhangxinxi")}}</button>
		</div>
		...
		<div class="bq2-wrapper" style="display:none;">
        	...
        	<div class="bot-container">
        		...
        		<div class="btns" >
        			<a class="contact" onclick="$('#chongzhi_bainlidian .bq2-wrapper').hide();$('#chongzhi_bainlidian #step1').show();$('.chongzhi_bainlidian_fhbtn2').hide();$('.chongzhi_bainlidian_fhbtn').show();">{{trans("lang.fanhuichongxinshuru")}}</a>
        			<button type="button" class="submit ajax-submit-without-confirm-btn switchroute" onclick="chongzhi_bainlidian_addrecharge()">{{trans("lang.qrcz")}}</button>
        		</div>
        	</div>
        	<p style="color: red;line-height: 2;margin-top: 20px;">{{trans("lang.chongzhi_wenan2")}}
        	</p>
...
function chongzhi_bainlidian_step(){
    ...
    var ts = "{{trans('lang.qsr')}}{{trans('lang.czje')}}";
   // $('#xiaoshu').val(n);
    ...
    if($('#chongzhi_bainlidian #money').val() < Number({{$setting->recharge_min}})){

        chenggong_alert(2,"{{trans('lang.jebxdy')}}{{$setting->recharge_min}}")
        return false;
    }
    if($('#chongzhi_bainlidian #money').val() > Number({{$setting->recharge_max}})){
...
<div class="page body-pages" id="yinhangkaguanli">
	<div class="pages-container show">
		...
		<div data-page-name="BankManagement" data-link="user-center" class="pages-main security-main active ani">
			<div class="pages-header">
				<h1 class="text_1040">{{trans("lang.yinhangkabangding")}}</h1>
			</div>
			<div class="pages-content">
				<div class="BankList-wrapper">
					<div class="btnline" style="width: 100%; height: 80px;">
						<div class="addbank text_1039"
							 style="@if($member['bank']) display: none; @else display: inline-block; @endif background: #BBA28A; width: 40%; height: 50px; line-height: 50px; text-align: center; border-radius: 5px; margin: 15px 5%; float: left;    color: #fff;
    font-size: 14px;">{{trans('lang.xzyhk')}}</div>
						<div class="addFPS text_1161"
							 style="@if($member['fps']) display: none; @else display: inline-block; @endif background: #BBA28A; width: 40%; height: 50px; line-height: 50px; text-align: center; border-radius: 5px; margin: 15px 5%; float: left;    color: #fff;
    font-size: 14px;">{{trans('lang.xzzsk')}}</div>
						<div class="addERC20"
							 style="@if($member['erc20']) display: none; @else display: inline-block; @endif background: #BBA28A; width: 44%; height: 50px; line-height: 50px; text-align: center; border-radius: 5px; margin: 15px 3%; float: left;    color: #fff;
    font-size: 14px;">
							USDT-ERC20
						</div>
						<div class="addTRC20"
							 style="@if($member['trc20']) display: none; @else display: inline-block; @endif background: #BBA28A; width: 44%; height: 50px; line-height: 50px; text-align: center; border-radius: 5px; margin: 15px 3%; float: left;    color: #fff;
    font-size: 14px;">
							USDT-TRC20
						</div>
    ...
    font-size: 16px;">{{trans('lang.yhklb')}}</div>
					</div>
					<div class="list" style="display: inline-block; width: 100%;">
						...
						<div class="bank-list-item"  style="width: 91%; border-radius:5px; margin: 15px; background: #b1987f; border: 1px solid #d1b497; padding: 0 10px 10px; color: #fff; font-size: 12px;">
							<div style="text-align: center;  border-bottom: 1px solid #fff; line-height: 40px;  margin-bottom: 10px;  font-size: 16px;">{{trans("lang.bdyhk")}}</div>
							<div style="height: 30px; line-height: 30px;">{{trans("lang.zsxm")}}: {{$member['username']}}</div>
							<div style="height: 30px; line-height: 30px;">{{trans("lang.yhmc")}}: {{$member['bank']}}</div>
							<div class="FPSAccount"
								 style="line-height: 30px; word-wrap: break-word; word-break: break-all;">{{trans("lang.yhkh")}}: ***{{substr($member['card'],3)}}
							</div>
						</div>
						@endif
						@if($member['fps'])
						<div class="bank-list-item"  style="width: 91%; border-radius:5px; margin: 15px; background: #b1987f; border: 1px solid #d1b497; padding: 0 10px 10px; color: #fff; font-size: 12px;">
							<div style="text-align: center;  border-bottom: 1px solid #fff; line-height: 40px;  margin-bottom: 10px;  font-size: 16px;">{{trans("lang.bdzsk")}}</div>
							<div style="height: 30px; line-height: 30px;">{{trans("lang.zsxm")}}: {{$member['username']}}</div>
							<div class="FPSAccount"
								 style="line-height: 30px; word-wrap: break-word; word-break: break-all;">{{trans("lang.zsk")}}{{trans("lang.zhanghao")}}: ***{{substr($member['fps'],3)}}
							</div>
						</div>
						@endif
						@if($member['erc20'])
						<div class="bank-list-item"  style="width: 91%; border-radius:5px; margin: 15px;  background: #b1987f; border: 1px solid #d1b497; padding:0 10px 10px; color: #fff; font-size: 12px;">
							...
							<div style="height: 30px; line-height: 30px;">{{trans("lang.zsxm")}}: {{$member['username']}}</div>
							<div class="FPSAccount"
								 style="line-height: 30px; word-wrap: break-word; word-break: break-all;">USDT{{trans("lang.zhanghao")}}: ***{{substr($member['erc20'],3)}}
							</div>
						</div>
						@endif
						@if($member['trc20'])
						<div class="bank-list-item"  style="width: 91%; border-radius:5px; margin: 15px;  background: #b1987f; border: 1px solid #d1b497; padding: 0 10px 10px; color: #fff; font-size: 12px;">
							...
							<div  style="height: 30px; line-height: 30px;">{{trans("lang.zsxm")}}: {{$member['username']}}</div>
							<div class="FPSAccount"
								 style="line-height: 30px; word-wrap: break-word; word-break: break-all;">USDT{{trans("lang.zhanghao")}}: ***{{substr($member['trc20'],3)}}
							</div>
						</div>
						@endif
					</div>
				...
				<div class="wm-bind-wrap">
					<div class="person-acc-box">
						...
						<div class="acc-data" style="height: 70px;">
							<span class="text_208" style="line-height:39px;">{{trans('lang.zsxm')}}</span>
							<input type="text"  class="username2" required="required" style="font-size: 12px;margin:0;"
								   placeholder="{{trans("lang.qsr")}}{{trans("lang.qsrckrxm")}}" value="{{$member['username']}}" >
						</div>
						<div class="acc-data datahide" type="bank" style="height: 70px; display: block;">
							<span class="text_231" style="line-height:39px;">{{trans('lang.yhmc')}}</span>
						...
						<div class="acc-data datahide" type="bank" style="height: 70px; display: block;">
							<span class="text_370" style="line-height:39px;">{{trans('lang.yhkh')}}</span>
							<input id="bankcode" type="text" required="required" minlength="15" maxlength="19"
								   style="font-size: 12px;margin:0;" placeholder="{{trans("lang.qsryhkh")}}">
						</div>
						<div style="position: absolute; width: 92%; bottom: 0;">
    						<a class="recharge-submit text_155" onclick="yinhangkaguanli_saveBank();" style="color: #fff;">{{trans('lang.quedihng')}}</a>
    						<a class="recharge-cancel text_135" style="color: #fff;">{{trans('lang.quxiao')}}</a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="wm-bind-wrap">
					<div class="person-acc-box">
						...
						<div class="acc-data datahide" type="FPS" style="height: 70px;">
							<span class="text_368" style="line-height:39px;">{{trans('lang.zskzh')}}</span>
							<input id="FPSAccount" type="text" required="required" style="font-size: 12px;margin:0;"
								   placeholder="{{trans("lang.qsrzskhm")}}">
						</div>
						<div style="position: absolute; width: 92%; bottom: 0;">
    						<a class="recharge-submit text_155" onclick="saveFps();" style="color: #fff;">{{trans('lang.quedihng')}}</a>
    						<a class="recharge-cancel text_135" style="color: #fff;">{{trans('lang.quxiao')}}</a>
						</div>
					</div>
				</div>
				...
				<div class="wm-bind-wrap">
					<div class="person-acc-box">
						...
						<div class="acc-data datahide" type="ERC20" style="height: 70px;">
							<span class="text_442" style="line-height:39px;">{{trans('lang.qsrusdtzh')}}</span>
							<input id="USDTAccount" type="text" required="required" style="font-size: 12px;margin:0;"
								   placeholder="{{trans("lang.qsr")}}USDT{{trans('lang.zhanghao')}}">
						</div>
						<div class="text_519 datahide" type="ERC20" style="color: rgb(255, 0, 0);"></div>
						<div style="position: absolute; width: 92%; bottom: 0;">
						<a class="recharge-submit text_155" onclick="saveErc20();" style="color: #fff;">{{trans('lang.quedihng')}}</a>
						<a class="recharge-cancel text_135" style="color: #fff;">{{trans('lang.quxiao')}}</a>
						</div>
					</div>
				</div>
					...
					<div class="person-acc-box">
						...
						<div class="acc-data datahide" type="TRC20" style="height: 70px;">
							...
							<input id="USDTAccountTRC20" type="text" required="required"
								   style="font-size: 12px;margin:0;" placeholder="{{trans("lang.qsr")}}USDT{{trans('lang.zhanghao')}}">
						</div>
						<div class="text_524 datahide" type="TRC20" style="color: rgb(255, 0, 0); display: none;"></div>
						<div style="position: absolute; width: 92%; bottom: 0;">
						<a class="recharge-submit text_155" onclick="saveTrc20();" style="color: #fff;">{{trans('lang.quedihng')}}</a>
						<a class="recharge-cancel text_135" style="color: #fff;">{{trans('lang.quxiao')}}</a>
						</div>
					</div>
				</div>
...
// yinhangkaguanli
	function yinhangkaguanli_saveBank() {
		...
		if(username.length<2){
			chenggong_alert(2,"{{trans("lang.qsr")}}{{trans("lang.qsrckrxm")}}")
			return ;
		}
		if(card.length<8){
		    chenggong_alert(2,"{{trans("lang.qsryhkh")}}")
			...
			success: function (data) {
				...
				if (data.status.errorCode == 0) {
					...
					$('#yinhangkaguanli .list').append(`<div class="bank-list-item"  style="width: 91%; border-radius:5px; margin: 15px; background: #b1987f; border: 1px solid #d1b497; padding: 0 10px 10px; color: #fff; font-size: 12px;">
							<div style="text-align: center;  border-bottom: 1px solid #fff; line-height: 40px;  margin-bottom: 10px;  font-size: 16px;">{{trans('lang.bdyhk')}}</div>
							<div style="height: 30px; line-height: 30px;">{{trans('lang.zsxm')}}:` + username +`</div>
							<div style="height: 30px; line-height: 30px;">{{trans('lang.yhmc')}}: `+ bank+`</div>
							<div class="FPSAccount"
								 style="line-height: 30px; word-wrap: break-word; word-break: break-all;">{{trans('lang.yhkh')}}: ***`+ card.substring(card.length - 3) +`
							</div>
						</div>`)
	...
	function saveFps() {
		...
		if(fps.length<8){
			chenggong_alert(2,"{{trans("lang.qsrzskhm")}}")
			return ;
		}
		$.ajax({
			url : "{{route('wap.set_bank')}}",
			...
			success: function (data) {
				if (data.status.errorCode == 0) {
					...
					<div class="bank-list-item"  style="width: 91%; border-radius:5px; margin: 15px; background: #b1987f; border: 1px solid #d1b497; padding: 0 10px 10px; color: #fff; font-size: 12px;">
							...
							<div  style="height: 30px; line-height: 30px;">{{trans('lang.zsxm')}}: ` + username + `</div>
							<div class="FPSAccount"
								 style="line-height: 30px; word-wrap: break-word; word-break: break-all;">USDT{{trans('lang.zhanghao')}}: ***`+ fps.substring(fps.length - 3) +`
							</div>
						</div>`)
	...
	function saveErc20() {
		...
		if(erc20.length<8){
			...
			chenggong_alert(2,"{{trans("lang.qsr")}}USDT{{trans("lang.zhanghao")}}")
			return ;
		}
		$.ajax({
			url : "{{route('wap.set_bank')}}",
			...
			success: function (data) {
				...
				if (data.status.errorCode == 0) {
					...
					<div class="bank-list-item"  style="width: 91%; border-radius:5px; margin: 15px; background: #b1987f; border: 1px solid #d1b497; padding: 0 10px 10px; color: #fff; font-size: 12px;">
							...
							<div  style="height: 30px; line-height: 30px;">{{trans('lang.zsxm')}}: ` + username + `</div>
							<div class="FPSAccount"
								 style="line-height: 30px; word-wrap: break-word; word-break: break-all;">USDT{{trans('lang.zhanghao')}}: ***`+ erc20.substring(erc20.length - 3) +`
							</div>
						</div>`)
			...
			success: function (data) {
				if (data.status.errorCode == 0) {
					...
					<div class="bank-list-item"  style="width: 91%; border-radius:5px; margin: 15px; background: #b1987f; border: 1px solid #d1b497; padding: 0 10px 10px; color: #fff; font-size: 12px;">
							...
							<div  style="height: 30px; line-height: 30px;">{{trans('lang.zsxm')}}: ` + username + `</div>
							<div class="FPSAccount"
								 style="line-height: 30px; word-wrap: break-word; word-break: break-all;">USDT{{trans('lang.zhanghao')}}: ***`+ trc20.substring(trc20.length - 3) +`
							</div>
						</div>`)
...
<div class="page body-pages" id="tixian">
	...
	<div class="drawInfor">
		<ul>
			...
			<li class="black"><span>{{trans("lang.tkje")}}</span><input type="text" name="money" id="money" oninput="this.value=this.value.replace(/\D/g,'');" autocomplete="off" style="width:75%;"></li>
			...
			@if($setting->sms_message)
			    ...
			    <!--</li>-->
			@endif
			<div style="padding-top:15px;font-size:20px;">{{trans("lang.shengyujihe")}}:<span id="ml_money">{{$member->ml_money}}</span></div>
			<div style="padding-top:15px;font-size:20px;">
			    {{trans("lang.yue")}}:<span id="gamemoney" class="old_money gamemoney_text">{{$member->money}}</span>
			    
			    <input type="button" value="{{trans('lang.zijinhuishou')}}" class="subBtn transfer_text" style="margin:0;width:70px;float: right;line-height: 30px;font-size:12px;" id="transfer2">
			</div>
		</ul>
		<input type="button" value="{{trans('lang.qr')}}" class="subBtn ajax-submit-btn" id="tixian_subBtn">
...
<script>
	...
	$('#tixian_subBtn').click(function(){
		...
		if(money==''){
			...
			chenggong_alert(2,'{{trans("lang.qsr")}}{{trans("lang.tkje")}}')
			return false;
		}

	    var qk_pwd = $("#tixian #qk_pwd").val();
		if(qk_pwd==''){
			chenggong_alert(2,'{{trans("lang.qsr")}}{{trans("lang.tkmm")}}')
			return false;
		}
...
<div class="m_container1 page" id="shenqinjindu">
    ...
    padding: 12px 0;">
                ...
                <ul class="list-group" style="padding: 15px;">
                            @foreach($data_shenqingjindu as $item)
                                @if(@$item->activity)
                                    <li class="list-group-item message-item" style="background: linear-gradient(180deg, #4d4c4a, #262626) !important;padding: .4rem .4rem;font-size: 16px;line-height: 1.5;border-radius:5px; margin-bottom:.3rem;">
                                        <div class="message-title" style="color:#fff;">{{trans('lang.hgbt')}}：{{ $item->activity->title }}</div>
                                        <div class="message-content" style="color:#fff;">
                                            @if($item->status == 3)
                                                {{trans('lang.ndhdsqwtg')}}：{{ $item->fail_reason }}
                                            @endif
                                            @if($item->status == 2)
                                                {{trans('lang.shenqing_title1')}}
                                            @endif
                                            @if($item->status == 1)
                                                {{trans('lang.shenqing_title2')}}
                                            @endif
                                        </div>
                                    </li>
                                @endif
...
<!--			<div class="bagTitle">-->
<!--				<div class="bagChange">-->
<!--					刷新金額{{trans('lang.quxiao')}}-->
<!--					<a href="javascript:void(0)" class="refuseBtn"></a>-->
<!--				</div>-->
<!--				<div class="getMoney"><a href="javascript:void(0);" class="refresh11 transfer_text" id="transfer3" style="color:#d2b79c">資金回收{{trans('lang.quxiao')}}</a></div>-->
<!--			</div>-->
<!--			<ul class="moneyInfor">-->
<!--				<li id="center_money" data-uri="/api/member_balance/4751">-->
<!--					<div class="moneyName">-->
<!--						<div></div>-->
<!--						<span>中心錢包{{trans('lang.quxiao')}}</span>-->
<!--					</div>-->
<!--					<p id="gamemoneyy" class="gamemoneyy gamemoney_text">{{$member->money}}</p>-->
<!--					<img src="/new/css/loading.png">-->
<!--				</li>-->
...
<!--					<div class="moneyName">-->
<!--						<div></div>-->
<!--						<span>遊戲錢包{{trans('lang.quxiao')}}</span>-->
<!--					</div>-->
<!--					<p id="api_money">0</p>-->
<!--					<img src="/new/css/loading.png">-->
<!--				</li>-->
...
<!--			<div class="moneyListbox">-->
<!--				<div class="checkMoremoney">-->
<!--					<div class="saveBox">詳細展開{{trans('lang.quxiao')}}</div>-->
<!--					<div class="openmoneyBtn"></div>-->
<!--				</div>-->
<!--				<ul class="moenyList">-->
...
<script>
    ...
    //     layer.open({
    //         content: '<div class="layui-m-layerbtn"><span yes="" type="1" onclick="tapCopy('+"'url_whats'"+')" data-clipboard-target="#url">WHATSAPP{{$setting->whatsapp}} </span></div>  {{--<div class="layui-m-layerbtn"><span yes="" type="1" onclick="wechat()">{{trans("lang.weixin")}}</span></div>--}} <div class="layui-m-layerbtn"><a href="{{$setting->service_link}}" target="_blank"><span yes="" type="1">{{trans("lang.zxkf")}}</span></a></div>'
    //         ,skin: 'footer'
    //     });
    // })
//     function tapCopy(){
                    ...
                    success:function(res){
						...
						if (k === len - 1)
            		    {
                    		        $.ajax({
                                        ...
                                        success:function(res){
                                            $('.transfer_text').text('{{trans("lang.zijinhuishou")}}');
                        		            $('.transfer_text').val('{{trans("lang.zijinhuishou")}}');
...
<div class="page" id="shenqingdaili">
    <div class="nytop">
        ...
        <h1>{{trans("lang.sqdl")}}</h1>
    </div>
    <div class="drawInfor">
		<ul>

			<li><span>Whatsapp</span><input type="text" name="qq" id="qq" placeholder="{{trans('lang.qsr')}}Whatsapp"  autocomplete="off"></li>
			<li><span>{{trans("lang.sjh")}}</span><input type="text" name="phone" id="phone" placeholder="{{trans('lang.qsr')}}{{trans('lang.sjh')}}" autocomplete="off" minlength="8" ></li>
			<li><span>{{trans("lang.sqly")}}</span><textarea  name="about" id="about" placeholder="{{trans('lang.qsr')}}{{trans('lang.sqly')}}" autocomplete="off" style="    background: none;
    line-height: 2;
    border: none;
    height: 100px;
    color: #fff;
...
<script>
	...
	$('#shenqingdaili #subBtn').click(function(){
	    ...
	    $.ajax({
				type:"post",
				url:"{{ route('wap.post_agent_apply') }}",
    ...
    <div class="body-pages">
    	<div class="pages-container show" style="height:100vh;">
                ...
                <div class="nytop">
                    ...
                    <div class="grzx">
                		<div class="grzxbox">
                			<h2>
                				...
                				<p onclick="click_show('#gerenxinxi')"style="float:left;"><i class="xtb1"></i>{{trans("lang.xgmm")}}</p>
                
                				<div style="clear:both"></div>
                			<ul>
                                
                				<li onclick="click_show('#bangdingshouji')"><span><i class=" xtb3 "></i>{{trans("lang.bdsj")}}</span></li>
                		        <li style="float: left;"  onclick="click_show('#dailizhongxin');">
                				    <span style="line-height:1.5">
                				        <img src="/new/img/agent2.png" style="float: left;margin-right:5px;width:20px;    margin-top: 2px;" >{{trans("lang.dlzx")}}
                				    </span>
                				</li>
                				
                		        @if($_member->is_daili && 1==2)
                				<li style="float: left;"  onclick="click_show('#dailizhongxin');">
                				    <span style="line-height:1.5">
                				        <img src="/new/img/agent2.png" style="float: left;margin-right:5px;width:20px;    margin-top: 2px;" >{{trans("lang.dlzx")}}
                				    </span>
                				...
                				<!--    <span style="line-height:1.5">-->
                				<!--        <img src="/new/img/agent.png" style="float: left;margin-right:5px;width:20px;" >{{trans("lang.sqdl")}}-->
                				<!--    </span>-->
                				<!--</li>-->
                                @endif
                                @if($_member->fps && $_member->card)
                                <li  onclick="click_show('#yinhangkaguanli')">
                				    <span style="line-height:1.5">
                				        <img src="/new/img/a45.png" style="float: left;margin-right:5px;width:20px;    margin-top: 5px;" >{{trans("lang.yinhangkabangding")}}
                				    </span>
                				</li>
                                @else
                				<li onclick="click_show('#yinhangkaguanli')">
                				    <span style="line-height:1.5">
                				        <img src="/new/img/a47.png" style="float: left;margin-right:5px;width:20px;    margin-top: 5px;" >{{trans("lang.yinhangkabangding")}}
                				    </span>
                				</li>
                				@endif
                			</ul>
                	...
                	<div class="zzc">
                		<div class="zzc_tit">
                			<h2 style="float:left;">{{trans("lang.zzhye")}}</h2>
                			<!-- <h2 style="float:right;">{{trans("lang.byxzze")}}</h2> -->
                		...
                		<div class="zzc_nr">
                			<div style="overflow: hidden;float:left; width:45%;">
                				...
                				<span id="gamemoney" class="gamemoney_text" style="color: #eb8f74;font-size: .48rem;display:block;float:left;width:52%;line-height: .48rem;">{{ $_member -> money }}</span>
                			</div>
                    ...
                    line-height: .5rem;
                    padding: 0 0.2rem;
                    border-radius: 1rem;" class="transfer_text" id="transfer">{{trans("lang.zijinhuishou")}}</button>
                				<!-- <span style="display:block;float:left;width:.45rem;margin-right: .16rem;"><i class="xtb5">$</i></span>
                				<span id="gamemoney" style="color: #eb8f74;font-size: .48rem;display:block;float:left;width:52%;line-height: .48rem;">{{ $_member -> liushui_total }}</span> -->
                			</div>
                			<h2 style="clear:both;"></h2>
                			<ul>
                				{{--<li><a href="/m/recharge" class="on1"><i class="xtb6"></i>{{trans("lang.chongzhi")}}</a></li>--}}
                				<li><a href="javascript:;" onclick="new_chongzhi()" class="on1"><i class="xtb6"></i>{{trans("lang.chongzhi")}}</a></li>
                				<!--<li><a onclick="alert('维护中')" class="on1"><i class="xtb6"></i>{{trans("lang.chongzhi")}}</a></li>-->
                				<li><a href="javascript:void(0);" class="xmjf"><i class="xtb10"></i>{{trans("lang.fanshui")}}</a></li>
                {{--				<li><a href="/m/drawing"><i class="xtb8"></i>{{trans("lang.tixian")}}</a></li>--}}
                				<li><a href="javascript:new_tixian()"><i class="xtb8"></i>{{trans("lang.tixian")}}</a></li>
                			</ul>
                		</div>
                	</div>
                	<div class="zzc">
                		<div class="zzc_tit">
                			<h2><span class="fr"><a href="javascript:click_show('#xitonggonggao')">{{trans("lang.qbxx")}}</a></span>{{trans("lang.xiaoxi")}}</h2>
                		</div>
                		<div class="qbhd_nr">
                			<ul>
                					<li>
                						<div class="qbhdbox">
                						    @if($data_xiaoxi2)
                						        <h3 style="color:#fff;line-height: 1.2;">{{$data_xiaoxi2->content}}</h3>
                							@else
                						        <h3>{{trans("lang.zwjl")}}</h3>
                						    @endif
                	...
                	<div class="zzc">
                		<div class="zzc_tit">
                			<h2><span class="fr"><a href="javascript:click_show('#huodong');">{{trans("lang.gengduo")}}</a></span>{{trans("lang.flhd")}}</h2>
                		</div>
                		<div class="qbhd_nr">
                			<ul>
                			    @foreach($data_huodong as $k => $item)
                				    <li>
                							<a href="javascript:open_huodong('{{$item->id}}');">
                								<div class="qbhdbox">
                	...
                	<div class="zzc" style="padding-bottom:3%;">
                		<div class="zzc_tit">
                			<h2><span class="fr"><a href="javascript:click_show('#chongzhijilv')">{{trans("lang.xiangxi")}}</a></span>{{trans("lang.baobiao")}}</h2>
                		</div>
                		<div class="qbhd_nr">
                			<ul>
                				<li>
                					<div class="zxjl">
                						...
                						<div class="zxjl_right">
                							...
                							<p><span>{{date('m-d',strtotime($recharge->created_at))}}</span>{{$recharge->money}}{{trans("lang.yuan")}}</p>
                							<p>
                						    ...
                						    @else
                						        <h2 style="margin-right:.4rem">{{trans("lang.zwjl")}}</h2>
                						    @endif
                				...
                				<li>
                					<div class="zxjl">
                						...
                						<div class="zxjl_right">
                							...
                							<p><span>{{date('m-d',strtotime($drawing->created_at))}}</span>{{$drawing->money}}{{trans("lang.yuan")}}</p>
                							<p>
...
<div class="cmtc" style="bottom:-25rem;z-index:999999">
	<form action="/m/send_fsss" method="post" onsubmit="$('.submit-form-sync').attr('disabled',true);">
		<div class="cmtc_tit"><h2>{{trans("lang.ssfs")}}</h2></div>
		<div class="cmnr">
							<h2><span>$&nbsp;</span><strong id="zongfangshui">{{$total['fs_money']}}</strong></h2>
			<p class="xmsm">{{trans("lang.zzxm")}}</p>
		</div>
		<div class="cmbtn">
			<ul>
				<li><a href="javascript:void(0);" class="btn3">{{trans("lang.quxiao")}}</a></li>
				<li>
...
<div class="page" id="bangdingshouji">
    ...
    <div class="drawInfor">
		<ul>
			...
			<!--@endif-->
			@if($member->phone)
				<li><span>{{trans("lang.ybdsjh")}}</span><input style="margin-left:10px;" type="text" name="ybdsjh" id="" value="{{$member->phone}}"  readonly autocomplete="off"></li>
				@endif
			...
			<li style="position:relative;">
			    ...
			    <input type="button" id="btn" value="{{trans('lang.hqyzm')}}" class="yanzhen" style="height: 27px;outline: none;cursor: pointer;position: absolute;top: 13px;right: 20px;">
			</li>
...
<script>
    ...
    if (bangdingshouji_countdown == 0) {   
        ...
        $('#bangdingshouji .sty2').val("{{trans('lang.hqyzm')}}");   
        bangdingshouji_countdown = 60;   
        return;  
    } else {   
        $('#bangdingshouji .sty2').attr("disabled", 'disabled');   
        $('#bangdingshouji .sty2').val("{{trans('lang.cxfs')}}(" + bangdingshouji_countdown + ")");   
...
$('#bangdingshouji .yanzhen').click(function(){
    ...
    if (!phone) {
        chenggong_alert(2,"{{trans('lang.qsr')}}{{trans('lang.sjh')}}");
        return false}
    $.ajax({
        url:"/m/msgcode",
        data:{phone:phone},
    ...
    <div class="inforTxt" style="border:none;">
    	<ul>
    	    <li>
            	...
            	<div class="inforLeft">
                	<h2>{{trans("lang.grxx")}}</h2>
                </div>
                <a href="javascript:click_show('#xiugaimima')" class="changebtn">{{trans('lang.genghuan')}}</a>
    	    </li>
    	    <li>
                ...
                <a href="javascript:click_show('#qukuanmima')" class="changebtn">{{trans('lang.genghuan')}}</a>
    	    </li>
        </ul>
    </div>
</div>
...
function xiugaimima_settime() {  
    if (xiugaimima_countdown == 0) {   
        ...
        $('#xiugaimima .sty2').val("{{trans('lang.hqyzm')}}");   
        xiugaimima_countdown = 60;   
        return;  
    } else {   
        $('#xiugaimima .sty2').attr("disabled", 'disabled');   
        $('#xiugaimima .sty2').val("{{trans('lang.cxfs')}}(" + xiugaimima_countdown + ")");   
...
function qukuanmima_settime() {  
    if (qukuanmima_countdown == 0) {   
        ...
        $('#qukuanmima .sty2').val("{{trans('lang.hqyzm')}}");   
        qukuanmima_countdown = 60;   
        return;  
    } else {   
        $('#qukuanmima .sty2').attr("disabled", 'disabled');   
        $('#qukuanmima .sty2').val("{{trans('lang.cxfs')}}(" + qukuanmima_countdown + ")");   
			...
			<ul>
					<li>
						<div class="qbhdbox">
                                        ...
                                        <h3 style="color:#fff;line-height: 2; text-align:center;">{{trans('lang.xiangxilianxikefu')}}</h3>
...
<div class="page" id="chongzhijilv">
	...
	<div style="position: fixed;top:.9rem;width: 100%;height:.78rem;background: #3a3a3a; z-index:99;">
		<a href="javascript:;"><div class="acse as">{{trans("lang.cunkuan")}}</div></a>
		<a href="javascript:click_show('#tixianjilv')"><div class="acse">{{trans("lang.tixian")}}</div></a>
		<a href="javascript:click_show('#touzhujilv')"><div class="acse">{{trans("lang.touzhu")}}</div></a>
		<a href="javascript:click_show('#honglijilv')"><div class="acse">{{trans("lang.fanshui")}}</div></a>
	</div>

	<div class="select-info">
        <div class="select-dw" style="width:23%">
            <span style="line-height:.6rem;font-size:.32rem;color:#fff">{{trans("lang.xzrq")}}：</span>
        </div>
        <div class="select-time" style="width:72%;margin-left: 0px;">
			<div style="width:100%;overflow: hidden;">
                <p style="width: 16%" tid="1" class="on" onclick="chongzhijilv_qiehua(1,this)">{{trans("lang.jinri")}}</p>
                <p style="width: 15.5%" tid="2" onclick="chongzhijilv_qiehua(2,this)">2{{trans("lang.day")}}</p>
				<p style="width: 15.5%" tid="3" onclick="chongzhijilv_qiehua(3,this)">3{{trans("lang.day")}}</p>
				<p style="width: 15.5%" tid="5" onclick="chongzhijilv_qiehua(4,this)">5{{trans("lang.day")}}</p>
                <p style="width: 18%" tid="7" onclick="chongzhijilv_qiehua(7,this)">7{{trans("lang.day")}}</p>
                <p style="width: 19.5%" tid="30" onclick="chongzhijilv_qiehua(30,this)">30{{trans("lang.day")}}</p>
            </div>
        </div>
    </div>
								...
								$.ajax({
									...
									success : function (data) {
										if(data.status.errorCode == 0){
											...
											if(!data2.length){
												_self.isGet = false;
												$("#chongzhijilv #load").show().text('{{trans("lang.meiyougengduole")}}');
											...
											if(data2.length > 15){
										    	$("#chongzhijilv #load").show().text('{{trans("lang.shanglajiazaigengduo")}}');
											}
...
<div class="page" id="tixianjilv">
	...
	<div class="nytop" style="position: fixed;top:0;width: 100%; z-index:99;">
		<a href="javascript:div_close2('#wode');" class="fhbtn"></a>
		<h1>{{trans("lang.txjl")}}</h1>
	</div>

	<div style="position: fixed;top:.9rem;width: 100%;height:.78rem;background: #3a3a3a;z-index: 99;">
		<a href="javascript:click_show('#chongzhijilv');"><div class="acse">{{trans("lang.cunkuan")}}</div></a>
		<a href="javascript:"><div class="acse as">{{trans("lang.tixian")}}</div></a>
		<a href="javascript:click_show('#touzhujilv')"><div class="acse">{{trans("lang.touzhu")}}</div></a>
		<a href="javascript:click_show('#honglijilv')"><div class="acse">{{trans("lang.fanshui")}}</div></a>
		<!--<a href="/m/transfer_record"><div class="acse">{{trans("lang.edzh")}}</div></a>-->
	</div>
	...
	<div class="select-info">
        ...
        <div class="select-time" style="width:72%;margin-left: 0px;">
			<div style="width:100%;overflow: hidden;">
                <p style="width: 16%" tid="1" class="on" onclick="tixianjilv_qiehua(1,this)">{{trans("lang.jinri")}}</p>
                <p style="width: 15.5%" tid="2" onclick="tixianjilv_qiehua(2,this)">2{{trans("lang.day")}}</p>
				<p style="width: 15.5%" tid="3" onclick="tixianjilv_qiehua(3,this)">3{{trans("lang.day")}}</p>
				<p style="width: 15.5%" tid="5" onclick="tixianjilv_qiehua(4,this)">5{{trans("lang.day")}}</p>
                <p style="width: 18%" tid="7" onclick="tixianjilv_qiehua(7,this)">7{{trans("lang.day")}}</p>
                <p style="width: 19.5%" tid="30" onclick="tixianjilv_qiehua(30,this)">30{{trans("lang.day")}}</p>
            </div>
        </div>
    </div>
				...
				$.ajax({
					...
					success : function (data) {
						if(data.status.errorCode == 0){
							...
							if(!data2.length){
								_self.isGet = false;
								$("#tixianjilv #load").show().text('{{trans("lang.meiyougengduole")}}');
							...
							if(data2.length > 15){
							    $("#tixianjilv #load").show().text('{{trans("lang.shanglajiazaigengduo")}}');
							}
...
<div class="page" id="touzhujilv">
	...
	<div class="m_container">
		...
		<a href="javascript:div_close2('#wode');" class="fhbtn"></a>
			<h1>{{trans("lang.touzhujilu")}}</h1>
		</div>

		<div style="position: fixed;top:.9rem;width: 100%;height:.78rem;background: #3a3a3a;z-index: 99;">
			<a href="javascript:click_show('#chongzhijilv');"><div class="acse">{{trans("lang.cunkuan")}}</div></a>
			<a href="javascript:click_show('#tixianjilv')"><div class="acse">{{trans("lang.tixian")}}</div></a>
			<a href="javascript:"><div class="acse as">{{trans("lang.touzhu")}}</div></a>
			<a href="javascript:click_show('#honglijilv')"><div class="acse">{{trans("lang.fanshui")}}</div></a>
			<!--<a href="/m/transfer_record"><div class="acse">{{trans("lang.edzh")}}</div></a>-->
		</div>
		...
		<div class="select-info">
	        ...
	        <div class="select-time" style="width:72%;margin-left: 5px;">
				<div style="width:100%;overflow: hidden;">
	                <p style="width: 16%" tid="1" class="on" onclick="touzhujilv_qiehua(1,this)">{{trans("lang.jinri")}}</p>
	                <p style="width: 15.5%" tid="2" onclick="touzhujilv_qiehua(2,this)">2{{trans("lang.day")}}</p>
					<p style="width: 15.5%" tid="3" onclick="touzhujilv_qiehua(3,this)">3{{trans("lang.day")}}</p>
					<p style="width: 15.5%" tid="5" onclick="touzhujilv_qiehua(4,this)">5{{trans("lang.day")}}</p>
	                <p style="width: 18%" tid="7" onclick="touzhujilv_qiehua(7,this)">7{{trans("lang.day")}}</p>
	                <p style="width: 19.5%" tid="30" onclick="touzhujilv_qiehua(30,this)">30{{trans("lang.day")}}</p>
	            </div>
	        </div>
	    </div>
	    ...
	    <div class="m_body" style="margin-top:2.42rem">
			<div class="gm_main">			
				<div class="content">
					...
					<div class="all-info">
						<div class="make-money">
							<p>{{trans("lang.zongtouzhu")}}: </p>  
							<h3 id="total" style="font-size: 20px;">$</h3>
						</div>
						<div class="failure">
							<h3 id="sunyi">$</h3>
							<p>{{trans("lang.sunyi")}}:</p>  
						</div>
					</div>
						...
						$.ajax({
							...
							success : function (data) {
								if(data.status.errorCode == 0){
									...
									if(!data2.length){
										_self.isGet = false;
										$("#touzhujilv #load").show().text('{{trans("lang.meiyougengduole")}}');
										$('#touzhujilv .jiazaizhon').hide();
									    click_on = true;
										return false;
									}
								    if(data2.length > 15){
							        	$("#touzhujilv #load").show().text('{{trans("lang.shanglajiazaigengduo")}}');
								    }
									for(let item of data2){
										...
										$('#touzhujilv_list').append(`<div class="list">
												<div class="list-top" onclick="qiehuan(this)" data-type = "1">
													...
													<div class="list-top2">
														<div>{{trans("lang.touzhu")}}: <strong style="color:red;">$ `+item.validBetAmount+`</strong></div>
														<div>{{trans("lang.zjj")}}：
												...
												<div class="list-bottom">
													...
													<div><span>{{trans("lang.touzhu")}}</span><span>`+item.validBetAmount+`</span></div>
...
<div class="page" id="honglijilv">
	...
	<div style="position: fixed;top:.9rem;width: 100%;height:.78rem;background: #3a3a3a;z-index: 99;">
			...
			<a href="javascript:click_show('#tixianjilv')"><div class="acse">{{trans("lang.tixian")}}</div></a>
			<a href="javascript:click_show('#touzhujilv')"><div class="acse">{{trans("lang.touzhu")}}</div></a>
			<a href="javascript:"><div class="acse as">{{trans("lang.fanshui")}}</div></a>
	</div>
	...
	<div class="select-info">
        ...
        <div class="select-time" style="width:72%;margin-left: 0px;">
			<div style="width:100%;overflow: hidden;">
                 ...
                 <p style="width: 16%" tid="1" class="on" onclick="honglijilv_qiehua(1,this)">{{trans("lang.jinri")}}</p>
	                <p style="width: 15.5%" tid="2" onclick="honglijilv_qiehua(2,this)">2{{trans("lang.day")}}</p>
										<p style="width: 15.5%" tid="3" onclick="honglijilv_qiehua(3,this)">3{{trans("lang.day")}}</p>
									<p style="width: 15.5%" tid="5" onclick="honglijilv_qiehua(4,this)">5{{trans("lang.day")}}</p>
	                <p style="width: 18%" tid="7" onclick="honglijilv_qiehua(7,this)">7{{trans("lang.day")}}</p>
	                <p style="width: 19.5%" tid="30" onclick="honglijilv_qiehua(30,this)">30{{trans("lang.day")}}</p>
								...
								$.ajax({
									...
									success : function (data) {
										if(data.status.errorCode == 0){
											...
											if(!data2.length){
												_self.isGet = false;
												$("#honglijilv #load").show().text('{{trans("lang.meiyougengduole")}}');
												$('#honglijilv .jiazaizhon').hide();
												click_on = true;
												return false;
											}
											if(data2.length > 15){
											    $("#honglijilv #load").show().text('{{trans("lang.shanglajiazaigengduo")}}');
											}
											for(let item of data2){
					                            ...
					                            $('#honglijilv_list').append(`<div class="list">
														<div class="list-top" onclick="qiehuan(this)" data-type = "1">
															...
															<div class="list-top2">
																<div>{{trans("lang.leixing")}}: <strong style="color:red;">$ `+item.money+`</strong></div>
															</div>
															<a href = "javascript:;" ></a>
														</div>
														<div class="list-bottom">
															...
															<div><span>{{trans("lang.leixing")}}</span><span>`+item.type+`</span></div>
														</div>
													</div>`)
	...
	<div id="main-container" class="main-container" style="height:100%;background:#222;">
	    ...
	    <div class="noticeAltbox noticeAltbox2">
    		...
    		<div class="noticeAltbox-bottom">
    		    <span class="toplay"  @if($_member) data-url="/game/playGame?plat_type=JK&game_type=3&game_code=&devices=1" @else data-url="" @endif data-code="JK">X1</span>
    			<span class="toplay"  @if($_member) data-url="/game/playGame?plat_type=JK2&game_type=3&game_code=&devices=1" @else data-url="" @endif data-code="JK2">X2</span>
    			
    			<span class="toplay"  @if($_member) data-url="/game/playGame?plat_type=JK5&game_type=3&game_code=&devices=1" @else data-url="" @endif data-code="JK5">X5</span>
    			<span class="toplay"  @if($_member) data-url="/game/playGame?plat_type=JK10&game_type=3&game_code=&devices=1" @else data-url="" @endif data-code="JK10">X10</span>
    		</div>
        </div>
        <style>
        /*弹出转账*/
.noticeAltbox-bottom{ display:flex; justify-content:center; flex-wrap:wrap; padding:.5rem 0;}
    ...
    border-radius: 0.3rem;}
		...
		<div class="context home-context">
			...
			<div class="home-fix-top-box">
				<div class="logo-title" style="background: url({{getset('site_logo')}}) no-repeat;background-size: 100% 100%;width:50px;"></div>
    	...
    	<!--						<div class="home-account">{{@$_member -> name}}</div>-->
    	<!--					</div>-->
    	<!--				</div>-->
					...
					<!--<audio id="audio" src="{{$setting->mp3}}" style="width:0; height: 0;"></audio>-->
        ...
        //                 })
					...
					<div class="language-box">
						<div class="language-setting">
							<a class="btn-language" style="height: 22px;width:22px;display: block;background:url({{trans('lang.png')}});    background-size: 100% 100%;position: relative;   top: 2px;" href="javascript:$('#yuyan').show();">
							</a>
			...
			<div id="alert" class="alert_div page">
			    <div class="alert">
			        ...
			        <div class="alert_content">
			            <article><span>{{trans('lang.zhuqianbaoyue')}}</span><span id="user_money">{{@$member->old_money}}</span></article>
			            @foreach($api_list as $item)
                            <?php
                                if(@$member){
                                    $mod = $_member->apis()->where('api_id', $item->id)->first();
                            ...
                            ?>
                            @if($mod)
        			        <article><span>{{ $item->api_title }}</span><span  data-code="{{$item->api_name}}">{{$mod->money}}</span></article>
        			        @else
        			        <article><span>{{ $item->api_title }}</span><span >0.00</span></article>
        			        @endif
    			        @endforeach
			        </div>
			    </div>
   ...
   <!--         </div> -->
						...
						<div class="marquee" style="width: 100%;">
							<div style="width: 100000px; transform: translateX(348.359px); animation: 40.4885s linear 1s infinite normal none running marqueeAnimation-8102871;"
								...
								<div class="js-marquee" style="margin-right: 0px; float: left;">
										<span>{{@$system_notices->title}}</span>{{@$system_notices->content}}
								</div>
							</div>
						</div>
					</div>
				...
				<div class="tab">
					<div class="tab-left">
					    ...
					    <div class="moneystyle" style="color:#fff">
					        <span onclick="click_show('#denglu')">{{trans("lang.denglu")}}</span>/
					        <span onclick="$('#form1')[0].reset();click_show('#zhuce');">{{trans("lang.zhuce")}}</span>
					    </div>
    ...
    font-weight: bold;
        position: relative;
    top: 2px;
    margin-left: 10px;">{{@$_member -> money?$_member -> money:'0.00'}}</text></h6>
					...
					<div class="tab-right">
						<div class="tab-right-btn trans-btn">
							...
							@endif
							<h4 style="color:#b1987f; font-size: 3vmin; font-weight: 400;width: 50px;" class="transfer_text2">{{trans("lang.zhuanhui")}}</h4>
						...
						<!--onclick="location.href='/m/drawing'"-->
    						...
    						<div class="tab-right-btn btn-pop tixian_btn" data-pop="withdraw-dialog"  onclick="@if(!$member['card'] && !$member['trc20'] && !$member['fps'] && !$member['erc20']);click_show('#yinhangkaguanli') @else new_tixian() @endif">
			     ...
			     //   new_money
			         ...
			         $.ajax({
                            ...
                            success:function(res){
        						...
        						if(res.status.errorCode==0){
        						   $('.new_ml_money').val('{{trans("lang.shengyumaliang")}}: '+ res.data.ml_money)
        						    $('.new_money').val('{{trans("lang.yue")}}: '+res.data.money)
    ...
    /*.gamelist-content .gamelist-type .gamelist-col:nth-child(2n){margin-left:0%;margin-right:2%;}*/
			...
			<div class="home-content">
				...
				<div id="gamelist-wrapper" class="gamelist-wrapper">
					...
					<div class="gameitem slotgame active" gamelistbtn="slotgame" onclick="yougxi(0,this)">
						...
						<span class="gameitem-text">{{trans("lang.dianzi")}}</span>
					</div>
					<div class="gameitem live " gamelistbtn="live" onclick="yougxi(1,this)">
						...
						<span class="gameitem-text">{{trans("lang.shixun")}}</span>
					</div>
					<div class="gameitem chess" gamelistbtn="chess" onclick="yougxi(2,this)">
						...
						<span class="gameitem-text">{{trans("lang.qipai")}}</span>
					</div>
					<div class="gameitem" gamelistbtn="sport" onclick="yougxi(3,this)">
						...
						<span class="gameitem-text">{{trans('lang.tiyu')}}</span>
					</div>
					...
					<div class="gameitem fish" gamelistbtn="fish" onclick="yougxi(4,this)">
						...
						<span class="gameitem-text">{{trans("lang.buyu")}}</span>
					</div>
				</div>
					...
					<div class="gamelist-content" >
					    <div class="gamelist-content2" style="padding-bottom:50px;">
					        <div class="gamelist-type active" gamelisttype="slotgame">
    						 <!--   <div class="game-btn gamelist-row toplay"  @if($_member) data-url="/game/playGame?plat_type=JK&game_type=3&game_code=&devices=1" @else data-url="" @endif data-code="JK">-->
    						 <!--       <span>JOERK</span>-->
    						 <!--       <i>{{trans("lang.kqyx")}}</i>-->
           ...
           <!--                         </div>-->
    							...
    							<div class="game-btn gamelist-row toplay2"  @if($_member) data-url="/game/playGame?plat_type=JK&game_type=3&game_code=&devices=1" @else data-url="" @endif data-code="JK">
    						        <span>JOERK</span>
    						        <i>{{trans("lang.kqyx")}}</i>
    							...
    							<!--<div class="game-btn gamelist-row toplay"  @if($_member) data-url="/game/playGame?plat_type=JK2&game_type=3&game_code=&devices=1" @else data-url="" @endif data-code="JK2">-->
    						 <!--       <span>JOERK x2</span>-->
    						 <!--       <i>{{trans("lang.kqyx")}}</i>-->
           ...
           <!--                         </div>-->
    							<!--</div>-->
    							<!--<div class="game-btn gamelist-row toplay"  @if($_member) data-url="/game/playGame?plat_type=JK3&game_type=3&game_code=&devices=1" @else data-url="" @endif data-code="JK3">-->
    						 <!--       <span>JOERK x3</span>-->
    						 <!--       <i>{{trans("lang.kqyx")}}</i>-->
           ...
           <!--                         </div>-->
    							<!--</div>-->
    							<!--<div class="game-btn gamelist-row toplay"  @if($_member) data-url="/game/playGame?plat_type=JK5&game_type=3&game_code=&devices=1" @else data-url="" @endif data-code="JK5">-->
    						 <!--       <span>JOERK x5</span>-->
    						 <!--       <i>{{trans("lang.kqyx")}}</i>-->
           ...
           <!--                         </div>-->
    							<!--</div>-->
    							<!--<div class="game-btn gamelist-row toplay"  @if($_member) data-url="/game/playGame?plat_type=JK10&game_type=3&game_code=&devices=1" @else data-url="" @endif data-code="JK10">-->
    						 <!--       <span>JOERK x10</span>-->
    						 <!--       <i>{{trans("lang.kqyx")}}</i>-->
           ...
           <!--                         </div>-->
    							<!--</div>-->
    							<div class="game-btn gamelist-row toplay"  @if($_member) data-url="/game/playGame?plat_type=JD&game_type=SL&game_code=&devices=1" @else data-url="" @endif data-code="JD">
    						        <span>JDB電子</span>
    						        <i>{{trans("lang.kqyx")}}</i>
    							...
    							<div class="game-btn gamelist-row toplay"  @if($_member) data-url="/game/playGame?plat_type=PG&game_type=SL&game_code=&devices=1" @else data-url="" @endif data-code="PG">
    						        <span>PG電子</span>
    						        <i>{{trans("lang.kqyx")}}</i>
    							...
    							<div class="game-btn gamelist-row toplay"  @if($_member) data-url="/game/playGame?plat_type=CQ&game_type=1&game_code=&devices=1" @else data-url="" @endif data-code="CQ">
    						        <span>CQ9電子</span>
    						        <i>{{trans("lang.kqyx")}}</i>
    							...
    							<div class="game-btn gamelist-row toplay"  @if($_member) data-url="/game/playGame?plat_type=GB&game_type=SL&game_code=&devices=1" @else data-url="" @endif data-code="GB">
    						        <span>BBIN電子</span>
    						        <i>{{trans("lang.kqyx")}}</i>
    							...
    							<!--<div class="game-btn gamelist-row toplay"  @if($_member) data-url="/game/playGame?plat_type=PS&game_type=&game_code=&devices=1" @else data-url="" @endif data-code="PS">-->
    						 <!--       <span>PS電子</span>-->
    						 <!--       <i>{{trans("lang.kqyx")}}</i>-->
           ...
           <!--                         </div>-->
    							<!--</div>-->
    							<div class="game-btn gamelist-row toplay"  @if($_member) data-url="/game/playGame?plat_type=PN&game_type=3&game_code=&devices=1" @else data-url="" @endif data-code="PN">
    						        <span>PNG電子</span>
    						        <i>{{trans("lang.kqyx")}}</i>
    						...
    						<div class="gamelist-type " gamelisttype="live">
    							<!--<div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=DG&game_type=1&game_code=&devices=1" @else data-url="" @endif data-code="DG">-->
    							<div class="game-btn gamelist-row" onclick="alert('维护中')">
    								<span>DG真人</span>
    							    <i>{{trans("lang.kqyx")}}</i>
    							...
    							<!--<div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=S2&game_type=1&game_code=&devices=1" @else data-url="" @endif data-code="S2">-->
    							<div class="game-btn gamelist-row" onclick="alert('维护中')">
    							    <span>SEXY真人</span>
    							     <i>{{trans("lang.kqyx")}}</i>
    							...
    							<!--<div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=WC&game_type=1&game_code=&devices=1" @else data-url="" @endif data-code="WC">-->
    							<div class="game-btn gamelist-row" onclick="alert('维护中')">
    							    <span>WM真人</span>
    							     <i>{{trans("lang.kqyx")}}</i>
    							...
    							<!--<div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=GB&game_type=1&game_code=&devices=1" @else data-url="" @endif data-code="GB">-->
    							<div class="game-btn gamelist-row" onclick="alert('维护中')">
    							    <span>BBIN真人</span>
    							     <i>{{trans("lang.kqyx")}}</i>
    							...
    							<!--<div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=E0&game_type=1&game_code=&devices=1" @else data-url="" @endif data-code="E0">-->
    							<div class="game-btn gamelist-row" onclick="alert('维护中')">
    							    <span>EVO真人</span>
    						        <i>{{trans("lang.kqyx")}}</i>
    						...
    						<div class="gamelist-type" gamelisttype="chess">
    							...
    							<!--<div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=TH&game_type=&game_code=&devices=1" @else data-url="" @endif data-code="TH">-->
    							<!--    <span>天豪棋牌</span>-->
    						 <!--       <i>{{trans("lang.kqyx")}}</i>-->
           ...
           <!--                         </div>-->
    							<!--</div>-->
    							<!--<div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=LG&game_type=CB&game_code=&devices=1" @else data-url="" @endif data-code="LG">-->
    							<!--    <span>樂游棋牌</span>-->
    						 <!--       <i>{{trans("lang.kqyx")}}</i>-->
           ...
           <!--                         </div>-->
    							<!--</div>-->
    							<!--<div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=BL&game_type=&game_code=&devices=1" @else data-url="" @endif data-code="DTQP">-->
    							<!--    <span>博樂棋牌</span>-->
    						 <!--       <i>{{trans("lang.kqyx")}}</i>-->
           ...
           <!--                         </div>-->
    						...
    						<div class="gamelist-type" gamelisttype="sport">
    						 ...
    						 <!--   <div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=CM&game_type=5&game_code=&devices=1" @else data-url="" @endif data-code="CM">-->
    						 <!--        <span>CMD體育</span>-->
    						 <!--       <i>{{trans("lang.kqyx")}}</i>-->
           ...
           <!--                         </div>-->
    						    ...
    						    <div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=S3&game_type=5&devices=1" @else data-url="" @endif data-code="S3">
    						         <span>SBO體育</span>
    						        <i>{{trans("lang.kqyx")}}</i>
    							...
    							<div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=ST&game_type=5&game_code=&devices=1" @else data-url="" @endif data-code="ST">
    							     <span>三昇體育</span>
    						        <i>{{trans("lang.kqyx")}}</i>
    							...
    							<!--<div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=UG&game_type=5&game_code=&devices=1" @else data-url="" @endif data-code="ST">-->
    							<!--     <span>UG體育</span>-->
    						 <!--       <i>{{trans("lang.kqyx")}}</i>-->
           ...
           <!--                         </div>-->
    							<!--</div>	-->
    							<!--<div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=CY&game_type=&game_code=&devices=1" @else data-url="" @endif data-code="ST">-->
    							<!--     <span>RCB賽馬</span>-->
    						 <!--       <i>{{trans("lang.kqyx")}}</i>-->
           ...
           <!--                         </div>-->
    							<!--</div>	-->
    							<!--<div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=S2&game_type=OT&game_code=&devices=1" @else data-url="" @endif data-code="ST">-->
    							<!--     <span>SV斗雞</span>-->
    						 <!--       <i>{{trans("lang.kqyx")}}</i>-->
           ...
           <!--                         </div>-->
    						...
    						<!--	<div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=TF&game_type=7&game_code=&devices=1" @else data-url="" @endif data-code="IA_HK">-->
    						<!--	    <span>雷火電競</span>-->
    						<!--        <i>{{trans("lang.kqyx")}}</i>-->
          ...
          <!--                          </div>-->
    						...
    						<div class="gamelist-type" gamelisttype="fish" style="padding-bottom:0;">
    							...
    							<div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=JK&game_type=FH&devices=1" @else data-url="" @endif data-code="JK">
    							    <span>JOKER捕魚</span>
    						        <i>{{trans("lang.kqyx")}}</i>
    							...
    							<div class="game-btn gamelist-row toplay" @if($_member) data-url="/game/playGame?plat_type=GB&game_type=FH&devices=1" @else data-url="" @endif data-code="GB">
    							<!--<div class="game-btn gamelist-row" onclick="alert('维护中')">-->
    							    <span>BBIN捕魚</span>
    						        <i>{{trans("lang.kqyx")}}</i>
           ...
           <!--                     <div class="game-btn gamelist-row" onclick="window.open('https://xvideos.com/')">-->
			...
			<div class="home-fix-bottom-box">
				<a  class="fix-bottom-btn active" href="javascript:open_div('#index');new_tixian2()">
					...
					<strong class="home-fix-bottom-text">{{trans("lang.shouye")}}</strong>
				</a>
				<a  class="fix-bottom-btn btn-pop" href="javascript:click_show('#huodong');">
					<span><img src = "/new0404/images/nav-2.png" /></span>
					<strong class="home-fix-bottom-text">{{trans("lang.hdzx")}}</strong>
				</a>
				<!-- @if (!Auth::guard('member')->guest())-->
				...
				<!--	<strong class="home-fix-bottom-text">{{trans("lang.edzh")}}</strong>-->
				<!--</a>-->
				<!--@else-->
				...
				<a href="{{$setting->service_link}}" class="fix-bottom-btn btn-service kefu_box" >
					<span><img src = "/new0404/images/nav-3.png" /></span>
					<strong class="home-fix-bottom-text">{{trans("lang.zxkf")}}</strong>
					
				</a>
				@if (!Auth::guard('member')->guest())
				<a  class="fix-bottom-btn btn-pages" href="javascript:click_show('#wode');new_tixian2()">
					<span><img src = "/new0404/images/nav-4.png" /></span>
					<strong class="home-fix-bottom-text ">{{trans("lang.wode")}}</strong>
				</a>
				@else
	...
	<!-- 公告  //修改-->
	@if($gonggao==0 && count($gongao) >= 1)
    	<div id="bulletin-dialog" class="modal after-close bulletin-dialog">
    	    
    	    <div class="new_dialog">
    	        @foreach($gongao as $k => $item)
	            <div class="new_dialog1" style="<?php if($k != 0){ echo 'display:none;';} ?>">
        	        <h6>{{ $item['title'] }}<img src  = "/new/css/close.png" onclick="$('#modal-backdrop,#bulletin-dialog').hide();$('.img_bofang').click()" /></h6>
    	        ...
    	        <div class="new_dialog_btn">
    	            <span class="new_dialog_pre" onclick="fun_dialog_pre();" style="display:none;">{{trans("lang.shangyige")}}</span>
    	            <span class="new_dialog_next" onclick="fun_dialog_next();">{{trans("lang.xiayige")}}</span>
    	        </div>
    	    </div>
    ...
    @if($setting->alert_img)
        <div id="alert_img">
            @php
                $alert_img = explode(',',$setting->alert_img);
            @endphp
            @foreach($alert_img as $k => $item)
                <div class="alert_img alert_img{{$k}}" style="@if($k>0)display:none;@endif">
                    <img src='{{ $item }}' class="imgss{{$k}}" style="width:60%;"/><br><br>
                    <img src='new0404/images/w_close01.svg'  class="img2" onclick="$('.alert_img{{$k}}').hide();$('.alert_img{{$k+1}}').show();@if($k==count($alert_img)-1)$('#alert_img').hide();$('#bulletin-dialog,#modal-backdrop').fadeToggle('slow');@endif" />
                </div>
...
<div class="noticeAltbox" style="display: none;">
		<div class="noticeTitlebox">
			您需要為【<span id="plat_type" class="plat_type"></span>】轉入金額嗎?
		</div>
		<div class="formAlt">
			<div class="lastMoney">
				<p>當前余額：<span id="lesNum" class="gamemoney_text">{{@$member->money}}</span></p>
...
let hei_arr = [0], hei_int = 0;
    ...
    function aaaa(){
        $('.refuseBtn').click();
        return;
        $('.gamemoney_text').text("{{trans("lang.jiazaizhong")}}...");
        $('#user_money').text("{{trans("lang.jiazaizhong")}}...");
        var len = $('.gamecode').length;
        $.ajax({
...
// 		});
    ...
    $('#transfer3,#transfer,#transfer2,#transfer4,#trans_all').click(function(){
        $('#loading_div').css({'display':'flex'});
	    var that = $(this);
	    $('.transfer_text').text('{{trans("lang.hsz")}}...');
	    $('.transfer_text2').text('{{trans("lang.hsz")}}...');
	    $('.transfer_text').val('{{trans("lang.hsz")}}...');
	    var len = $('.gamecode').length;
		...
		setTimeout(function(){
		    $('.transfer_text').text("{{trans("lang.zijinhuishou")}}");
	        $('.transfer_text').val("{{trans("lang.zijinhuishou")}}");
	        $('.transfer_text2').text("{{trans("lang.zhuanhui")}}");
	   ...
	   //     type:'post',
	   //     success:function(res){
	   //         that.next().text('{{trans("lang.zijinhuishou")}}');
	   //        // location.reload()
	   //        $.ajax({
	   //            url:'/member/getNowMoney',
	   //            success:function(res){
...
//     })
    function refresh_ml2(){
        $('#ml_money').text('{{trans("lang.jiazaizhong")}}...');
        $.ajax({
            url:'/m/refresh_ml2',
            success:function(res){
                if(res.status.errorCode==0){
