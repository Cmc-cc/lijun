				...
				<div class="info-list" style="padding-bottom:10px;">
    			    ...
    			    <table class="Hyzx-table mt10 MMain" style="line-height: 1.5; width:100%;">
                        ...
                        <tr style="line-height:3;">
                            <th style="width:33%; text-align: center;">{{trans("lang.wanfa")}}</th>
                            <th style="width:33%; text-align: center;">{{trans("lang.jine")}}</th>
                            <th style="width:33%; text-align: center;">{{trans("lang.zjj")}}</th>
                        </tr>
                        </thead>
