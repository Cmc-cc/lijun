	...
	<div class="select-info">
        ...
        <div class="select-time" style="width:72%;margin-left: 0px;">
			<div style="width:100%;overflow: hidden;">
                <p  style="width: 16%" tid="1" @if($day==1)class="on"@endif onclick="location.href='/m/member_offline_recharge?day=1'">今日</p>
                <p style="width: 15.5%" tid="2" @if($day==2)class="on"@endif onclick="location.href='/m/member_offline_recharge?day=2'">2日</p>
				<p style="width: 15.5%" tid="3" @if($day==3)class="on"@endif onclick="location.href='/m/member_offline_recharge?day=3'">3日</p>
				<p style="width: 15.5%" tid="5" @if($day==5)class="on"@endif onclick="location.href='/m/member_offline_recharge?day=5'">5日</p>
                <p style="width: 18%" tid="7" @if($day==7)class="on"@endif onclick="location.href='/m/member_offline_recharge?day=7'">7日内</p>
                <p style="width: 19.5%" tid="30" @if($day==30)class="on"@endif onclick="location.href='/m/member_offline_recharge?day=30'">30日内</p>
            </div>
        </div>
    </div>
