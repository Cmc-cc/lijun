...
<div class="m_container">
	...
	<div style="position: fixed;top:.9rem;width: 100%;height:.68rem;background: #3a3a3a;z-index: 99;">
		...
		<a href="/m/user_fsjl"><div class="acse as">{{trans("lang.fanshui")}}</div></a>
	...
	<div class="select-info">
        ...
        <div class="select-time" style="width:72%;margin-left: 0px;">
			<div style="width:100%;overflow: hidden;">
                <p  style="width: 16%" tid="1" @if($day==1)class="on"@endif onclick="qiehua(1,this)">{{trans("lang.jinri")}}</p>
                <p style="width: 15.5%" tid="2" @if($day==2)class="on"@endif onclick="qiehua(2,this)">2{{trans("lang.day")}}</p>
				<p style="width: 15.5%" tid="3" @if($day==3)class="on"@endif onclick="qiehua(3,this)">3{{trans("lang.day")}}</p>
				<p style="width: 15.5%" tid="5" @if($day==5)class="on"@endif onclick="qiehua(5,this)">5{{trans("lang.day")}}</p>
                <p style="width: 18%" tid="7" @if($day==7)class="on"@endif onclick="qiehua(7,this)">7{{trans("lang.day")}}</p>
                <p style="width: 19.5%" tid="30" @if($day==30)class="on"@endif onclick="qiehua(30,this)">30{{trans("lang.day")}}</p>
            </div>
        </div>
    </div>
				...
				<!--<div class="info-list">
    			    ...
    			    <table class="Hyzx-table mt10 MMain" style="line-height: 1.5;">
                        ...
                        <tr>
                            ...
                            <th style="width:33%">{{trans("lang.wanfa")}}</th>
                            <th style="width:33%">{{trans("lang.touzhu")}}</th>
                            <th style="width:33%">{{trans("lang.zjj")}}</th>
                        </tr>
                        </thead>
                        <tbody id="general-msg">
                                ...
                                @foreach($data as $item)
                                    <tr class="haveRead MColor1" style="display: table-row;">
                                        ...
                                        <td style="text-align:center;">{{ $item->describe }}</td>
									...
									success : function (data) {
										if(data.status.errorCode == 0){
											...
											for(let item of data2){
												...
												// 		</div>
												// 		<div class="list-bottom">
												// 			<div><span>{{trans("lang.wanfa")}}</span><span>`+ item.money+`</span></div>
