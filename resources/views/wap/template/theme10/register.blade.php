...
<head>
    ...
    <meta name="notify-type" content<html style="height: 100%" language="tw">
<head>
    <meta http-equiv="content-type" content="text/html; charset=UTF-8">
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <style>
        .input-box{
            background-color: hsla(0,0%,1000%,.3) !important;
        }
        input{
            color:#fff !important;
        }
	...
	<div id="registion-dialog" class="registion-dialog" style="display: block;">
		<div class="registion-box">
			<div class="registion-title">
				<div class="text_181" style="font-size: 5vmin; font-weight: 600; color: #fff;"></div>
			</div>
			<div class="registion-logo" style="background:url({{ $_system_config->site_logo}});background-size:100% 100%;"></div>
			<div class="registion-content">
				<form method="post" action="{{ route('wap.register.post') }}" onSubmit="return
				check_form(this)" id="form1">
					<div class="input-box registion-input-box
					username" style="display: inline-flex;">
						<input name="name" type="text" id="name" style="outline:none;" required="required" minlength="6" maxlength="9" placeholder="{{trans('lang.qingshuruzanghao')}} *">
					</div>
					<div class="input-box registion-input-box password" style="display:
					inline-flex;">
						<input name="password" type="password" style="outline:none;" id="registpassword" required="required" minlength="6" maxlength="12" placeholder="{{trans('lang.qingshurumima')}} *"></div>
					<div class="input-box registion-input-box password2" style="display: inline-flex;">
						<input name="password_confirmation" style="outline:none;" type="password" id="registpassword2" required="required" minlength="6" maxlength="12" placeholder="{{trans('lang.qingzaicishuru')}}{{trans('lang.mima')}} *"></div>
					<div class="input-box registion-input-box truename" style="display:
					inline-flex;">
						<input name="qk_pwd" type="password" style="outline:none;" id="registtruename" minlength="6" maxlength="10" required="required" placeholder="{{trans('lang.qingshuqukuanmima')}} *"></div>
						
						<div class="input-box registion-input-box
					username" style="display: inline-flex;">
						<input name="username" type="text" id="username" style="outline:none;" required="required"  placeholder="{{trans('lang.qingshuru')}}{{trans('lang.zsxm')}} *">
					</div>
						@if($setting->sms_message)
					<div class="input-box registion-input-box phone" style="display: inline-flex;">
						<input name="phone" type="text" id="phone" style="outline:none;" required="required" minlength="8" maxlength="11" style="width: 60%;" placeholder="{{trans('lang.qingshuru')}}{{trans('lang.sjh')}}*">
					...
					<div class="input-box registion-input-box phoneCode" style="">
						<input name="code" type="text" id="registPhoneCode" style="outline:none;" placeholder="{{trans('lang.qingshuru')}}{{trans('lang.yzm')}}*"></div>@else
					<div class="input-box registion-input-box phone" style="display:
					inline-flex;">
						<input name="phone" type="text" id="phone" style="outline:none;" required="required" minlength="8" maxlength="11" placeholder="{{trans('lang.qingshuru')}}{{trans('lang.sjh')}} *">
					</div>
					@endif
					...
					<div class="registion-gologin" id="btn-gologin" onclick="goLogin();">已有帳號</div></form>
			</div>
		</div>
	</div>
</div>
   ...
   var password = $("#registpassword").val();
     ...
     var username = $('#username').val();
        ...
        if (password　!= cfmpwd) {
         ...
         if (!phone) {
            alert("請輸入{{trans('lang.sjh')}}!");
            return false;
        }
        if (!username) {
            alert("請輸入{{trans('lang.zsxm')}}!");
            return false;
        }
        var pattern = /^[0-9]{8,11}$/;
        if (!phone) {alert("手機號為8-11個數字!");return false}
