				...
				<div class="BankList-wrapper">
					<div class="btnline" style="width: 100%; height: 80px;">
						<div class="addbank text_1039"
							 style="@if($member['bank']) display: none; @else display: inline-block; @endif background: rgb(241, 234, 145); width: 40%; height: 50px; line-height: 50px; text-align: center; border-radius: 5px; margin: 15px 5%; float: left;"></div>
						<div class="addFPS text_1161"
							 style="@if($member['fps']) display: none; @else display: inline-block; @endif background: #f1ea91; width: 40%; height: 50px; line-height: 50px; text-align: center; border-radius: 5px; margin: 15px 5%; float: left;"></div>
						<div class="addERC20"
							 style="@if($member['erc20']) display: none; @else display: inline-block; @endif background: rgb(241, 234, 145); width: 44%; height: 50px; line-height: 50px; text-align: center; border-radius: 5px; margin: 15px 3%; float: left;">
							USDT-ERC20
						</div>
						<div class="addTRC20"
							 style="@if($member['trc20']) display: none; @else display: inline-block; @endif background: rgb(241, 234, 145); width: 44%; height: 50px; line-height: 50px; text-align: center; border-radius: 5px; margin: 15px 3%; float: left;">
							USDT-TRC20
						</div>
					...
					<div class="list" style="display: inline-block; width: 100%;">
						...
						<div class="bank-list-item"  style="width: 91%; margin: 15px; background: rgb(255, 255, 255); border: 1px solid rgb(220, 180, 84); padding: 10px;">
							...
							<div style="height: 30px; line-height: 30px;">真實姓名: {{$member['username']}}</div>
							<div style="height: 30px; line-height: 30px;">銀行名稱: {{$member['bank']}}</div>
							<div class="FPSAccount"
								 style="line-height: 30px; word-wrap: break-word; word-break: break-all;">銀行卡號: ***{{substr($member['card'],3)}}
							</div>
						</div>
						@endif
						@if($member['fps'])
						<div class="bank-list-item"  style="width: 91%; margin: 15px; background: rgb(255, 255, 255); border: 1px solid rgb(220, 180, 84); padding: 10px;">
							...
							<div style="height: 30px; line-height: 30px;">真實姓名: {{$member['username']}}</div>
							<div class="FPSAccount"
								 style="line-height: 30px; word-wrap: break-word; word-break: break-all;">轉數快帳號: ***{{substr($member['fps'],3)}}
							</div>
						</div>
						@endif
						@if($member['erc20'])
						<div class="bank-list-item"  style="width: 91%; margin: 15px; background: rgb(255, 255, 255); border: 1px solid rgb(220, 180, 84); padding: 10px;">
							...
							<div style="height: 30px; line-height: 30px;">真實姓名: {{$member['username']}}</div>
							<div class="FPSAccount"
								 style="line-height: 30px; word-wrap: break-word; word-break: break-all;">USDT帳號: ***{{substr($member['erc20'],3)}}
							</div>
						</div>
						@endif
						@if($member['trc20'])
						<div class="bank-list-item"  style="width: 91%; margin: 15px; background: rgb(255, 255, 255); border: 1px solid rgb(220, 180, 84); padding: 10px;">
							...
							<div  style="height: 30px; line-height: 30px;">真實姓名: {{$member['username']}}</div>
							<div class="FPSAccount"
								 style="line-height: 30px; word-wrap: break-word; word-break: break-all;">USDT帳號: ***{{substr($member['trc20'],3)}}
							</div>
						</div>
						@endif
					</div>
					...
					<div class="person-acc-box">
						...
						<div class="acc-data" style="height: 70px;">
							...
							<input class="username" type="text" required="required" style="font-size: 12px;margin:0;"
								   placeholder="請輸入持卡人姓名" value="{{$member['username']}}" >
						</div>
