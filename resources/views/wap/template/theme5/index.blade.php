...
<link href="{{ asset('/wap/theme5/css/sweet-alert.css') }}" rel="stylesheet">
<link href="{{ asset('/wap/theme5/css/loadAnimation.css') }}" rel="stylesheet">
...
<div class="homebaner clearboth" id="homebaner" >
    <div class="swiper-container">
        <div class="swiper-wrapper">
            ...
            @endforeach
            {{--<div class="swiper-slide"><img src="~/Areas/Wap2/Content/images/main/banner2.jpg" /></div>
            <div class="swiper-slide"><img src="~/Areas/Wap2/Content/images/main/banner3.jpg" /></div>
            <div class="swiper-slide"><img src="~/Areas/Wap2/Content/images/main/banner4.jpg" /></div>--}}
        </div>
