...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('/wap/theme5/css/swiper.min.css') }}">
    ...
    <script type="text/javascript" src="{{ asset('/wap/theme5/js/jquery-1.11.3.min.js') }}"></script>
    <script src="{{ asset('wap/theme5/js/CUnits.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ asset('wap/theme5/js/wapMain.js') }}"></script>
