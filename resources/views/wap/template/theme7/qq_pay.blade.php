            ...
            <div data-v-5e9fb540="" class="addCard view">
                <div class="userInfo wrap" style="padding: 10px;">
                    ...
                    <form id="form1" name="form1" action="{{ route('wap.post_qq_pay') }}" method="post">
                        ...
                        <button type="button" class="submit_btn ajax-submit-btn" id="SubTran" style="width: 100%;background-color: rgb(63,137,100) !important;">提交信息
                        </button>
                    </form>
