    ...
    <div class="container-fluid gm_main">
        ...
        <div class="userInfo wrap" style="padding: 10px;">
            ...
            <table class="text-center" width="100%"  border="0" cellpadding="0" cellspacing="1">
                ...
                <tr>
                    <td>银行账号</td>
                    <td id="bank_num">{{ $item->card_no }}</td>
                    <td><span class="btn" onclick="copyArticle()" data-clipboard-target="#bank_num" style="color: #e4393c">复制</span></td>
                </tr>
                <tr>
                    <td>开户人姓名</td>
                    <td>{{ $item->username }}</td>
...
@section('after.js')
    ...
    <script>
        function copyArticle() {
             ...
             range.selectNode(document.getElementById('bank_num'));
