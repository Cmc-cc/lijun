...
class GameRecordController extends AdminBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->has('playerName'))
        {
            ...
            $mod = $mod->where('playerName', $playerName);
        }
    ...
    public function gameRecordStatis(Request $request){
        $mod = new GameRecord();
        $playerName = $start_at = $end_at = $api_type = $gameType = $flag ='';
        if ($request->has('api_type'))
        {
        ...
        $data['total_netAmount'] = $mod->sum('netAmount');
        $data['total_betAmount'] = $mod->sum('betAmount');
        $data['total_validBetAmount'] = $mod->sum('validBetAmount');
        return $data;
    }
