...
class Base extends Model
{
    ...
    static public $ON_LINE_HTML = [
        ...
        2      => '<strong style="color:grey;">维护中</strong>'
    ];
    ...
    const BANK_TYPE_EIGHTTEEN     = 18;
    const BANK_TYPE_NINETEEN     = 19;
    const BANK_TYPE_TWEENTY     = 20;
    const BANK_TYPE_TWEENTYONE     = 21;
    ...
    static public $BANK_TYPE = [
        ...
        self::BANK_TYPE_SEVENTEEN => '渣打银行',
        self::BANK_TYPE_EIGHTTEEN => '汇丰银行',
        self::BANK_TYPE_NINETEEN => '中兴银行',
        self::BANK_TYPE_TWEENTY => '恒生银行',
        self::BANK_TYPE_TWEENTYONE => '创新银行'
    ];
