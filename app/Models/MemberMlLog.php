...
class MemberMlLog extends Model
{
    protected $table = 'member_ml_log' ;

    protected $guarded = [];
    
    protected $append = ['type_str'];
    
    // const TYPES =  [1=>'充值',2=>'提现',3=>'提现驳回',4=>'赠送',5=>'系统上分',6=>'系统下分',7=>'接口转入',8=>'接口转出',9=>'转盘',10=>'等级奖励',11=>'实时返水',12=>'亏损补助',20=>'借备用金',21=>'还备用金'];
    const TYPES =  [1=>'下注',2=>'充值',3=>'活动',4=>'洗碼'];
