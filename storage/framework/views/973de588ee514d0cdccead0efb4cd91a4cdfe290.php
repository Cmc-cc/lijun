                                    ...
                                    <div class="pay-list">
                                        <form action="<?php echo e(route('ajax_pay')); ?>" method="post" id="post_pay">
                                            <div class="two">
                                                ...
                                                <div class="card-num">
                                                    <img src="<?php echo e($setting->bld_pic); ?>" style="width:200px;height:200px;">
                                                </div>
                                        ...
                                        <div class="one">
                                            <li>
                                                <div class="title">
                                                    ...
                                                    <span class="alipay">
                                                        轉數快昵称:<?php echo e($_system_config->qq_account); ?><br/>
                                                        轉數快账号:<?php echo e($_system_config->qq_nickname); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="layui-col-xs9">
                                                    <select class="form-control" name="account2">
                                                        ...
                                                        <?php endif; ?>
                                                        <?php if($sunbet && $sunbet->on_line == 1 && $sunbets && $sunbets->on_line==0): ?>
                                                            <option value="<?php echo e($sunbets->id); ?>">申博視訊厅</option>
                                                        <?php endif; ?>
                                                        <?php $__currentLoopData = $api_mod; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if($item->api_name=='AGS' || $item->api_name == 'SUNBETS'): ?><?php continue; ?>;
                                                            <?php endif; ?>
                                ...
                                <div class="pull-left">
                                    <?php if($_member->bank_name): ?>
                                        <div class="crd1 lsts choose">
                                            ...
                                            <p style="padding: 20px 0;font-size: 20px;" class=""><?php echo e($_member->bank_name); ?></p>
