...
<div class="m_container">
	...
	<div style="position: fixed;top:.9rem;width: 100%;height:.68rem;background: #3a3a3a;">
		<a href="/m/recharge_record"><div class="acse as"><?php echo e(trans("lang.cunkuan")); ?></div></a>
		...
		<a href="/m/user_fsjl"><div class="acse"><?php echo e(trans("lang.fanshui")); ?></div></a>
	...
	<div class="select-info">
        ...
        <div class="select-time" style="width:72%;margin-left: 0px;">
			<div style="width:100%;overflow: hidden;">
                <p  style="width: 16%" tid="1" <?php if($day==1): ?>class="on"<?php endif; ?> onclick="location.href='/m/recharge_record?day=1'"><?php echo e(trans("lang.jinri")); ?></p>
                <p style="width: 15.5%" tid="2" <?php if($day==2): ?>class="on"<?php endif; ?> onclick="location.href='/m/recharge_record?day=2'">2<?php echo e(trans("lang.day")); ?></p>
				<p style="width: 15.5%" tid="3" <?php if($day==3): ?>class="on"<?php endif; ?> onclick="location.href='/m/recharge_record?day=3'">3<?php echo e(trans("lang.day")); ?></p>
				<p style="width: 15.5%" tid="5" <?php if($day==5): ?>class="on"<?php endif; ?> onclick="location.href='/m/recharge_record?day=5'">5<?php echo e(trans("lang.day")); ?></p>
                <p style="width: 18%" tid="7" <?php if($day==7): ?>class="on"<?php endif; ?> onclick="location.href='/m/recharge_record?day=7'">7<?php echo e(trans("lang.day")); ?></p>
                <p style="width: 19.5%" tid="30" <?php if($day==30): ?>class="on"<?php endif; ?> onclick="location.href='/m/recharge_record?day=30'">30<?php echo e(trans("lang.day")); ?></p>
            </div>
        </div>
    </div>
				...
				<div class="info-list">
    			    ...
    			    <table class="Hyzx-table mt10 MMain" style="line-height: 1.5;">
                        ...
                        <tr>
                            ...
                            <th style="width:35%"><?php echo e(trans("lang.jine")); ?></th>
                            <th style="width:35%"><?php echo e(trans("lang.zhuangtai")); ?></th>
                            <th style="width:35%"><?php echo e(trans("lang.shijian")); ?></th>
                        </tr>
                        </thead>
                        <tbody id="general-msg">
                                ...
                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="haveRead MColor1" style="display: table-row;">
                                        <td style="text-align:center;">+<?php echo e($item->money); ?><?php echo e(trans("lang.yuan")); ?></td>
                                        <td style="text-align:center;">
                                            <?php if($item->status==1): ?>
                                                        <strong style="color:orange;"><?php echo e(trans("lang.dqr")); ?></strong>
                                                        <?php elseif($item->status==2): ?>
                                                        <strong style="color:green;"><?php echo e(trans("lang.hkcg")); ?></strong>
                                                        <?php else: ?>
                                                        <strong style="color:red;"><?php echo e(trans("lang.hksb")); ?></strong>
                                                        <?php endif; ?>
                                        </td>
