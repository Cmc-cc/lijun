    ...
    <section class="content">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <?php echo $__env->make('admin.recharge.refilter', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                ...
                <table id="tab" class="table table-bordered table-hover text-center">
                    ...
                    <tr>
                        ...
                        <th style="width: 5%">赠送金额</th>
                        <th style="width: 5%">汇款方式</th>
                    ...
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($item->member->ml_money): ?>
                                    <font color="red"><?php echo e($item->member->ml_money); ?></font>
                                <?php else: ?>
                            ...
                            <td >
                                <a  >
                                    <button type="button" class="btn btn-danger btn-xs" data-uri="<?php echo e(route('recharge.update', ['id' => $item->id,'type'=>2])); ?>" onclick="showRemark(this)"><?php if($item->fail_reason): ?><?php echo e($item->fail_reason); ?> <?php else: ?>填写备注<?php endif; ?></button>
                                </a>
                            </td>
                        </tr>
                        <?php endif; ?>
