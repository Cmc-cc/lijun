    ...
    <section class="content">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <?php echo $__env->make('admin.drawing.refilter', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                ...
                <table id="tab" class="table table-bordered table-hover text-center">
                    ...
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo e($item->member->username); ?>
                            ...
                            <!--<td class="fail" style="cursor:pointer;" data-id="<?php echo e($item->id); ?>">-->
                            ...
                            <td >
                                ...
                                <a  >
                                    <button type="button" class="btn btn-danger btn-xs" data-uri="<?php echo e(route('drawing.update', ['id' => $item->id,'type'=>2])); ?>" onclick="beizhu(this)"><?php if($item->fail_reason): ?><?php echo e($item->fail_reason); ?> <?php else: ?>填写备注<?php endif; ?></button>
                                </a>
             
                            </td>
                             <td>
                                <?php if($item->user): ?>
                                    <font ><?php echo e($item->user->name); ?></font>
                                <?php else: ?>
                ...
                <div class="clearfix">
                    ...
                    <div class="pull-right" style="margin: 0;">
                        <?php echo $data->appends(['status' => $status, 'name' => $name, 'start_at' => $start_at, 'end_at' => $end_at, 'updated_start_at' => $updated_start_at, 'updated_end_at' => $updated_end_at])->links(); ?>
