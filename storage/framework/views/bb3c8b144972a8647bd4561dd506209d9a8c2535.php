                        ...
                        <div class="memCon memCon1">
                            ...
                            <form class="bindBank" id="addbanks" novalidate="novalidate">
                                ...
                                <div class="oneset" style="display: flex; width: 95%; margin: 15px auto;">
                                    <div class="text_172 oneset bindbankcard" style="text-align: center; width: 33%; height: 35px; <?php if($member['bank']): ?> display: none; <?php else: ?> display: grid; <?php endif; ?> align-items: center; background: rgb(236, 216, 168); margin-right: 10px; cursor: pointer; border-radius: 5px;"></div>
                                    <div class="text_1033 oneset bindfps" style="text-align: center; width: 33%; height: 35px; <?php if($member['fps']): ?> display: none; <?php else: ?> display: grid; <?php endif; ?> align-items: center; background: rgb(236, 216, 168); margin-right: 10px; cursor: pointer; border-radius: 5px;"></div>
                                    <div class="text_1034 oneset bindusdterc20" style="text-align: center; width: 33%; height: 35px; <?php if($member['erc20']): ?> display: none; <?php else: ?> display: grid; <?php endif; ?> align-items: center; background: #ecd8a8; margin-right: 10px; cursor: pointer; border-radius: 5px;"></div>
                                    <div class="text_1035 oneset bindusdttrc20" style="text-align: center; width: 33%; height: 35px; <?php if($member['trc20']): ?> display: none; <?php else: ?> display: grid; <?php endif; ?> align-items: center; background: #ecd8a8; margin-right: 10px; cursor: pointer; border-radius: 5px;"></div>
                               </div>
                                <div class="memMain table-mc form-horizontal oneset">
                                    <div class="control-group" <?php if($member['bank'] && $member['fps'] && $member['erc20'] && $member['trc20']): ?> style="display: none;" <?php endif; ?>>
                                        <label class="control-label text_577">：</label>
                                        <div class="controls">
                                            <input type="text" class="form-control" id="username" required="" aria-required="true" value="<?php echo e($member->username); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <table class="guideTable ">
                                        ...
                                        <tbody id="bankList">
                                          <?php if($member['bank']): ?>
                                            <tr>
                                                <td>1</td>
                                                <td style="word-break: normal;"><?php echo e($member['username']); ?></td>
                                                <td style="word-break: normal;"><div><?php echo e($member['bank']); ?></div><div><?php echo e($member['card']); ?></div></td>
                                                <td></td>
                                                <td></td>
                                                <td></td>
                                            </tr>
