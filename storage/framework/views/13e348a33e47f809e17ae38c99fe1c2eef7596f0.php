	...
	<div class="select-info">
        ...
        <div class="select-time" style="width:72%;margin-left: 0px;">
			<div style="width:100%;overflow: hidden;">
				...
				<p style="width: 15.5%" tid="5" onclick="qiehua(4,this)">5<?php echo e(trans("lang.day")); ?></p>
			...
			<div class="content">
				...
				<div class="info-list" style="background: transparent;">
    			    ...
    			    <table class="Hyzx-table mt10 MMain" style="line-height: 1.5; width:100%;">
                        <thead>
                        <tr>
                            <th style="width:35%; text-align: center;"><?php echo e(trans("lang.jine")); ?></th>
                            <th style="width:35%;text-align: center;"><?php echo e(trans("lang.zhuangtai")); ?></th>
                            <th style="width:35%;text-align: center;"><?php echo e(trans("lang.shijian")); ?></th>
                        </tr>
                        </thead>
