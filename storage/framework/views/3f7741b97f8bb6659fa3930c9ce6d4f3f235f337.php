                                ...
                                <div class="memCon clearfix">
                                    <div class="erclass form-group choiceDate" style="height: 60px;">
                                        ...
                                        <select class="form-control" id="recordType" name="api_type">
                                            <option value="">全部</option>
                                                <?php $__currentLoopData = $api; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k =>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($v->id); ?>" <?php if($api_type == $v->id): ?> selected <?php endif; ?>><?php echo e($v->api_title); ?></option>
                                    ...
                                    <div id="recordType4" class="record">
                                        <table width="100%" class="table table-hover" id="bet">
                                            <thead>
                                            <tr>
                                                <th  style="width: 20%;word-break: normal;"
                                                    class="header text_251">

                                                </th>
                                                <th style="width: 13%;word-break: normal;" class="header text_236">
