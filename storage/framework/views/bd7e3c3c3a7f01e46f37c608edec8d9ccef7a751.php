...
<?php $__env->startSection('content'); ?>
    <div class="nivoSlider" id="Sliderbanner">
        <ul id="au" class="mianbanner">
            ...
            <li><a id="img1"><img src="<?php echo e(asset('/web/images/444.jpg')); ?>"/></a></li>
            <li style="display: none;"><a><img
                            src="<?php echo e(asset('/web/images/333.jpg')); ?>"/></a></li>
            <li style="display: none;"><a><img
                            src="<?php echo e(asset('/web/images/111.jpg')); ?>"/></a></li>
            <li style="display: none;"><a><img
                            src="<?php echo e(asset('/web/images/222.jpg')); ?>"/></a></li>
            <li style="display: none;"><a><img
                            src="<?php echo e(asset('/web/images/555.jpg')); ?>"/></a></li>
            <li style="display: none;"><a><img
                            src="<?php echo e(asset('/web/images/666.jpg')); ?>"/></a></li>
        </ul>
    ...
    <div class="home-one">
        <div class="container">
            <h2 class="title"><?php echo e($_system_config->site_name); ?>，最专业的网上博彩平台</h2>
            <p class="address"><?php echo e($_system_config->site_domain); ?></p>
            <ul>
                <li>
                    <a hidefocus="true" href="<?php echo e(route('web.eGame')); ?>" target="_blank">
                        <img src="<?php echo e(asset('/web/images/home-one1.jpg')); ?>" alt="">
                        <p class="cn">電子游艺</p>
                        <p class="en">Slots</p>
                    </a>
                </li>
                <li>
                    <a hidefocus="true" target="_blank" href="<?php echo e(route('web.liveCasino')); ?>"
                       onclick="return Com_Gametree_Cashap.App.getOnlyMemberLogin();">
                        <img src="<?php echo e(asset('/web/images/home-one2.jpg')); ?>" alt="">
                        <p class="cn">真人娱乐</p>
                        <p class="en">Live casino</p>
                    </a>
                </li>
                <li class="center">
                    <img src="<?php echo e(asset('/web/images/home-one5.jpg')); ?>" alt="">
                </li>
                <li>
                    <a hidefocus="true" href="<?php echo e(route('web.lottory')); ?>">
                        <img src="<?php echo e(asset('/web/images/home-one3.jpg')); ?>" alt="">
                        <p class="cn">幸运彩票</p>
                        <p class="en">Lottery</p>
                    </a>
                </li>
                <li class="last">
                    <a hidefocus="true" href="<?php echo e(route('web.esports')); ?>">
                        <img src="<?php echo e(asset('/web/images/home-one4.jpg')); ?>" alt="">
                        <p class="cn">體育竞猜</p>
                        <p class="en">Sports</p>
                    </a>
                </li>
            </ul>
            <img class="btm-txt" src="<?php echo e(asset('/web/images/home-one6.jpg')); ?>" alt="">
        </div>
    </div>
    ...
    <div class="wrapper">
            ...
            <div class="bd">
                <div class="list about">
                    <div class="content">
                        ...
                        <p class="txt"><?php echo e($_system_config->site_name); ?>一切博彩营业行为皆遵从澳门政府博彩条约。
                            我们在越来越热的网络博彩市场中，不断地求新求变，寻找最新的创意，秉持最好的服务。以带给广大游戏玩家高质量的服务、产品、娱乐，是我们企业永恒的宗旨。</p>
                        <span class="onbtn">形象代言：贝克汉姆</span>
                    </div>
                    <img src="<?php echo e(asset('/web/images/beckham.jpg')); ?>" class="img" alt="">
                </div>
            </div>
            <!--第一个选项卡 end-->
            ...
            <ul class="tabMune">
                ...
                <li class="three tabup">
                    <a href="javascript:;" target="_blank">
                        ...
                        <p class="cn">官方网址 </p>
                        <p class="en"><?php echo e($_system_config->site_domain); ?></p>
        ...
        <div class="home-mobile">
            <div class="weima">
                <img src="<?php echo e($_system_config->wap_qrcode); ?>" alt="">
            </div>
        ...
        <div class="home-msg">
            <img src="<?php echo e(asset('/web/images/q-lion1.jpg')); ?>" alt="" class="hover one">
            <img src="<?php echo e(asset('/web/images/q-lion2.jpg')); ?>" alt="" class="hover two">
            <img src="<?php echo e(asset('/web/images/q-lion3.jpg')); ?>" alt="" class="hover three">
            <img src="<?php echo e(asset('/web/images/q-lion4.jpg')); ?>" alt="" class="hover four">
            <img src="<?php echo e(asset('/web/images/q-lion5.jpg')); ?>" alt="" class="hover five">
            <img src="<?php echo e(asset('/web/images/q-lion6.jpg')); ?>" alt="" class="hover six">
        </div>
