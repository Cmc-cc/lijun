...
<div class="member-container">
	...
	<div class="module-top">
		<div class="top-menu-area">
			<a class="switchroute" href="login_psw_xin"><?php echo e(trans("lang.xgdenglumima")); ?></a>
			<a href="javascript:void(0)" class="active"><?php echo e(trans("lang.xgqkmm")); ?></a>
		</div>
	</div>		
	<div class="module-main" style="margin-top:25px">
		<form class="form-horizontal">
			<div class="form-group">
				...
				<div class="col-xs-6">
					<input name="old_password" type="password"  id="oddPwdPay" class="form-control" oninput="value=value.replace(/[^\d]/g,'')" placeholder="<?php echo e(trans("lang.srjmm")); ?>" maxlength="4">
				</div>
			</div>
			<div class="form-group">
				<label class="col-xs-3 control-label"></label>
				<div class="col-xs-6">
					<input name="password" type="password" id="newPwdPay" class="form-control" oninput="value=value.replace(/[^\d]/g,'')" placeholder="（<?php echo e(trans("lang.qikuangmm")); ?>）" maxlength="4">
				</div>
			...
			<div class="form-group">
				<label class="col-xs-3 control-label"></label>
				<div class="col-xs-6">
					<input id="newPwd2Pay" name="password_confirmation" type="password" class="form-control" oninput="value=value.replace(/[^\d]/g,'')" placeholder="<?php echo e(trans("lang.qrxmm")); ?>" maxlength="4">
				</div>
				<!-- <div class="col-xs-3 info">
					* 4位数取款密码
				</div> -->
...
<script>
    function upPw() {
        ...
        if(!password || !password_confirmation || !old_password){
            chenggong_alert(2,'<?php echo e(trans("lang.qrztxxx")); ?>');
            return false;
        }
        ...
        $.ajax({
            url : "<?php echo e(route('member.update_qk_password')); ?>",
            type : 'POST',
