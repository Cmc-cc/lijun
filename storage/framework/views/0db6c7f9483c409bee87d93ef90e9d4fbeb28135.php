...
<script type="text/javascript">
    $('body').on('click','.kefu_box',function(){
        layer.open({
            content: '<div class="layui-m-layerbtn"><a href="<?php echo e(getset('whatsapp_url')); ?>" target="_blank"><span yes="" type="1"  data-clipboard-target="#url">Whats: '+"<?php echo e(getset('whatsapp')); ?>"+'</span></a></div><div class="layui-m-layerbtn"><a href="<?php echo e(getset('service_link')); ?>" target="_blank"><span yes="" type="1"><?php echo e(trans("lang.zxkf")); ?></span></a></div>'
            ,skin: 'footer'
        });
    })
    function tapCopy(){
