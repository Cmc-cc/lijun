                    ...
                    <div class="banner" style="height:430px;">
                        <div class="wrapper" style="width: 100%;">
                            <div class="banner-img">
                                ...
                                <div class="banner-item" style="position: absolute;background: url(<?php echo e(asset('/web/mb3/images/banner01.jpg')); ?>) no-repeat center center;background-size: 100% 100%;"></div>
                                <div class="banner-item" style="display:none;position: absolute;background: url(<?php echo e(asset('/web/mb3/images/banner001.jpg')); ?>) no-repeat center center;background-size: 100% 100%;"></div>
                                <div class="banner-item" style="display:none;position: absolute;background: url(<?php echo e(asset('/web/mb3/images/banner002.jpg')); ?>) no-repeat center center;background-size: 100% 100%;"></div>
                                <div class="banner-item" style="display:none;position: absolute;background: url(<?php echo e(asset('/web/mb3/images/banner003.jpg')); ?>) no-repeat center center;background-size: 100% 100%;"></div>
                                <div class="banner-item" style="display:none;position: absolute;background: url(<?php echo e(asset('/web/mb3/images/banner0103.jpg')); ?>) no-repeat center center;background-size: 100% 100%;"></div>
                                <div class="banner-item" style="display:none;position: absolute;background: url(<?php echo e(asset('/web/mb3/images/banner03.jpg')); ?>) no-repeat center center;background-size: 100% 100%;"></div>
                                <div class="banner-item" style="display:none;position: absolute;background: url(<?php echo e(asset('/web/mb3/images/banner04.jpg')); ?>) no-repeat center center;background-size: 100% 100%;"></div>
                                <div class="banner-item" style="display:none;position: absolute;background: url(<?php echo e(asset('/web/mb3/images/banner05.jpg')); ?>) no-repeat center center;background-size: 100% 100%;"></div>
