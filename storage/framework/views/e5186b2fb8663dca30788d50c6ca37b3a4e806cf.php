                                  ...
                                  <div class="container service" id="service">
                                     <div class="mx-auto fill-height v-sheet theme--dark transparent" style="max-width: 1280px;">
                                        <div class="d-flex justify-center align-center pa-4">
                                            <h2><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php echo e(trans("lang.bzzx")); ?> </font></font></h2>
                                        </div>
                                                     ...
                                                     <div role="list" class="v-list v-sheet theme--dark v-list--dense v-list--nav">
                                                          <div role="listbox" class="v-item-group theme--dark v-list-item-group primary--text">
                                                           <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <div tabindex="0" role="listitem" class="v-list-item v-list-item--link theme--dark <?php if(request()->get('type') == $v->id): ?> v-item--active v-list-item--active  <?php endif; ?> ">
                                                                    <div class="v-list-item__content" data-type="<?php echo e($v->id); ?>">
                                                                                        ...
                                                                                        <div class="v-responsive__content">
                                                                                            ...
                                                                                            <div class="col">
                                                                                                <div class="v-card__title">
                                                                                                    <font style="vertical-align: inherit;">
                                                                                                        <font style="vertical-align: inherit;"><?php echo e($data->title); ?></font>
                                                                                                    </font>
                                                                                                </div>
