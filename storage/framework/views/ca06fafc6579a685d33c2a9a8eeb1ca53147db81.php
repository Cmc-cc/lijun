    ...
    <div class="fl_in">
        <div class="service_tool">
            <ul>
                ...
                <li><a class="aftertext_1" data-toggle="cs" href="<?php echo e($_system_config->service_link); ?>" target="_blank"
                       onclick="javascript:openChat('<?php echo e($_system_config->service_link); ?>','900','600');" '=""
                    oncontextmenu="return false;"></a></li>
               <!--<li><a class="aftertext_3" href="/r" oncontextmenu="return false;"></a></li>-->
                <li class="appdownload-box" style="display: list-item;"><a class="QRCodeBtn aftertext_6" goal="W3"
                    ...
                    <div id="W3" class="hover-box"><img
                                src="http://dgayt369.com/phpqrcode/get.php?string=http%3A%2F%2Fgameone.fun&amp;size=10">
                    </div>
                </li>
            </ul>
        </div>
