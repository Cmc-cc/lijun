    ...
    <div class="member-container">
    	<div class="member-body">
    		<div id="layout-main-area"><div style="height: 100%; background-color: rgb(255, 255, 255); display: block;" id="layout-main-area-div">
    	     ...
    	     <a href="javascript:;"><div class="zfu bgc"><span style="color:#f5f5f5"><?php echo e(trans("lang.tkzx")); ?></span></div></a>
    
    </div>
    
    <div id="main-container">
    <div style="width:46.2%;height:50px;background:#e1e4e6;margin: 30px auto 0;border-radius: 5px;padding: 11px 0 11px 10px;">
       <div style="width:50%;float:left"><?php echo e(trans("lang.zhye")); ?>&nbsp;<b>:</b>&nbsp;<span style="font-size: 20px;color: #DF9917;">$</span>&nbsp;<span class="ch"></span><span class="ch" id="gamemoneyy" style="font-size: 20px;color:#DF9917;"><?php echo e($member->money); ?></span>
       </div>
    	...
    	<div class="module-main" style="margin-top:20px">
    		...
    		<form action="https://www.emixbet.com/member/drawing" method="post" class="form-horizontal">
    		    <div class="form-group">
    				<label class="col-xs-3 control-label"><?php echo e(trans("lang.zhenshixingming")); ?>：</label>
    				<div class="col-xs-6">
    					 <input class="form-control" id="username" value="<?php echo e($member->username); ?>" <?php if($member->username): ?> disabled <?php endif; ?> >
    				</div>
    			</div>
    				<div class="form-group">
    				<label class="col-xs-3 control-label"><?php echo e(trans("lang.zhlx")); ?>：</label>
    				<div class="col-xs-6">
    					...
    					<!--	<option value='4'>USDT-ERC20</option> -->
    						<option value='5'><?php echo e(trans("lang.yhzz")); ?></option>
                        </select>
    				</div>
    			</div>
    			<div class="form-group fps">
    				<label class="col-xs-3 control-label"><?php echo e(trans("lang.zskzh")); ?>：</label>
    				<div class="col-xs-6">
    					 <input class="form-control" id="fps" value="<?php echo e($member->fps); ?>"   <?php if($member->fps): ?> disabled=""  <?php endif; ?> >
    				</div>
    			</div>
    			<div class="form-group trc" style="display:none;">
    				<label class="col-xs-3 control-label">USDT-TRC20：</label>
    				<div class="col-xs-6">
    					 <input class="form-control" id="trc20"  value="<?php echo e($member->trc20); ?>"  <?php if($member->trc20): ?> disabled <?php endif; ?> >
    				</div>
    			</div>
    			<div class="form-group erc" style="display:none;">
    				<label class="col-xs-3 control-label">USDT-ERC20：</label>
    				<div class="col-xs-6">
    					 <input class="form-control" id="erc20" value="<?php echo e($member->erc20); ?>" <?php if($member->erc20): ?> disabled <?php endif; ?> >
    				</div>
    			</div>
    			<div class="form-group bank" style="display:none;">
    				<label class="col-xs-3 control-label"><?php echo e(trans("lang.yhmc")); ?>：</label>
    				<div class="col-xs-6">
    					 <input class="form-control" id="bank_name" value="<?php echo e($member->bank); ?>"  <?php if($member->bank): ?> disabled <?php endif; ?> >
    				</div>
    			</div>
    			<div class="form-group bank" style="display:none;">
    				<label class="col-xs-3 control-label"><?php echo e(trans("lang.yhzh2")); ?>：</label>
    				<div class="col-xs-6">
    					 <input class="form-control" id="bank_card" value="<?php echo e($member->card); ?>"  <?php if($member->card): ?> disabled <?php endif; ?> >
    				</div>
    			</div>
    			<div class="form-group">
    				<label class="col-xs-3 control-label"><?php echo e(trans("lang.tkje")); ?>：</label>
    				<div class="col-xs-6">
    					<input type="text" class="form-control" id="money2222" name="money" placeholder='<?php echo e(trans("lang.qingshurujine")); ?>' autocomplete="off">
    				</div>
    				<div class="col-xs-3 info">
    					*<span style="color:#FF0000;">&nbsp;<?php echo e(trans("lang.tk100")); ?>&nbsp;</span>
    				</div>
    			</div>
    			<div class="form-group">
    				<label class="col-xs-3 control-label"><?php echo e(trans("lang.shengyumaliang")); ?>：</label>
    				<div class="col-xs-6">
    					<input type="text" value="<?php echo e($member->ml_money); ?>" class="form-control" disabled >
    				</div>
    			</div>	
    			<div class="form-group">
    				<label class="col-xs-3 control-label"><?php echo e(trans("lang.qkmm")); ?>：</label>
    				<div class="col-xs-6">
    					<input type="text" id="qk_pwd" onfocus="this.type='password'" class="form-control" name="qk_pwd" placeholder="******" autocomplete="off">
    				</div>
    				<div class="col-xs-3 info">
    					*<span style="color:#FF0000;"><?php echo e(trans("lang.qingshuqukuanmima")); ?></span>
    				</div>
    			</div>			
    			<div class="form-group">
    				<label class="col-xs-3 control-label"></label>
    				<div class="col-xs-6">
    					<button type="button" onclick="tixian();" class="ajax-submit-without-confirm-btn" style="width: 100%;height: 46px;font-size: 16px;color:#fff;font-weight: 800;border: 0px solid #EB5D4D;background:linear-gradient(90deg,#d2b496,#e6ceb6);margin-top:10px;border-radius: 4px;"><?php echo e(trans("lang.quedihng")); ?></button>
    				</div>
    			</div>
    		</form>
