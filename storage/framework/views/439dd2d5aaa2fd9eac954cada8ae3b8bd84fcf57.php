<?php $__env->startSection('content'); ?>
            ...
            <div class="panel-body">
                ...
                <table class="table table-bordered table-hover text-center">
                    ...
                    <tr>
                        ...
                        <td><strong id="total_netAmount" style="color: red">--</strong></td>
                        <td><strong id="total_betAmount" style="color: red">--</strong></td>
                        <td><strong id="total_validBetAmount" style="color: red">--</strong></td>
                        <td colspan="4"></td>
                    </tr>
                    </tfoot>
                </table>
                <div class="clearfix">
                    ...
                    <div class="pull-right" style="margin: 0;">
                        <?php echo $data->appends(['playerName' => $playerName, 'start_at' => $start_at, 'end_at' => $end_at, 'api_type' => $api_type, 'gameType' => $gameType,'flag'=>$flag])->links(); ?>
    ...
    <script>
         $(function(){
            ...
            let requestUrl = "/gameRecordStatis?" + params;
            $.ajax({
                url:requestUrl,
                success:function(result){
                    $("#total_netAmount").html(result['total_netAmount']);
                    $("#total_betAmount").html(result['total_betAmount']);
                    $("#total_validBetAmount").html(result['total_validBetAmount']);
                }});
         });
     </script>
