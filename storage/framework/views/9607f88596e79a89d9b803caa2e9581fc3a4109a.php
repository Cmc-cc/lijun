            ...
            <div class="col-lg-3">
                <div class="input-group">
                    ...
                    <select name="flag" id="flag" class="form-control">
                        <option value="">--请选择--</option>
                            <option value="1" <?php if($flag == 1): ?> selected <?php endif; ?>>已结算</option>
                            <option value="0" <?php if(is_numeric($flag) && $flag == 0): ?> selected <?php endif; ?>>未结算</option>
                            <option value="-1" <?php if(is_numeric($flag) && $flag == -1): ?> selected <?php endif; ?>>无效注单</option>
                    </select>
                </div>
            </div>
