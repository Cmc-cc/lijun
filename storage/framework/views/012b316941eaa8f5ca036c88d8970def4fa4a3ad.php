<div class="Tfooter">
        ...
        <div class="container clear">
            ...
            <div class="item" id="gtmail">
                ...
                <p class="cn">全球服务热线 <a href="javascript:;">
                        <img src="<?php echo e(asset('/web/images/footer-more.jpg')); ?>" alt=""></a></p>
                <p class="num"><?php echo e($_system_config->phone1); ?></p>
            ...
            <div class="item">
                <i class="iconfont"></i>
                <p class="cn">客服QQ </p>
                <p class="num"><a href="javascript:;" onclick="window.open('http://wpa.qq.com/msgrd?v=3&uin=<?php echo e($_system_config->qq); ?>&site=qq&menu=yes','','width=1024,height=768')"><?php echo e($_system_config->qq); ?></a></p>
            </div>
            <div class="item">
                <i class="iconfont"></i>
                <p class="cn">24小时在线客服</p>
                <a onclick="window.open('<?php echo e($_system_config->service_link); ?>','','width=1024,height=768')"
    ...
    <div class="container">
        ...
        <p class="copyright">
            Copyright © <?php echo e($_system_config->site_name); ?>版权所有
            Reserved
        </p>
    </div>
</div>
