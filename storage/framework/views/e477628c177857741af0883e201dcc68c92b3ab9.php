...
<div class="body-pages page" id="zhuce" >
	<div id="registion-dialog" class="registion-dialog">
		<div class="registion-box">
			...
			<div class="registion-logo" style="background:url(<?php echo e($_system_config->site_logo); ?>);background-size:100% 100%;    margin-top: 10vmin !important;"></div>
            ...
            <section class="xin_zhifu_alert">
                ...
                <section class="xin_zhifu_alert_content">
                    <article class="xin_zhifu_nav">
                        ...
                        <article class="dopay on" onclick="new_qiehuan(1,this,'<?php echo e(trans('lang.zhuanhuankuai')); ?>')"><img src="/new/css/fps.png" alt=""></article>
                        <?php endif; ?>
    
                        <?php if(!$setting->is_bankpay_on): ?>
                        <article class="dopay" onclick="new_qiehuan(4,this,'<?php echo e(trans('lang.yinhangka')); ?>')"><img src="/new/css/add2_i911.png" alt="" style="width: 81%;"></article>
                        <?php endif; ?>
    
                        <?php if(!$setting->is_alipay_on): ?>
                        <article class="dopay" onclick="new_qiehuan(2,this,'<?php echo e(trans('lang.bldzz')); ?>')"><img src="/new/css/bld.png" alt=""></article>
                        <?php endif; ?>
            ...
            if(val != '' && val > 0){
                if(type == 1){
                    $.ajax({
                        ...
                        data : {money:$('#chongzhi2 #new_amount').val(),xiaoshu:xiaoshu},
                        beforeSend: function(){
                            open_load();
                        },
                        complete: function(){
                    ...
                    $.ajax({
                        ...
                        data : {amount:$('#chongzhi2 #new_amount').val(),xiaoshu:0},
                        beforeSend: function(){
                            open_load();
                        },
                        complete: function(){
                    ...
                    $.ajax({
                        type:"post",
                        url : "<?php echo e(route('ajax_pay')); ?>",
                        data : {amount:$('#chongzhi2 #new_amount').val(),xiaoshu:xiaoshu,'paytype':'bank',usdt_type:$('#chongzhi2 #usdt_type').val(),banksss:$('#chongzhi2 #banksss').val()},
                        beforeSend: function(){
                            open_load();
                        },
                        complete: function(){
                    ...
                    $.ajax({
                        type:"post",
                        url : "<?php echo e(route('ajax_pay')); ?>",
                        data : {amount:$('#chongzhi2 #new_amount').val(),xiaoshu:xiaoshu,'paytype':'usdt',usdt_type:$('#chongzhi2 #usdt_type').val()},
                        beforeSend: function(){
                            open_load();
                        },
                        complete: function(){
...
<div class="page" id="wode">
    <div class="body-pages">
    	<div class="pages-container show" style="height:100vh;padding-bottom:60px;">
    	...
    	<!--				</div>-->
					...
					<div class="language-box">
						<div class="language-setting">
							<a class="btn-language" style="height: 34px;width:34px;display: block;background:url(<?php echo e(trans('lang.png')); ?>);    background-size: 100% 100%;position: relative;   top: 2px;" href="javascript:$('#yuyan').show();">
							</a>
    ...
    /*.gamelist-content .gamelist-type .gamelist-col:nth-child(2n){margin-left:0%;margin-right:2%;}*/
			...
			<div class="home-content">
				...
				<div id="gamelist-wrapper" class="gamelist-wrapper">
					...
					<div class="gameitem live active" gamelistbtn="live" onclick="yougxi(0,this)">
					...
					<div class="gameitem chess" gamelistbtn="chess" onclick="yougxi(1,this)">
						<svg width="24px" height="24px" xmlns="http://www.w3.org/2000/svg" class="text-gradient gameicon-svg sprite-app2" data-v-43a11c04="">
					...
					<div class="gameitem" gamelistbtn="sport" onclick="yougxi(2,this)">
						<svg width="24px" height="24px" xmlns="http://www.w3.org/2000/svg" class="text-gradient gameicon-svg sprite-app2" data-v-43a11c04="">
                    ...
                    <div class="gameitem" gamelistbtn="esports" onclick="yougxi(3,this)">
						<svg width="24px" height="24px" xmlns="http://www.w3.org/2000/svg" class="text-gradient gameicon-svg sprite-app2" data-v-43a11c04="">
                                                                                <use href="/_nuxt/5178ea949699c439f7d9adef4e5aead8.svg#i-game-e-game" xlink:href="/_nuxt/5178ea949699c439f7d9adef4e5aead8.svg#i-game-live" data-v-43a11c04=""></use>
                                                                            </svg>
                        <img src="/images/game-e-game.f56aa96.png" />
						<span class="gameitem-text"><?php echo e(trans('lang.dianjing')); ?></span>
					</div>
					<div class="gameitem slotgame" gamelistbtn="slotgame" onclick="yougxi(4,this)">
						<svg width="24px" height="24px" xmlns="http://www.w3.org/2000/svg" class="text-gradient gameicon-svg sprite-app2" data-v-43a11c04="">
					...
					<div class="gameitem fish" gamelistbtn="fish" onclick="yougxi(5,this)">
						<svg width="24px" height="24px" xmlns="http://www.w3.org/2000/svg" class="text-gradient gameicon-svg sprite-app2" data-v-43a11c04="">
					...
					<!--<div class="gameitem lottery" gamelistbtn="lottery" onclick="yougxi(6,this)">-->
					<!--		<svg width="24px" height="24px" xmlns="http://www.w3.org/2000/svg" class="text-gradient gameicon-svg sprite-app2" data-v-43a11c04="">-->
     <!--                                                                           <use href="/_nuxt/5178ea949699c439f7d9adef4e5aead8.svg#i-game-live" xlink:href="/_nuxt/5178ea949699c439f7d9adef4e5aead8.svg#i-game-live" data-v-43a11c04=""></use>-->
     <!--                                                                       </svg>-->
     <!--                   <img src="/images/game-live.d72ce7c.png" />-->
					...
					<div class="gamelist-content" >
					    <div class="gamelist-content2" style="padding-bottom:50px;">
    						<div class="gamelist-type active" gamelisttype="live">
    							...
    							<div class="game-btn gamelist-row toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=GE&game_type=1&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="GE">
    							    <span>EVO真人</span>
    						        <i><?php echo e(trans("lang.kqyx")); ?></i>
    						...
    						<div class="gamelist-type" gamelisttype="sport">
    						    ...
    						    <div class="game-btn gamelist-row toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=SO&game_type=5&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="SO">
    						         <span>SBO體育</span>
    						        <i><?php echo e(trans("lang.kqyx")); ?></i>
    						...
    						<div class="gamelist-type" gamelisttype="slotgame">
    							...
    							<div class="game-btn gamelist-row toplay"  <?php if($_member): ?> data-url="/game/playGame?plat_type=L4&game_type=3&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="L4">
    						        <span>LIVE22電子</span>
    						        <i><?php echo e(trans("lang.kqyx")); ?></i>
    							...
    							<div class="game-btn gamelist-row toplay"  <?php if($_member): ?> data-url="/game/playGame?plat_type=PR&game_type=3&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="PR">
    						        <span>PP電子</span>
    						        <i><?php echo e(trans("lang.kqyx")); ?></i>
    							...
    							<div class="game-btn gamelist-row toplay"  <?php if($_member): ?> data-url="/game/playGame?plat_type=EP&game_type=1&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="JK">
    						        <span>EP電子</span>
    						        <i><?php echo e(trans("lang.kqyx")); ?></i>
...
// 		});
    ...
    $('#transfer3,#transfer,#transfer2,#transfer4').click(function(){
        $('#loading_div').css({'display':'flex'});
	    var that = $(this);
    ...
    $('.toplay').click(function(){
        ...
        $('.toplay').find('.toplay-alert').fadeOut();
                ...
                if(code=='OB'){
                    layer.open({
                        content: '<font color="#000"><?php echo e(trans("lang.weihuzhong")); ?></font>'
                        ,btn: '<?php echo e(trans("lang.wozhidaole")); ?>'
                    });
                    return;
                }
          //   	$.ajax({
