    	...
    	<div class="top-filter">
    			...
    			<div class="form-group">
    				...
    				<div class="col-xs-7">
    					<select name="api_type" id="api_type" class="form-control1 report_option">
    					    <option value=""><?php echo e(trans("lang.xzyx")); ?></option>
    					    <?php $__currentLoopData = $api_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    		...
    		<div class="col-xs-4" style="padding-left:0;padding-right:0">
    			<div class="form-group">
    				...
    				<div class="col-xs-7">
    					<input type="text" id="startTime" class="form-control1" placeholder="<?php echo e(trans("lang.xzrq")); ?>" lay-key="1">
    				</div>
    			</div>		
    		</div>
    		<div class="col-xs-4" style="padding-left:0;padding-right:0">
    			<div class="form-group">
    				...
    				<div class="col-xs-7">
    					<input type="text" id="endTime" style="margin-right:0"  class="form-control1" placeholder="<?php echo e(trans("lang.xzrq")); ?>" lay-key="2">
    				</div>
    			</div>		
    		</div>		
    	</div>
