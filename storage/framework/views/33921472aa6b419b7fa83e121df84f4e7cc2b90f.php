...
<div class="m_container">
	...
	<div class="nytop" style="position: fixed;top:0;width: 100%;">
		...
		<h1><?php echo e(trans("lang.hysybb")); ?></h1>
	</div>

	<div style="position: fixed;top:.9rem;width: 100%;height:.68rem;background: #3a3a3a;">
		<a href="/m/daili_money_log"><div class="acse "><?php echo e(trans('lang.yjffjl')); ?></div></a>
		...
		<a href="/m/member_offline_sy"><div class="acse as"><?php echo e(trans('lang.hysybb')); ?></div></a>
	</div>
    ...
    <!--            <p  style="width: 16%" tid="1" <?php if($day==1): ?>class="on"<?php endif; ?> onclick="location.href='/m/member_offline_sy?day=1'">今日</p>-->
    <!--            <p style="width: 15.5%" tid="2" <?php if($day==2): ?>class="on"<?php endif; ?> onclick="location.href='/m/member_offline_sy?day=2'">2日</p>-->
				<!--<p style="width: 15.5%" tid="3" <?php if($day==3): ?>class="on"<?php endif; ?> onclick="location.href='/m/member_offline_sy?day=3'">3日</p>-->
				<!--<p style="width: 15.5%" tid="5" <?php if($day==5): ?>class="on"<?php endif; ?> onclick="location.href='/m/member_offline_sy?day=5'">5日</p>-->
    <!--            <p style="width: 18%" tid="7" <?php if($day==7): ?>class="on"<?php endif; ?> onclick="location.href='/m/member_offline_sy?day=7'">7日内</p>-->
    <!--            <p style="width: 19.5%" tid="30" <?php if($day==30): ?>class="on"<?php endif; ?> onclick="location.href='/m/member_offline_sy?day=30'">30日内</p>-->
                <input type="text" class="layui-input " id="start" placeholder="开始时间" style="color: #fff;" value="<?php echo e($cn_begin); ?>">
                <input type="text" class="layui-input " id="end" placeholder="结束时间" style="color: #fff;" value="<?php echo e($cn_end); ?>">
            </div>
        </div>
    </div>
		...
		<div class="container-fluid gm_main">			
			<div class="content">
				<div class="info-list">
    			    ...
    			    <table class="Hyzx-table mt10 MMain" style="line-height: 1.5;width:100%;margin-top:20px;">
                        
                        <tbody id="general-msg">
                            <tr class="haveRead MColor1" style="display: table-row;">
                                <td style="text-align:center;"><?php echo e(trans('lang.ckzs')); ?></td>
                                <td style="text-align:center;"><?php echo e($total_recharge); ?></td>
                            </tr>   
                            <tr class="haveRead MColor1" style="display: table-row;">
                                <td style="text-align:center;"><?php echo e(trans('lang.ckbs')); ?></td>
                                <td style="text-align:center;"><?php echo e($recharge_count); ?></td>
                            </tr>   
                            <tr class="haveRead MColor1" style="display: table-row;">
                                <td style="text-align:center;"><?php echo e(trans('lang.tkze')); ?></td>
                                <td style="text-align:center;"><?php echo e($total_drawing); ?></td>
                            </tr>   
                            <tr class="haveRead MColor1" style="display: table-row;">
                                <td style="text-align:center;"><?php echo e(trans('lang.tkbs')); ?></td>
                                <td style="text-align:center;"><?php echo e($drawing_count); ?></td>
                            </tr>   
                            <tr class="haveRead MColor1" style="display: table-row;">
                                <td style="text-align:center;"><?php echo e(trans('lang.hlze')); ?></td>
                                <td style="text-align:center;"><?php echo e($total_dividend); ?></td>
                            </tr>   
                            <tr class="haveRead MColor1" style="display: table-row;">
                                <td style="text-align:center;"><?php echo e(trans('lang.hlbs')); ?></td>
                                <td style="text-align:center;"><?php echo e($dividend_count); ?></td>
                            </tr>   
                            <tr class="haveRead MColor1" style="display: table-row;">
                                <td style="text-align:center;"><?php echo e(trans('lang.yl')); ?></td>
                                <td style="text-align:center;"><?php echo e(round($total_recharge - $total_drawing,2)); ?></td>
                            </tr>   
                            <tr class="haveRead MColor1" style="display: table-row;">
                                <td style="text-align:center;"><?php echo e(trans('lang.hysy')); ?></td>
                                <td style="text-align:center;"><?php echo e(round($total_drawing -  $total_recharge,2)); ?></td>
                            </tr>   
                        </tbody>
