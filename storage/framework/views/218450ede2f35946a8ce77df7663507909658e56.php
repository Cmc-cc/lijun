            	...
            	<div class="top-filter">
            		<div class="col-xs-4" style="padding-left:0;padding-right:0">
            			<div class="form-group">
            				<label class="col-xs-4" style="text-align:center;padding-top:7px;padding-right:0"><?php echo e(trans("lang.xclx")); ?></label>
            				<div class="col-xs-7">
            					<select class="form-control1 report_option" id="report_option" onchange="deposit2()">
            						<option value="0" <?php if($type==0): ?>  selected <?php endif; ?>><?php echo e(trans("lang.ckjl")); ?></option>
            						<option value="1" <?php if($type==1): ?>  selected <?php endif; ?>><?php echo e(trans("lang.tkjl")); ?></option>
            						<option value="2" <?php if($type==2): ?>  selected <?php endif; ?>><?php echo e(trans("lang.edzh")); ?></option>
            						<option value="4" <?php if($type==4): ?>  selected <?php endif; ?>><?php echo e(trans("lang.hljl")); ?></option>
            					</select>
            				</div>
            			</div>			
            		</div>
            		<div class="col-xs-4" style="padding-left:0;padding-right:0">
            			<div class="form-group">
            				<label class="col-xs-4" style="text-align:center;padding-top:7px;padding-right:0"><?php echo e(trans("lang.kssj")); ?></label>
            				<div class="col-xs-7">
            					<input type="text" id="startTime" class="form-control1" value="<?php echo e($start); ?>" placeholder="<?php echo e(trans("lang.xzrq")); ?>" lay-key="1">
            				</div>
            			</div>		
            		</div>
            		<div class="col-xs-4" style="padding-left:0;padding-right:0">
            			<div class="form-group">
            				<label class="col-xs-4" style="text-align:center;padding-top:7px;padding-right:0"><?php echo e(trans("lang.jssj")); ?></label>
            				<div class="col-xs-7">
            					<input type="text" id="endTime" style="margin-right:0" value="<?php echo e($end); ?>" class="form-control1" placeholder="<?php echo e(trans("lang.xzrq")); ?>" lay-key="2">
            				</div>
            			</div>		
            		</div>		
            	</div>
            	<div class="module-main" style="height: 630px; overflow: auto">
                    <div class="table-top">
                        <table class="table table-striped table-bordered">
                            <thead>
                                <th><?php echo e(trans("lang.shijian")); ?></th>
                                <th><?php echo e(trans("lang.leixing")); ?></th>
                                <th><?php echo e(trans("lang.jine")); ?></th>
                                <th><?php echo e(trans("lang.yy")); ?></th>
                                <th><?php echo e(trans("lang.zhuangtai")); ?></th>
                            </thead>
                            <tbody>
                                 <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                         <td style="width:24%"><?php echo e($item->created_at); ?></td>   
                                        <td style="width:19%">
                                            <?php if($type==0): ?> <?php echo e(trans("lang.ckjl")); ?><?php endif; ?>
                                            <?php if($type==1): ?> <?php echo e(trans("lang.tkjl")); ?><?php endif; ?>
                                            <?php if($type==2): ?> <?php echo e(trans("lang.edzh")); ?><?php endif; ?>
                                            <?php if($type==4): ?> <?php echo e(trans("lang.hljl")); ?><?php endif; ?>
                                        </td>  
                                        <td style="width:19%"><?php echo e($item->money); ?></td>  
                                        <td style="width:20%"><?php echo e($item->fail_reason); ?></td>
                                        <td style="width:19%">
                                            <?php if($type==2 || $type==4): ?>
                                                 <strong style="color:green;"><?php echo e(trans("lang.chenggong")); ?></strong>
                                            <?php else: ?>
                                             <?php if($type==0): ?>
