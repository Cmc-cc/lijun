    ...
    <section class="content">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form class="form-horizontal" id="form" action="<?php echo e(route('about.store')); ?>" method="post">
                    <div class="box-body">
                            ...
                            <div class="col-sm-7">
                                <select name="type" id="type" class="form-control">
                                    ...
                                    <?php $__currentLoopData = config('platform.about_type'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($k); ?>" <?php if($k == 1): ?> selected <?php endif; ?>><?php echo e($v); ?></option>
                        ...
                        <div class="form-group">
                            <label for="quota" class="col-sm-2 control-label">内容</label>
                            <div class="col-sm-7">
                                <script id="editor2" name="en_content" type="text/plain" style="height:300px;"></script>
                            </div>
                        </div>
