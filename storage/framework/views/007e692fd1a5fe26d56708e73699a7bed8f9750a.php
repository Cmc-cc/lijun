...
<section id="xin_tixian_alert">
        <section class="xin_zhifu_alert" style="height: 86%;">
            <h4><?php echo e(trans("lang.tixian")); ?></h4>
            <section class="xin_zhifu_alert_content">
                <section class="xin_type_1" style="padding-top: 0;">
                    ...
                    <article class="xin_jine" style="margin-top: 0.5rem;position: relative; ">
                        <input type="number" name="money" id="money" autocomplete="off" placeholder="<?php echo e(trans("lang.tkje")); ?>" class="jine" style="width: 86%;text-align: center;">
                    ...
                    <article class="xin_jine" style="margin-top: 0.5rem;">
                        <input type="password" style="width: 86%;" name="qk_pwd" id="qk_pwd" autocomplete="off" placeholder="<?php echo e(trans("lang.tkmm")); ?>" class="jine">
                    </article>
                    <article class="xin_jine" style="margin-top: 0.5rem;">
                        <input type="text" disabled style="width: 86%;"  autocomplete="off" class="jine" value="<?php echo e(trans("lang.shengyumaliang")); ?>: <?php echo e($member->ml_money); ?>">
                    </article>
                    <article class="xin_jine" style="margin-top: 0.5rem;">
                        <input type="text" disabled style="width: 86%;"  autocomplete="off" class="jine" value="<?php echo e(trans("lang.yue")); ?>: <?php echo e($member->money); ?>">
                    </article>
	...
	<section id="xin_zhifu_alert">
		<section class="xin_zhifu_alert">
			<h4><?php echo e(trans("lang.chongzhi")); ?></h4>
			<section class="xin_zhifu_alert_content">
				<article class="xin_zhifu_nav">
					<?php if(!$setting->is_qq_on): ?>
					<article class="dopay on" onclick="qiehuan(1,this,'<?php echo e(trans('lang.zhuanhuankuai')); ?>')"><img src="/new/css/fps.png" alt="" style="width: 70%;"></article>
					<?php endif; ?>

					<?php if(!$setting->is_bankpay_on): ?>
					<article class="dopay" onclick="qiehuan(4,this,'<?php echo e(trans('lang.yinhangka')); ?>')"><img src="/new/css/add2_i911.png" alt="" style="width: 76%;"></article>
					<?php endif; ?>

					<?php if(!$setting->is_alipay_on): ?>
					<article class="dopay" onclick="qiehuan(2,this,'<?php echo e(trans('lang.bldzz')); ?>')"><img src="/new/css/bld.png" alt=""></article>
					<?php endif; ?>

					<?php if(!$setting->is_wechat_on): ?>
					<article class="dopay" onclick="qiehuan(3,this,'<?php echo e(trans('lang.xnbzf')); ?>')"><img src="/new/css/xnb.png" alt=""></article>
					<?php endif; ?>
				...
				<article class="xin_jine">
					<input type="number" placeholder="<?php echo e(trans("lang.srje")); ?>" id="amount" class="jine" oninput ="jine_input()">
					...
					<section class="type_1_list">
						...
						<section id="zhihu1">
							<article>
								...
								<p><?php echo e($_system_config->qq_account); ?></p>
								<i class="btn-copy" data-clipboard-text="<?php echo e($_system_config->qq_account); ?>"><?php echo e(trans("lang.fuzhi")); ?></i>
							</article>
							<article>
								<span><?php echo e(trans("lang.skzhm")); ?>：</span>
								<p><?php echo e($_system_config->qq_nickname); ?></p>
								<i class="btn-copy" data-clipboard-text="<?php echo e($_system_config->qq_nickname); ?>"><?php echo e(trans("lang.fuzhi")); ?></i>
							</article>
						</section>
						<?php endif; ?>
						...
						<section id="zhihu2" style="display: none;">
							<article>
								...
								<img src="<?php echo e($setting->bld_pic); ?>" alt="">
							</article>
						</section>
						<?php endif; ?>
...
// 		}
		...
		function reset(){
			qiehuan(1,$('.xin_zhifu_nav article:eq(0)'),'<?php echo e(trans('lang.zhuanhuankuai')); ?>');
			$('#amount').val('');
			$('#xin_type1_jine').text('$0.00')
