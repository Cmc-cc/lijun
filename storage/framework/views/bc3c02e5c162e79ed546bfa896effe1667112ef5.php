...
link.href = "<?php echo e($_system_config->ico); ?>";  //icon图标
        ...
        <div class="header-main clear">
            <div class="menu">
                <ul class="menu-list-box">
                    <a href="/" class="logo" style="background: url(<?php echo e($_system_config->site_logo); ?>) no-repeat;background-size: 100% 100%;"></a>
                    <li id="btn-menu-casino"><a href="/liveCasino" oncontextmenu="return false;">
                        ...
                        <ul class="menu-sub-list">
                         <!--   <li groupid="114" class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=OB&game_type=1&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="OB">
                            ...
                            <li groupid="114" class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=P3_HK&game_type=1&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="P3_HK">
                                <a groupid="114" gamename="EVO" gametype=""  oncontextmenu="return false;">
                                    <div class="icon c-9"></div>
                                    <span class="">EVO真人</span></a>
                            </li>
                            <li groupid="70" class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=DG_HK&game_type=1&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="DG_HK">
                                <a groupid="70" class="openGame" gamename="DG_HK" gametype="1"  oncontextmenu="return false;">
                                    <div class="icon c-8"></div>
                                    <span >DG真人</span></a>
                            </li>
 
                            <li groupid="105" class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=WC_HK&game_type=1&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="WC_HK">
                                <a groupid="105" class="openGame" gamename="WMHILL" gametype="7" oncontextmenu="return false;">
                                    <div class="icon c-1"></div>
                                    <span>WM真人</span></a>
                            </li>
                                    
                            <li groupid="113" class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=S2_HK&game_type=1&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="S2_HK">
                            ...
                            <li groupid="4" class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=GB_HK&game_type=1&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="GB_HK">
                    ...
                    <li id="chess"><a href="/poker" oncontextmenu="return false;">
                        ...
                        <ul class="menu-sub-list">
                          ...
                          <!--  <li groupid="132" class="toplay" <?php if($_member): ?> data-url="api/gamelist?api_code=BL&game_type=6&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="BL">
                            ...
                            <li groupid="60" class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=KY_HK&game_type=6&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="KY">
                    ...
                    <li id="slotgame"><a href="/eGame" oncontextmenu="return false;">
                        ...
                        <ul class="menu-sub-list">
                            ...
                            <li groupid="43" class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=JD_HK&game_type=3&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="JD_HK">
                                <a groupid="43"  oncontextmenu="return false;">
                                    <div class="icon g-6"></div>
                                    <span class="text_88"></span></a>
                            </li>
                            <li groupid="54" class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=CQ_HK&game_type=3&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="CQ_HK">
                                <a groupid="54"  oncontextmenu="return false;">
                                    <div class="icon g-12"></div>
                                    <span class="text_96"></span>
                                </a>
                            </li>
                            <li groupid="4" class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=GB_HK&game_type=SL&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="GB_HK">
                            ...
                            <li groupid="37"  class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=PN_HK&game_type=3&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="PN_HK">
                            ...
                            <li groupid="53" class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=PR_HK&game_type=3&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="PR_HK ">
                    ...
                    <li><a href="/esports" oncontextmenu="return false;">
                            ...
                            <span>Sport</span></a>
                        <ul class="menu-sub-list">
                            <li groupid="45" class="toplay"   data-code="CM_HK">
                                <a groupid="45" class="openGame" gamename="CM_HK" gametype="0">
                                    <div class="icon g-9"></div>
                                    <span class="text_85"></span>
                                </a>
                            </li>
                            <li groupid="25" class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=SO_HK&game_type=5&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="SO_HK">
                            ...
                            <!--    </a>-->
                            <!--</li>        -->
                         <li groupid="105" class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=ST_HK&game_type=7&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="ST_HK">
...
<script>
    ...
    $('body').on('click','.toplay',function(){
        var url = $(this).data('url');
            ...
            if(code=='OB'){
                alert('遊戲維護中 請儘快等遊戲結算後將資金回收！',1);return;
            }
