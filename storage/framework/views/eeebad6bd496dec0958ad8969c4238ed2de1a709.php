                            ...
                            <form class="form-horizontal" id="form" action="<?php echo e(route('system_config.update', ['id' => 1])); ?>" method="post">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <div id="files_ico" class="files">
                                                <?php if($data->ico): ?>
                                                    <div class="pull-left" style="position:relative;margin: 10px;">
                                                        <a href="<?php echo e($data->ico); ?>" target="_blank"><img src="<?php echo e($data->ico); ?>" alt="" style="width: 100px;"></a>
                                                        <a href="javascript:;" class="glyphicon glyphicon-remove" style="position: absolute;right: 0;top: 0;" onclick="removeDiv(this)"></a>
                                                        <input type="hidden" name="ico" value="<?php echo e($data->ico); ?>">
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-7">
                                            <div id="files_mp3" class="files">
                                                <?php if($data->mp3): ?>
                                                        ...
                                                        <font color="red"><?php echo e($data->mp3); ?></font>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" id="whatsapp" name="whatsapp" value="<?php echo e($data->whatsapp); ?>"  />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="site_name" class="col-sm-2 control-label">whatsapp链接</label>
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" id="whatsapp_url" name="whatsapp_url" value="<?php echo e($data->whatsapp_url); ?>"  />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <label><input type="radio" name="is_zhuanpan"  value="0" <?php if($data->is_zhuanpan == 0): ?>checked <?php endif; ?> />开放</label>
                                            <label><input type="radio" name="is_zhuanpan"  value="1" <?php if($data->is_zhuanpan == 1): ?>checked <?php endif; ?> />关闭</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                            ...
                                            <div id="files9" class="files">
                                                <?php if($data->alert_img): ?>
                                                    <?php 
                                                     ...
                                                     ?>
                                                    <?php $__currentLoopData = $alert_img; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="pull-left" style="position:relative;margin: 10px;">
                                                            <a href="<?php echo e($item); ?>" target="_blank"><img src="<?php echo e($item); ?>" alt="" style="width: 100px;"></a>
                                                            <a href="javascript:;" class="glyphicon glyphicon-remove" style="position: absolute;right: 0;top: 0;" onclick="removeDiv(this)"></a>
                                                            <input type="hidden" name="alert_img[]" value="<?php echo e($item); ?>">
                                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <label><input type="radio" name="sms_message"  value="1" <?php if($data->sms_message == 1): ?>checked <?php endif; ?> />开启</label>
                                            <label><input type="radio" name="sms_message"  value="0" <?php if($data->sms_message == 0): ?>checked <?php endif; ?> />关闭</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="app_link" class="col-sm-2 control-label">APP链接</label>
                                        <div class="col-sm-2">
                                            <label><input type="radio" name="is_app_link_on"  value="0" <?php if($data->is_app_link_on == 0): ?>checked <?php endif; ?> />开启</label>
                                            <label><input type="radio" name="is_app_link_on"  value="1" <?php if($data->is_app_link_on == 1): ?>checked <?php endif; ?> />关闭</label>
                            ...
                            <form class="form-horizontal" id="form" action="<?php echo e(route('system_config.update', ['id' => 1])); ?>" method="post">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="number" class="form-control" id="daili_report" name="daili_report"  value="<?php echo e($data->daili_report); ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                            ...
                            <form class="form-horizontal" id="form" action="<?php echo e(route('system_config.update', ['id' => 1])); ?>" method="post">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" id="usdt_lv" name="usdt_lv"  value="<?php echo e($data->usdt_lv); ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="qq_account" class="col-sm-2 control-label">TRC地址</label>
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" id="trc_address" name="trc_address"  value="<?php echo e($data->trc_address); ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <div id="files_trc" class="files">
                                                <?php if($data->trc_pic): ?>
                                                    <div class="pull-left" style="position:relative;margin: 10px;">
                                                        <a href="<?php echo e($data->trc_pic); ?>" target="_blank"><img src="<?php echo e($data->trc_pic); ?>" alt="" style="width: 100px;"></a>
                                                        <a href="javascript:;" class="glyphicon glyphicon-remove" style="position: absolute;right: 0;top: 0;" onclick="removeDiv(this)"></a>
                                                        <input type="hidden" name="trc_pic" value="<?php echo e($data->trc_pic); ?>">
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label for="usdt_trc" class="col-sm-2 control-label"> USDT TRC20 地址</label>
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" id="usdt_trc" name="usdt_trc"  value="<?php echo e($data->usdt_trc); ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="subtitle" class="col-sm-2 control-label"> USDT TRC20 二维码</label>
                                        <div class="col-sm-7">
                                            <input id="fileupload_usdt_trc_pic" type="file" name="file" multiple>
                                            <div id="progress_usdt_trc_pic" class="progress">
                                                <div class="progress-bar progress-bar-success"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="subtitle" class="col-sm-2 control-label"></label>
                                        <div class="col-sm-7">
                                            <div id="files_usdt_trc_pic" class="files">
                                                <?php if($data->usdt_trc_pic): ?>
                                                    <div class="pull-left" style="position:relative;margin: 10px;">
                                                        <a href="<?php echo e($data->usdt_trc_pic); ?>" target="_blank"><img src="<?php echo e($data->usdt_trc_pic); ?>" alt="" style="width: 100px;"></a>
                                                        <a href="javascript:;" class="glyphicon glyphicon-remove" style="position: absolute;right: 0;top: 0;" onclick="removeDiv(this)"></a>
                                                        <input type="hidden" name="usdt_trc_pic" value="<?php echo e($data->usdt_trc_pic); ?>">
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label for="usdt_erc" class="col-sm-2 control-label"> USDT ERC20 地址</label>
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" id="usdt_erc" name="usdt_erc"  value="<?php echo e($data->usdt_erc); ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="subtitle" class="col-sm-2 control-label"> USDT ERC20 二维码</label>
                                        <div class="col-sm-7">
                                            <input id="fileupload_usdt_erc_pic" type="file" name="file" multiple>
                                            <div id="progress_usdt_erc_pic" class="progress">
                                                <div class="progress-bar progress-bar-success"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="subtitle" class="col-sm-2 control-label"></label>
                                        <div class="col-sm-7">
                                            <div id="files_usdt_erc_pic" class="files">
                                                <?php if($data->usdt_erc_pic): ?>
                                                    <div class="pull-left" style="position:relative;margin: 10px;">
                                                        <a href="<?php echo e($data->usdt_erc_pic); ?>" target="_blank"><img src="<?php echo e($data->usdt_erc_pic); ?>" alt="" style="width: 100px;"></a>
                                                        <a href="javascript:;" class="glyphicon glyphicon-remove" style="position: absolute;right: 0;top: 0;" onclick="removeDiv(this)"></a>
                                                        <input type="hidden" name="usdt_erc_pic" value="<?php echo e($data->usdt_erc_pic); ?>">
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <textarea class="form-control" id="kefu_html" name="kefu_html" style="height:80px;"><?php echo e($data->kefu_html); ?></textarea>
                                        </div>
                                    </div>
                            ...
                            <form class="form-horizontal" id="form" action="<?php echo e(route('system_config.update', ['id' => 1])); ?>" method="post">
                                ...
                                <div class="box-body">
                                   <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" id="leyu_domain" name="leyu_domain" value="<?php echo e($data->leyu_domain); ?>"  />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="third_version" class="col-sm-2 control-label">港币</label>
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" id="leyu_pre_1" name="leyu_pre_1" value="<?php echo e($data->leyu_pre_1); ?>"  />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="third_userkey" class="col-sm-2 control-label">ApiKey</label>
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" id="leyu_api_key" name="leyu_api_key" value="<?php echo e($data->leyu_api_key); ?>"  />
                                        </div>
                                    </div>
                                       <div class="form-group">
                                        <label for="third_version" class="col-sm-2 control-label">人民币</label>
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" id="leyu_pre_2" name="leyu_pre_2" value="<?php echo e($data->leyu_pre_2); ?>"  />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="third_userkey" class="col-sm-2 control-label">ApiKey2</label>
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" id="leyu_api_key2" name="leyu_api_key2" value="<?php echo e($data->leyu_api_key2); ?>"  />
                                        </div>
                                    </div>
                                </div><!-- /.box-body -->
                                <div class="box-footer">
...
//                    });
            ...
            $('#fileupload_trc').fileupload({
                ...
                .parent().addClass($.support.fileInput ? undefined : 'disabled');
                 ...
                 // USDT TRC20 
            $('#fileupload_usdt_trc_pic').fileupload({
                url: url,
                dataType: 'json',
                done: function (e, data) {
                    ...
                    var html = '<div class="pull-left" style="position:relative;margin: 10px;">' +
                        ...
                        '</a>' +
                        '<a href="javascript:;" class="glyphicon glyphicon-remove" style="position: absolute;right: 0;top: 0;" onclick="removeDiv(this)"></a>'+
                        '<input type="hidden" name="usdt_trc_pic" value="'+img_path+'">' +
                        '</div>';
                    $('#files_usdt_trc_pic').append(html)
                },
                progressall: function (e, data) {
                    var progress = parseInt(data.loaded / data.total * 100, 10);
                    $('#progress_usdt_trc_pic .progress-bar').css(
                        'width',
                        progress + '%'
                    );
                }
                ...
                $('#fileupload_usdt_erc_pic').fileupload({
                url: url,
                dataType: 'json',
                done: function (e, data) {
                    ...
                    var html = '<div class="pull-left" style="position:relative;margin: 10px;">' +
                        ...
                        '</a>' +
                        '<a href="javascript:;" class="glyphicon glyphicon-remove" style="position: absolute;right: 0;top: 0;" onclick="removeDiv(this)"></a>'+
                        '<input type="hidden" name="usdt_erc_pic" value="'+img_path+'">' +
                        '</div>';
                    $('#files_usdt_erc_pic').append(html)
                },
                progressall: function (e, data) {
                    var progress = parseInt(data.loaded / data.total * 100, 10);
                    $('#progress_usdt_erc_pic .progress-bar').css(
                        'width',
                        progress + '%'
                    );
                }
