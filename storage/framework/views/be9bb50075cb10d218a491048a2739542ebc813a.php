                    ...
                    <div class="list-head-container" style="width: 920px; height: 31px;">
                        <div class="list-head" style="width: 920px;">
                            <div class="col-xs-12" style="padding:0;">
                                <div class="col-xs-6">我的厅室</div>
                                <div class="col-xs-6">余额</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xs-12 exchange" style="padding:0">
                        <table class="table table-striped table-bordered">
                            ...
                            <?php $__currentLoopData = $api_mod; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($item->api_name=='AGS'): ?><?php continue; ?>;
                                <?php endif; ?>
                                <?php
                                $mod = '';
                                ...
                                <tr>
                                    <td class="col-xs-6"><?php echo e($item->api_title); ?>厅</td>
                                    <td class="col-xs-6 exchange-money"><span class="newpos"> <?php if($mod): ?> <?php echo e($mod->money); ?>元  <?php else: ?> N/A <?php endif; ?></span><a
                                                href="javascript:;" class="refresh"
                                                data-uri="<?php echo e(route('member.api.check')); ?>?api_name=<?php echo e($item->api_name); ?>"></a></td>
