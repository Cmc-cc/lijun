...
<div style="width:100%;margin-bottom:5px;background: linear-gradient(90deg,#e8e8e8,#cccbca);overflow: hidden;">
	...
	<?php if(!$setting->is_bankpay_on): ?>
		<a href="new_bank_pay" class="switchroute"><div class="zfu bgc"><span style="color:#f5f5f5"><?php echo e(trans('lang.yinhanghuikuan')); ?></span></div></a>
	<?php endif; ?>
	...
	<?php if(!$setting->is_wechat_on): ?>
		<a href="usdt_pay_xin" class="switchroute"><div class="zfu"><span class="zfu1"><?php echo e(trans('lang.xnbzf')); ?></span></div></a>
	<?php endif; ?>
	...
	<div class="module-main" style="margin-top:26px;">
		<form action="https://www.emixbet.com/member/new_bank_pay" method="post" class="form-horizontal">
			...
			<div class="form-group" style="margin-bottom:10px">
				...
				<div style="float:left;" class="col-xs-6">
					<input type="number" class="form-control" name="amount" id="amount" onblur="jine_input()" placeholder="<?php echo e(trans("lang.qingshuru")); ?><?php echo e(trans("lang.huikuanjine")); ?>">
				</div>
				<div class="col-xs-3 info">
					&nbsp;&nbsp;<?php echo e(trans("lang.qingshuru")); ?><?php echo e(trans("lang.huikuanjine")); ?><span class="STYLE12">*</span>
				</div>
			</div>

			<div class="form-group" style="margin-bottom:10px">
				<div class="col-xs-3 control-label"><?php echo e(trans('lang.hkyh')); ?>：</div>
				<div style="float:left" class="col-xs-6">
					<select class="form-control" id="banksss" onchange="setBank(this.value);">
						...
						<option value='<?php echo e($item->bank_id); ?>' data-cardno="<?php echo e($item->card_no); ?>" data-username="<?php echo e($item->username); ?>"><?php echo e($item->bank_name); ?></option>
					    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					</select>
				</div>
				<div class="col-xs-3 info">
					&nbsp;&nbsp;<?php echo e(trans('lang.qxzckyh')); ?><span class="STYLE12">*</span>
				</div>
			</div>	
			<div class="form-group" style="margin-bottom:10px">
				<div class="col-xs-3 control-label"><?php echo e(trans('lang.skzh')); ?>：</div>
				<div style="float:left;" class="col-xs-6">
					<input type="text" class="form-control" id="bank_card" name="name" value="<?php echo e(count($banks)>0 ? $banks[0]->card_no : ''); ?>" readonly="">
				</div>
				<div class="col-xs-3 info">
					&nbsp;&nbsp; <?php echo e(trans('lang.skzh')); ?><span class="STYLE12">*</span>
				</div>
			</div>
			
			<div class="form-group" style="margin-bottom:10px">
				<div class="col-xs-3 control-label"><?php echo e(trans('lang.skzhm')); ?>：</div>
				<div style="float:left;" class="col-xs-6">
					<input type="text" class="form-control" id="bank_name" name="name" value="<?php echo e(count($banks)>0 ? $banks[0]->username : ''); ?>" readonly="">
				</div>
				<div class="col-xs-3 info">
					&nbsp;&nbsp; <?php echo e(trans('lang.skzhm')); ?><span class="STYLE12">*</span>
				</div>
			</div>

		<!--	<div class="form-group" style="margin-bottom:16px;">
				<div class="col-xs-3 control-label"><?php echo e(trans("lang.cksj")); ?>：</div>
				<div style="float:left;" class="col-xs-6">
						<input type="text" name="paytime" class="form-control" value="2022-08-16 21:36:37" readonly="">
				</div>
				<div class="col-xs-3 info">
					&nbsp;&nbsp;<?php echo e(trans("lang.zdhq")); ?><?php echo e(trans("lang.cksj")); ?><span class="STYLE12">*</span>
				</div>
			</div>

			<div class="form-group">
			    <div class="col-xs-3 control-label"><?php echo e(trans("lang.skyh")); ?>：</div>
				<div class="col-xs-6">
											...
											<tbody><tr>
												<td style="height:46px">
													<div style="float:left;font-size:14px;float:left;padding:0 10px;line-height: 27px;display:flex; color:#000;">
														...
														<?php echo e(trans("lang.zhuanhuankuai")); ?>
			...
			<script type="text/javascript">
	            ...
	            var account = "<?php echo e(trans('lang.yinhanghuikuan')); ?>";
			...
			<div class="form-group">
				...
				<div class="col-xs-6">
					<button onclick="chongzhi()" type="button" class="ajax-submit-without-confirm-btn switchroute" style="width: 100%;height: 46px;font-size: 16px;color:#fff;font-weight: 800;border: 0px solid #EB5D4D;background:linear-gradient(90deg,#d2b496,#e6ceb6);margin-top:10px;border-radius: 4px;"><?php echo e(trans("lang.qrcz")); ?></button>
				</div>
			</div>
