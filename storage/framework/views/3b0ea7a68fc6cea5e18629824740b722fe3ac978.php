                               ...
                               <!--     <div class="CQ9-fish-bg" id="CQ9-fish-bg" groupid="65"
                                    ...
                                    <div class="jdb-fish-bg" id="jdb-fish-bg" groupid="56"
                                        ...
                                        <div class="fishTbar fishTbar_jdb">
                                            <a groupid="56" class="btn-fish btn-bet toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=JD_HK&game_type=2&game_code=7_7001&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="JD_HK" oncontextmenu="return false;" oncontextmenu="return false;">
                                                <div class="text_958"></div>
                                            </a>
                                            <a groupid="56" class="btn-fish1 btn-bet toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=JD_HK&game_type=2&game_code=7_7002&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="JD_HK" oncontextmenu="return false;">
                                                <div class="text_959"></div>
                                            </a>
                                            <a groupid="56" class="btn-fish2 btn-bet toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=JD_HK&game_type=2&game_code=7_7003&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="JD_HK" oncontextmenu="return false;">
                                                <div class="text_960"></div>
                                            </a>
                                            <a groupid="56" class="btn-fish3 btn-bet toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=JD_HK&game_type=2&game_code=7_7004&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="JD_HK" oncontextmenu="return false;">
