...
.noticeAltbox-bottom{ display:flex; justify-content:center; flex-wrap:wrap; padding:.5rem 0;}
   ...
   <!--         </div> -->
    ...
    /*.gamelist-content .gamelist-type .gamelist-col:nth-child(2n){margin-left:0%;margin-right:2%;}*/
           ...
           <!--                         </div>-->
    							<!--</div>-->
    							<!--<div class="game-btn gamelist-row toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=LG&game_type=CB&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="LG">-->
    							<!--    <span>樂游棋牌</span>-->
    						 <!--       <i><?php echo e(trans("lang.kqyx")); ?></i>-->
          ...
          <!--                          </div>-->
    						...
    						<div class="gamelist-type" gamelisttype="fish" style="padding-bottom:0;">
    							...
    							<div class="game-btn gamelist-row toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=JK&game_type=FH&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="JK">
    							    <span>JOKER捕魚</span>
    						        <i><?php echo e(trans("lang.kqyx")); ?></i>
    							...
    							<div class="game-btn gamelist-row toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=GB&game_type=FH&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="GB">
    							<!--<div class="game-btn gamelist-row" onclick="alert('维护中')">-->
    							    <span>BBIN捕魚</span>
    						        <i><?php echo e(trans("lang.kqyx")); ?></i>
