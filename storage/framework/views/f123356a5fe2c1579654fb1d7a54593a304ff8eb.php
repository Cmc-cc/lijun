    ...
    <div class="container">
        <div class="footer-img-box">
            <a href="" class="pullLeft bbin">
                <img src="<?php echo e(asset('/web/images/bbinlogo.png')); ?>" alt=""><img src="/web/images/joker.png">
            </a>
            <a href="" class="pullLeft ub">
                <img src="<?php echo e(asset('/web/images/ublogo.png')); ?>" alt="">
            </a>
        </div>
        ...
        <div class="copyright-info-box">
            Copyright © <?php echo e($_system_config->site_title); ?> Reserved
        </div>
    </div>
</div>
