	...
	<div class="drawInfor">
		...
		<div class="bq2-wrapper" style="display:none;">
        	...
        	<div class="bot-container">
        		...
        		<p class="row banker">
        			<span class="asain"><?php echo e(trans("lang.skzhm")); ?>：</span>
...
function addrecharge() {
    ...
    $.ajax({
						...
						data : {amount:$('#money').val(),xiaoshu:xiaoshu,paytype:'bank',usdt_type:'trc',banksss:bank_id},
...
// 			})
    ...
    // $('.banks').eq(0).addClass('on');
		$('.banks').click(function(){
			...
			$('.chatNumber4').text($(this).data('username'));
