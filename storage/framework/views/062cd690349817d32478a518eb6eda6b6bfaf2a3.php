                            ...
                            <div class="trans-money-header clear" id="balance">
                                <div class="t-h-box" data-num="11">
                                    ...
                                    <div class="t-h-info last">
                                        <h1>主钱包</h1>
                                        <h6 class="lockmoney" gamename="LockMoney" id="gamemoneytotal">0</h6>
                                    </div>
                                </div>
                                ...
                                <div class="t-h-box" data-num="10">
                                    ...
                                    <div class="t-h-info ">
                                        ...
                                        <h6 class="gameMoney gamemoney_text" gamename="Center"><?php echo e($member->money); ?></h6>
                                    </div>
                                </div>
                                    ...
                                    <div class="t-h-box" data-num="2">
                                        ...
                                        <?php if($mod): ?>
                                            <div class="t-h-info"><h1><?php echo e($item->api_title); ?></h1>
                                                <h6 class="gameMoney gamecode"  gamename="<?php echo e($item->api_name); ?>"  data-code="<?php echo e($item->api_name); ?>"><?php echo e($mod->money); ?></h6>
                                            </div>
                                        <?php else: ?>
...
<script>
    ...
    var gamemoneytotal = $('.gamemoney_text').text();
    var lengt = $('.gamecode').length;
    $('.gamecode').each(function(k,v){
        gamemoneytotal = Number(gamemoneytotal)+Number($(this).text());
        
        if(k == lengt - 1){
            $('#gamemoneytotal').text(gamemoneytotal)
        }
    })
