                            ...
                            <div class="game-content" id="game-list">
                                <div class="ag-fish game-2" style="width: 1000px; display: block;margin:0;">
                                    <div style="width: 960px;text-align: initial;float: left; ">
                                        <div class="fishTbar">
                                            <a groupid="56" class="btn-fish btn-bet toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=JDB&game_type=3&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="JDB" oncontextmenu="return false;" oncontextmenu="return false;" style="background:url(/new0404/pc/images/g-j6.png) 55px 70px no-repeat;">
                                                <div>JDB电子</div>
                                            </a>
                                            <a groupid="56" class="btn-fish btn-bet toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=CQ9&game_type=3&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="CQ9" oncontextmenu="return false;" oncontextmenu="return false;" style="background:url(/new0404/pc/images/g-j12.png) 55px 70px no-repeat;">
                                                <div>CQ9电子</div>
                                            </a>
                                            ...
                                            <a groupid="56" class="btn-fish btn-bet toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=PNG&game_type=3&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="PNG" oncontextmenu="return false;" oncontextmenu="return false;" style="background:url(/new0404/pc/images/g-j14.png) 55px 70px no-repeat;">
                                                <div>PNG电子</div>
                                            </a>
