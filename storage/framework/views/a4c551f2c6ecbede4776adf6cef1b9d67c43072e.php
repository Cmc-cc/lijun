...
<div class="m_container">
	...
	<div style="position: fixed;top:.9rem;width: 100%;height:.68rem;background: #3a3a3a;">
		...
		<a href="/m/game_record"><div class="acse as"><?php echo e(trans("lang.touzhu")); ?></div></a>
	...
	<div class="select-info">
        ...
        <div class="select-time" style="width:72%;margin-left: 0px;">
			<div style="width:100%;overflow: hidden;">
                <p  style="width: 16%" tid="1" <?php if($day==1): ?>class="on"<?php endif; ?> onclick="location.href='/m/game_record?day=1'"><?php echo e(trans("lang.jinri")); ?></p>
                <p style="width: 15.5%" tid="2" <?php if($day==2): ?>class="on"<?php endif; ?> onclick="location.href='/m/game_record?day=2'">2<?php echo e(trans("lang.day")); ?></p>
				<p style="width: 15.5%" tid="3" <?php if($day==3): ?>class="on"<?php endif; ?> onclick="location.href='/m/game_record?day=3'">3<?php echo e(trans("lang.day")); ?></p>
				<p style="width: 15.5%" tid="5" <?php if($day==5): ?>class="on"<?php endif; ?> onclick="location.href='/m/game_record?day=5'">5<?php echo e(trans("lang.day")); ?></p>
                <p style="width: 18%" tid="7" <?php if($day==7): ?>class="on"<?php endif; ?> onclick="location.href='/m/game_record?day=7'">7<?php echo e(trans("lang.day")); ?></p>
                <p style="width: 19.5%" tid="30" <?php if($day==30): ?>class="on"<?php endif; ?> onclick="location.href='/m/game_record?day=30'">30<?php echo e(trans("lang.day")); ?></p>
            </div>
        </div>
    </div>
				...
				<div class="info-list">
    			    ...
    			    <table class="Hyzx-table mt10 MMain" style="line-height: 1.5;">
                        ...
                        <tr>
                            ...
                            <th style="width:25%"><?php echo e(trans("lang.wanfa")); ?></th>
                            <th style="width:25%"><?php echo e(trans("lang.touzhu")); ?></th>
                            <th style="width:25%"><?php echo e(trans("lang.zjj")); ?></th>
                            <th style="width:25%"><?php echo e(trans("lang.shijian")); ?></th>
                        </tr>
                        </thead>
                        <tbody id="general-msg">
                                ...
                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="haveRead MColor1" style="display: table-row;">
                                        ...
                                        ?>
                                        <td style="text-align:center;"><?php echo e($plat_type); ?></td>
                                        ...
                                        <td style="text-align:center;"><?php echo e($item->betTime); ?></td>
                                    </tr>                
