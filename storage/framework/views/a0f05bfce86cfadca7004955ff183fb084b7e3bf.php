            ...
            <li class="bankChose">
				...
				<div class="bankBox">
				    <?php $__currentLoopData = $banks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    					<b class="banks" data-cardno="<?php echo e($item->card_no); ?>" data-username="<?php echo e($item->username); ?>" data-id="<?php echo e($item->id); ?>" data-bank_name="<?php echo e($item->bank_name); ?>">
...
var bank_id = 0;
var xiaoshu = "<?php echo e($xiaoshu); ?>";
function step(){
    if(!$('#money').val()){
        alert("<?php echo e(trans('lang.qsr')); ?><?php echo e(trans('lang.czje')); ?>");
        return false;
    }
    if($('#money').val() < Number(<?php echo e($setting->recharge_min); ?>)){
        alert("<?php echo e(trans('lang.jebxdy')); ?><?php echo e($setting->recharge_min); ?>");
        return false;
    }
    if($('#money').val() > Number(<?php echo e($setting->recharge_max); ?>)){
