      ...
      <section id="lobby">
        <div class="ng-scope">
          ...
          <div class="content game-list clearfix">
            <div class="lists">
              <?php $__currentLoopData = $gamelist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <li class="ng-scope" <?php if($_member): ?> onclick="location.href='<?php echo e(route('game.playGame')); ?>?plat_type=<?php echo e($item['code']); ?>&game_type=<?php echo e($item['gameType']); ?>&game_code=<?php echo e($item['gameCode']); ?>&devices=<?php echo e($devices); ?>'"<?php else: ?> onclick="return layer.msg('请先登录!',{icon:0})" <?php endif; ?>>
                <img class="icon icon01" src="/newpage/NewGame.gif">
                <img class="icon icon02" src="/newpage/IsHot.gif">
                <div class="pic">
                  <img src="https://nbgame.s3.ap-southeast-1.amazonaws.com/<?php echo e($item['gameCode']); ?>.png">
                </div>
