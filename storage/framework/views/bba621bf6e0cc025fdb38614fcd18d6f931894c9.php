    ...
    <form action="" method="get" id="searchForm">
        <div class="row">
            ...
            <div class="col-lg-3 pull-right">
                <div class="input-group">
					<a href="javascript:void(0)" class="btn btn-danger" id="delAll" data-ids="" data-toggle="modal" data-target="#delete-modal" data-url="<?php echo e(route('activity_apply.delall')); ?>">删除选中</a>&nbsp;
