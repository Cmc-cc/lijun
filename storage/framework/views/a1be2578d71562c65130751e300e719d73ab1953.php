                        ...
                        <div role="tabpanel" class="tab-pane" id="profile">
                            <form class="form-horizontal" id="form" action="<?php echo e(route('system_config.update', ['id' => 1])); ?>" method="post">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="active_member_money" class="col-sm-2 control-label">正常充值码量比例设置</label>
                                        <div class="col-sm-7">
                                    ...
                                    <div class="form-group">
                                        <label for="cz_ration" class="col-sm-2 control-label">新用户首次充值赠送比例</label>
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control"  placeholder="只填写数字"  value="100" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="active_member_money" class="col-sm-2 control-label">新用户首次充值打码量比例设置</label>
                                        <div class="col-sm-7">
                                            <input type="number" class="form-control"   value="20" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="active_member_money" class="col-sm-2 control-label">每日首冲赠送比例</label>
                                        <div class="col-sm-7">
                                            <input type="number" class="form-control" id="sc_percent" name="sc_percent"  value="<?php echo e($data->sc_percent); ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="active_member_money" class="col-sm-2 control-label">每日首冲打码量比例设置</label>
                                        <div class="col-sm-7">
                                    ...
                                    <div class="form-group">
                                        <label for="cz_ration" class="col-sm-2 control-label">每日无限次充值赠送比例</label>
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" id="cz_ration" name="cz_ration" placeholder="只填写数字"  value="<?php echo e($data->cz_ration); ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="active_member_money" class="col-sm-2 control-label">每日无限次打码量比例设置</label>
                                        <div class="col-sm-7">
                                    ...
                                    <div class="form-group">
                                        <label for="active_member_money" class="col-sm-2 control-label">每日亏损回赠比例</label>
                                        <div class="col-sm-7">
