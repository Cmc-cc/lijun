            ...
            <div class="content" style="">
                <div class="sports-site">
                   ...
                   <!-- </div>-->
                    ...
                    <div class="sport-playbtnBBIN toplay asas" groupid="4" <?php if($_member): ?> data-url="/game/playGame?plat_type=ST_HK&game_type=5&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="ST_HK">
                        <a groupid="4" class="openGame" gamename="ST_HK" gametype="FT"  oncontextmenu="return false;"></a>
                    </div>
                 <div class="sport-playbtn toplay asas" groupid="91" <?php if($_member): ?> data-url="/game/playGame?plat_type=CM_HK&game_type=5&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="CM_HK" style="top: 35px;">
                         <a groupid="91" class="openGame" gamename="CM_HK" gametype="0"  oncontextmenu="return false;"></a> 
                    </div>
                    <div class="sport-playbtnCRSPORT toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=SO_HK&game_type=5&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="SO_HK" style="top: 35px;">
