			...
			<tbody><tr>
			   <td style="width:50%">
				  <div class="" style="padding:0 0 0 10px;font-size:16px;float:left;width:100%">
					<div style="width:50%;float:left;color:#000;"><?php echo e(trans("lang.zhye")); ?>  &nbsp;<b>:</b>&nbsp;<span style="font-size: 20px;color: #DF9917;">$</span>&nbsp;<span class="ch"></span><span class="ch" id="gamemoneyy" style="font-size: 20px;color:#DF9917;"><?php echo e($member->money); ?></span>
					</div>
					<div style="float:left;width:50%">
                    <a href="javascript:void(0);" class="abutton refresh11" id="transfer"><?php echo e(trans("lang.zijinhuishou")); ?></a>
                    </div>
                                     ...
                                     <div class="game1 onmouse api-info api-41">
            					        ...
            					        <p class="acd">
            					            <?php if($mod): ?>
                                             ...
                                             <span>  <?php echo e($mod->money); ?>  </span>
                                             <a href="javascript:void(0);" class="refresh1" data-uri="https://www.emixbet.com/api/check?api_name=<?php echo e($item->api_name); ?>" style="">
                                                 <img src="../../../web/css/images/bg-ico.png">
                                            </a>
                                              <?php else: ?>
                                                <span class="title"><?php echo e($item->api_title); ?></span>
                                                <span> <?php echo e(trans("lang.zzwh")); ?></span>
                                             <?php endif; ?>
