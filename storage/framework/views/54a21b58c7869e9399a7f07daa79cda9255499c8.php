	...
	<div class="drawInfor">
		<ul>
			...
			<?php if($setting->sms_message): ?>
			    ...
			    <!--</li>-->
			<?php endif; ?>
			<div style="padding-top:15px;font-size:20px;"><?php echo e(trans("lang.shengyujihe")); ?>:<?php echo e($member->ml_money); ?></div>
			<div style="padding-top:15px;font-size:20px;">
			    <?php echo e(trans("lang.yue")); ?>:<span id="gamemoney"><?php echo e($member->money); ?></span>
			    <input type="button" value="<?php echo e(trans('lang.zijinhuishou')); ?>" class="subBtn" style="margin:0;width:70px;float: right;line-height: 30px;font-size:12px;" id="transfer">
			</div>
		</ul>
...
<!-- 获取焦点加亮 -->
	...
	$('#transfer').click(function(){
	    var that = $(this);
	    that.val('<?php echo e(trans("lang.hsz")); ?>...');
	    $.ajax({
	        url:'/member/transfer_all',
	        type:'post',
	        success:function(res){
	            that.val('<?php echo e(trans("lang.zijinhuishou")); ?>');
	           // location.reload()
	           $.ajax({
