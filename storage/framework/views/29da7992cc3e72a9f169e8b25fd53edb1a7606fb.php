...
<div class="m_container">
	...
	<div class="nytop" style="position: fixed;top:0;width: 100%;">
		...
		<h1><?php echo e(trans("lang.xxhy")); ?></h1>
	</div>
	...
	<div style="position: fixed;top:.9rem;width: 100%;height:.68rem;background: #3a3a3a;">
		...
		<a href="/m/member_offline"><div class="acse as"><?php echo e(trans('lang.xxhy')); ?></div></a>
 ...
 <!--               <p  style="width: 16%" tid="1" <?php if($day==1): ?>class="on"<?php endif; ?> onclick="location.href='/m/member_offline?day=1'">今日</p>-->
 <!--               <p style="width: 15.5%" tid="2" <?php if($day==2): ?>class="on"<?php endif; ?> onclick="location.href='/m/member_offline?day=2'">2日</p>-->
	<!--			<p style="width: 15.5%" tid="3" <?php if($day==3): ?>class="on"<?php endif; ?> onclick="location.href='/m/member_offline?day=3'">3日</p>-->
	<!--			<p style="width: 15.5%" tid="5" <?php if($day==5): ?>class="on"<?php endif; ?> onclick="location.href='/m/member_offline?day=5'">5日</p>-->
 <!--               <p style="width: 18%" tid="7" <?php if($day==7): ?>class="on"<?php endif; ?> onclick="location.href='/m/member_offline?day=7'">7日内</p>-->
 <!--               <p style="width: 19.5%" tid="30" <?php if($day==30): ?>class="on"<?php endif; ?> onclick="location.href='/m/member_offline?day=30'">30日内</p>-->
 <!--           </div>-->
 <!--       </div>-->
 <!--   </div>-->
