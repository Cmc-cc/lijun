        ...
        <div class="live-container loading">
            ...
            <div class="live-game-btns-wrap2">
             <!--   <a groupid="35" class="game-btns og1 openGame toplay" gamename="OG" gametype="0" 
                ...
                <a groupid="114" class="game-btns EVO openGame toplay" gamename="P3_HK" gametype="" gameid="" <?php if($_member): ?> data-url="/game/playGame?plat_type=P3_HK&game_type=1&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="P3_HK"></a>
                <a groupid="70" class="game-btns DG openGame toplay" gamename="DG_HK" gametype="1" <?php if($_member): ?> data-url="/game/playGame?plat_type=DG_HK&game_type=&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="DG_HK"></a>
                   
                <a groupid="21" class="game-btns lixin openGame toplay" gamename="Lixinlive" <?php if($_member): ?> data-url="/game/playGame?plat_type=WC_HK&game_type=1&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="WC_HK"></a>
                <a groupid="113" class="game-btns SEXYLIVE openGame toplay" gamename="SEXYLIVE" gametype="LIVE"
                   gameid="SEXYBCRT" <?php if($_member): ?> data-url="/game/playGame?plat_type=S2_HK&game_type=1&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="S2_HK"></a>   
                
                   
                <a groupid="26" class="game-btns ebet openGame toplay" gamename="EBet" gametype="1" <?php if($_member): ?> data-url="/game/playGame?plat_type=GB_HK&game_type=1&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="GB_HK"></a>
