				...
				<div class="info-list" style="padding-bottom:10px;">
    			    ...
    			    <table class="Hyzx-table mt10 MMain" style="line-height: 1.5; width:100%;">
                        ...
                        <tr style="line-height:3;">
                            <th style="width:33%; text-align: center;"><?php echo e(trans("lang.wanfa")); ?></th>
                            <th style="width:33%; text-align: center;"><?php echo e(trans("lang.jine")); ?></th>
                            <th style="width:33%; text-align: center;"><?php echo e(trans("lang.zjj")); ?></th>
                        </tr>
                        </thead>
...
let type = 1;
				function qiehua(int,_this){
					...
					getUserList.get();
					$("#load").text('<?php echo e(trans("lang.shanglajiazaigengduo")); ?>');
											...
											for(let item of data2){
												...
												$('#list').append(`<div class="list">
														<div class="list-top" style="background:transparent;">
															...
															<div class="list-top2">
																<div><?php echo e(trans("lang.shuruzhanghu")); ?>: `+item.transfer_in_account+`</div>
																<div><?php echo e(trans("lang.shuchuzhanghu")); ?>：
