...
<div style="width:100%;margin-bottom:5px;background: linear-gradient(90deg,#e8e8e8,#cccbca);overflow: hidden;">
		...
		<a href="ali_pay_xin" class="switchroute"><div class="zfu bgc"><span class="zfu1" style="color:#f5f5f5"><?php echo e(trans('lang.zhuanhuankuai')); ?></span></div></a>
	<?php endif; ?>
...
<script type="text/javascript">
           var account = "<?php echo e(trans('lang.zhuanhuankuai')); ?>";
           var paytype = 2;
		</script>		
			...
			<div class="form-group" style="margin-bottom:10px">
				...
				<div style="float:left;" class="col-xs-6">
					<input type="number" class="form-control" name="money" id="amount" onblur="jine_input()"  placeholder="<?php echo e(trans("lang.qingshuru")); ?><?php echo e(trans("lang.huikuanjine")); ?>">
				</div>
				<div class="col-xs-3 info">
			...
			<div class="form-group" style="margin-bottom:10px">
				...
				<div style="float:left;" class="col-xs-6">
					<input type="text" class="form-control" disabled  value="<?php echo e($_system_config->qq_account); ?>">
				</div>
				<div class="col-xs-3 info">
			...
			<div class="form-group" style="margin-bottom:10px">
				...
				<div style="float:left" class="col-xs-6">
				   <input type="text" class="form-control" disabled  value="<?php echo e($_system_config->qq_nickname); ?>">
				</div>
				<div class="col-xs-3 info">
