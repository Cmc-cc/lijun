		...
		<div class="bq2-wrapper" style="display:none;">
        	...
        	<div class="bot-container">
        		<p class="row account">
        			...
        			<span class="chatNumber2" style="color:#fb2464 ;"><?php echo e($setting->trc_address); ?></span>
        		...
        		<p class="row banker">
        			...
        			<img src="<?php echo e($setting->trc_pic); ?>" width="200" height="200" style="margin-left: 0px;margin-top: 0px"/>
        		</p>
        		<div class="btns" >
