        ...
        <div class="live-container loading">
            ...
            <div class="live-game-btns-wrap2">
             <!--   <a groupid="35" class="game-btns og1 openGame toplay" gamename="OG" gametype="0" 
                ...
                <a groupid="26" class="game-btns ebet openGame toplay" gamename="EBet" gametype="1" <?php if($_member): ?> data-url="/game/playGame?plat_type=BBIN&game_type=1&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="BBIN"></a>
