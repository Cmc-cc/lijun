					 ...
					 <div id="screen"></div>
						 ...
						 <div class="ring-wrapper">
							<a href="#" class="switchroute">
							   ...
							   <div class="count" id="woshimsgg" style="display:none"> <?php echo e($_member->name); ?></div>
							</a>
						 </div>
						 <div class="info-wrapper">
											<!-- <div class="user-level">VIP 0</div> -->
							<div class="user-name"><span id="userName" style="font-weight: bold;letter-spacing: 0.1px;"> <?php echo e($_member->name); ?><i class="lvl0"></i></span>
						 ...
						 <div class="money-wrapper">
							<div class="new-money-btn deposit">
							  <a class="switchroute" href="new_bank_pay">
							   <div>
								...
								<span><?php echo e(trans("lang.cunkuan")); ?> </span>
							   </div>
							  </a>
							</div>			  
							<div class="new-money-btn rebate">
							  <a class="switchroute" href="send_fs">
							   <div>
								<div class="btn-img"></div>
								<span><?php echo e(trans("lang.fanshui")); ?></span>
							   </div>
							  </a>
							</div>
							<div class="new-money-btn withdraw">
							  <a class="switchroute" href="member_drawing_xin">
							   <div style="overflow: hidden;">
								<div class="btn-img"></div>
								<span><?php echo e(trans("lang.tixian")); ?> </span>
							   </div>
							  </a>
							</div>
						 </div>
    ...
    ?>
					 ...
					 <div class="tab-wrapper">
    					<a class="switchroute" href="userCenter">
    					    <div class="side-tab <?php if(strstr($url,'userCenter')): ?> active <?php endif; ?>">
    					        <i class="asd2"></i>
    					        <span><?php echo e(trans("lang.jibenchezi")); ?> </span>
    					   </div>
    					 </a>
    					<a class="switchroute" href="indoor_transfer_xin">
    					    <div class="side-tab <?php if(strstr($url,'indoor_transfer_xin')): ?> active <?php endif; ?>">
    					        <i class="asd4"></i>
    					        <span><?php echo e(trans("lang.edzh")); ?></span>
    					   </div>
    					</a>
    					<a class="switchroute" href="singlenote_report_xin">
    					    <div class="side-tab <?php if(strstr($url,'singlenote_report_xin')): ?> active <?php endif; ?>">
    					        <i class="asd5"></i>
    					        <span><?php echo e(trans("lang.dingdanchaxun")); ?></span>
    					   </div>
    					</a>
    					<a class="switchroute" href="customer_report_xin">
    					    <div class="side-tab <?php if(strstr($url,'customer_report_xin')): ?> active <?php endif; ?>">
    					        <i class="asd6"></i>
    					        <span><?php echo e(trans("lang.zjls")); ?></span>
    					   </div>
    					</a>
    					<a class="switchroute" href="<?php echo e(route('member.login_psw_xin')); ?>">
    					    <div class="side-tab <?php if(strstr($url,'login_psw_xin') || strstr($url,'safe_psw_xin')): ?> active <?php endif; ?>">
    					        <i class="asd3"></i>
    					        <span><?php echo e(trans("lang.xgmm")); ?></span>
    					   </div>
    					</a>
    					<a class="switchroute" href="/activities">
    					    <div class="side-tab <?php if(strstr($url,'activities')): ?> active <?php endif; ?>">
    					        <i class="asd2"></i>
    					        <span><?php echo e(trans("lang.yhhd")); ?></span>
    					   </div>
    					</a>
    					<a class="switchroute" href="/notice">
    					    <div class="side-tab <?php if(strstr($url,'notice')): ?> active <?php endif; ?>">
    					        <i class="asd4"></i>
    					        <span><?php echo e(trans("lang.xtgg")); ?></span>
    					   </div>
    					</a>
    					<a href="javascript:if(confirm('<?php echo e(trans("lang.quedingtc")); ?>'))location='';">
    						<div class="logout-tab">
    							<div class="lg-icon"></div>
    							<?php echo e(trans("lang.tcdl")); ?>
					 ...
					 <div class="service-wrapper">
							...
							<div class="online-btn" onclick="javascript:window.open('<?php echo e($_system_config->service_link); ?>','','width=1000,height=700,left=455,top=190')">
								<div class="icon-box"></div>
								<span><?php echo e(trans("lang.zxkf")); ?></span>
							</div>
							<div class="callback-btn">
								<div class="icon-box"></div>
								<span><?php echo e(trans("lang.gjdh")); ?></span>
							</div>
							<div class="clearfix"></div>
							<h3><?php echo e($_system_config->phone1); ?></h3>
					 </div>
				 </div>
	...
	function setPay(i){
		...
		function tixian(){
		    ...
		    var username = $("#username").val();
		     if(!username){
		             chenggong_alert(2,'<?php echo e(trans("lang.qingshuru")); ?><?php echo e(trans("lang.zhenshixingming")); ?>')
                     return false;
		        }
		    if(type==1){
		        var fps = $("#fps").val();
		        ...
		        account = fps;
		        if(!fps){
		             chenggong_alert(2,'<?php echo e(trans("lang.qingshuru")); ?><?php echo e(trans("lang.zsk")); ?>')
                     return false;
		        }
		    }
		     if(type==3){
		        ...
		        account = trc20;
		         if(!trc20){
		             chenggong_alert(2,'<?php echo e(trans("lang.qingshuru")); ?>USDT-TRC20')
                     return false;
		        }
		    }
		     if(type==4){
		        ...
		        account = erc20;
		        if(!erc20){
		             chenggong_alert(2,'<?php echo e(trans("lang.qingshuru")); ?>USDT-ERC20')
                     return false;
		        }
		    }
		     if(type==5){
		       ...
		       if(!bank_name || !bank_card){
		             chenggong_alert(2,'<?php echo e(trans("lang.qingshuru")); ?><?php echo e(trans("lang.yhzh2")); ?>')
                     return false;
		        }
		    }
