                        ...
                        <form id="Depositeform">
                            ...
                            <table style="width: 100%;" border="0" cellspacing="1" cellpadding="0">
                                ...
                                <tr class="b_rig recharge-data amount" style="display: table-row;">
                                    ...
                                    <td width="80%" style="display: flex;">
                                        <div align="left" style="float: left;position: relative;">
                                            <input name="money" id="PayMoney_usdt" style="width: 180px" onkeyup="this.value=this.value.replace(/\D/g,'');$('#account_usdt').val((Number(Number(this.value / <?php echo e($_system_config->usdt_lv); ?>).toFixed(2))+Number(<?php echo e($xiaoshu); ?> / 100)).toFixed(2))" onafterpaste="this.value=this.value.replace(/\D/g,'')">
                                        </div>
